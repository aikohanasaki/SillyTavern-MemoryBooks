...
`).filter((G)=>G.trim());if(Q.length>0){let J=Q[0].trim().replace(/^(You are|Analyze|Create|Generate|Write)\s+/i,"").replace(/[:.]/g,"").trim();return _8(J.substring(0,50))}return"Custom Prompt"}function k6(Z,Q){let G=S7(Z),J=G,W=2,q=T0();while(J in Q||J in q)J=`${G}-${W}`,W++;return J}async function s1(Z=null){if(t0)return t0;let Q=!1,G=null;try{let J=await fetch(`/user/files/${V4}`,{method:"GET",credentials:"include",headers:X4()});if(!J.ok)Q=!0;else{let W=await J.text();if(G=JSON.parse(W),!K4(G))Q=!0}}catch(J){Q=!0}if(Q){let J={},W=new Date().toISOString(),q=T0();for(let[z,Y]of Object.entries(q))J[z]={displayName:f6[z]||_8(z),prompt:Y,createdAt:W};if(Z&&Z.profiles&&Array.isArray(Z.profiles)){for(let z of Z.profiles)if(z.prompt&&z.prompt.trim()){let Y=`Custom: ${z.name||"Unnamed Profile"}`,V=k6(Y,J);J[V]={displayName:Y,prompt:z.prompt,createdAt:W},console.log(`${T1}: Migrated custom prompt from profile "${z.name}" as "${V}"`)}}G={version:n1.CURRENT_VERSION,overrides:J},await e0(G)}return t0=G,t0}async function e0(Z){try{let Q=JSON.stringify(Z,null,2),G=btoa(unescape(encodeURIComponent(Q))),J=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:X4(),body:JSON.stringify({name:V4,data:G})});if(!J.ok)throw Error(`Failed to save prompts: ${J.statusText}`);t0=Z,console.log(`${T1}: Prompts saved successfully`)}catch(Q){throw console.error(`${T1}: Error saving overrides:`,Q),Q}}function K4(Z){if(!Z||typeof Z!=="object")return console.error(`${T1}: Invalid data type`),!1;if(typeof Z.version!=="number")return console.error(`${T1}: Invalid schema version type: ${Z.version}`),!1;if(Z.version!==n1.CURRENT_VERSION)console.warn(`${T1}: Unexpected schema version: ${Z.version} (expected ${n1.CURRENT_VERSION})`);if(!Z.overrides||typeof Z.overrides!=="object")return console.error(`${T1}: Missing or invalid overrides object`),!1;for(let[Q,G]of Object.entries(Z.overrides)){if(!G||typeof G!=="object")return console.error(`${T1}: Invalid override entry for key: ${Q}`),!1;if(typeof G.prompt!=="string"||!G.prompt.trim())return console.error(`${T1}: Invalid or empty prompt for key: ${Q}`),!1;if(G.displayName!==void 0&&typeof G.displayName!=="string")return console.error(`${T1}: Invalid displayName for key: ${Q}`),!1}return!0}async function Z8(Z){return await s1(Z),P7=!0,x7=null,!0}async function A0(Z=null){let Q=await s1(Z),G=[];for(let[W,q]of Object.entries(Q.overrides))G.push({key:W,displayName:q.displayName||_8(W),createdAt:q.createdAt||null});let J=T0()||{};for(let W of Object.keys(J))if(!(W in Q.overrides))G.push({key:W,displayName:f6[W]||_8(W),createdAt:null});return G.sort((W,q)=>{if(!W.createdAt)return 1;if(!q.createdAt)return-1;return new Date(q.createdAt)-new Date(W.createdAt)}),G}async function G0(Z,Q=null){let G=await s1(Q);if(G.overrides[Z]){let W=G.overrides[Z].prompt;if(typeof W==="string"&&W.trim())return W}return T0()[Z]||d1()}async function g6(Z,Q=null){let G=await s1(Q);if(G.overrides[Z]&&G.overrides[Z].displayName)return G.overrides[Z].displayName;return f6[Z]||_8(Z)}async function I8(Z,Q,G){let J=await s1(),W=new Date().toISOString();if(!Z)Z=k6(G||z4(Q),J.overrides);if(J.overrides[Z])J.overrides[Z].prompt=Q,J.overrides[Z].displayName=G||J.overrides[Z].displayName,J.overrides[Z].updatedAt=W;else J.overrides[Z]={displayName:G||z4(Q),prompt:Q,createdAt:W};return await e0(J),Z}async function U4(Z){let Q=await s1(),G=Q.overrides[Z];if(!G)throw Error(`Preset "${Z}" not found`);let J=`${G.displayName} (Copy)`,W=k6(J,Q.overrides),q=new Date().toISOString();return Q.overrides[W]={displayName:J,prompt:G.prompt,createdAt:q},await e0(Q),W}async function j4(Z){let Q=await s1();if(!Q.overrides[Z])throw Error(`Preset "${Z}" not found`);delete Q.overrides[Z],await e0(Q)}async function F4(){let Z=await s1();return JSON.stringify(Z,null,2)}async function B4(Z){try{let Q=JSON.parse(Z);if(!K4(Q))throw Error("Invalid prompts file structure - see console for details");await e0(Q)}catch(Q){throw console.error(`${T1}: Error importing prompts:`,Q),Q}}async function H4(Z="overwrite"){if(Z!=="overwrite")console.warn(`${T1}: Unsupported mode for recreateBuiltInPrompts: ${Z}; defaulting to 'overwrite'`);let Q=await s1(),G=T0(),J=Object.keys(G||{}),W=0;if(Q&&Q.overrides&&typeof Q.overrides==="object"){for(let q of J)if(q in Q.overrides)delete Q.overrides[q],W++}return await e0(Q),t0=Q,console.log(`${T1}: Recreated built-in prompts (removed ${W} overrides)`),{removed:W}}var T1="STMemoryBooks-SummaryPromptManager",V4,t0=null,P7=!1,x7=null,f6;var r8=H0(()=>{S1();O0();V4=i0.PROMPTS_FILE,f6=Object.fromEntries(Object.keys(R8).map((Z)=>[Z,v7(R8[Z],p8[Z])]))});var D4={};Q4(D4,{validateProfile:()=>W8,showLorebookSelectionPopup:()=>N0,resolveEffectiveConnectionFromProfile:()=>i6,readIntInput:()=>W1,parseTemperature:()=>l6,normalizeCompletionSource:()=>z1,isValidPreset:()=>d7,getUIModelSettings:()=>Q1,getPresetPrompt:()=>u7,getPresetNames:()=>m7,getEffectivePrompt:()=>R0,getEffectiveLorebookName:()=>J8,getDefaultPrompt:()=>d1,getCurrentModelSettings:()=>g7,getCurrentMemoryBooksContext:()=>$8,getCurrentApiInfo:()=>o,getBuiltInPresetPrompts:()=>T0,getApiSelectors:()=>p6,generateSafeProfileName:()=>D0,formatPresetDisplayName:()=>c7,estimateTokens:()=>$0,deepClone:()=>G8,createProfileObject:()=>_0,clampInt:()=>U1,SELECTORS:()=>r1});import{chat_metadata as Q8,characters as u6,name2 as m6,this_chid as d6}from"../../../../script.js";import{getContext as E7,extension_settings as A4}from"../../../extensions.js";import{selected_group as T4,groups as b7}from"../../../group-chats.js";import{METADATA_KEY as c6,world_names as a8}from"../../../world-info.js";import{Popup as N4,POPUP_TYPE as R4,POPUP_RESULT as t8}from"../../../popup.js";import{translate as c1}from"../../../i18n.js";function y7(...Z){for(let Q of Z){let G=L1(Q);if(G.length)return G}return L1()}function f7(){return document.querySelector("#group_chat_completion_source")?"#group_":"#"}function W1(Z,Q){if(!Z)return Q;let G=parseInt(Z.value,10);return Number.isFinite(G)?G:Q}function U1(Z,Q,G){return Math.min(Math.max(Z,Q),G)}function z1(Z){let Q=String(Z||"").trim().toLowerCase();if(Q==="google")return"makersuite";return Q===""?"openai":Q}function o(){try{let Z="unknown",Q="unknown",G="unknown";if(typeof window.getGeneratingApi==="function")Z=window.getGeneratingApi();else Z=L1(r1.mainApi).val()||"unknown";if(typeof window.getGeneratingModel==="function")Q=window.getGeneratingModel();if(G=L1(r1.completionSource).val()||Z,!k7.includes(G))console.warn(`${p1}: Unsupported completion source: ${G}, falling back to openai`),G="openai";return{api:Z,model:Q,completionSource:G}}catch(Z){return console.warn(`${p1}: Error getting API info:`,Z),{api:L1(r1.mainApi).val()||"unknown",model:"unknown",completionSource:L1(r1.completionSource).val()||"openai"}}}function p6(){let Z=f7(),G=y7(`${Z}chat_completion_source`,"#chat_completion_source").val?.()||"openai",J={openai:`${Z}model_openai_select`,claude:`${Z}model_claude_select`,openrouter:`${Z}model_openrouter_select`,ai21:`${Z}model_ai21_select`,makersuite:`${Z}model_google_select`,mistralai:`${Z}model_mistralai_select`,custom:`${Z}model_custom_select`,cohere:`${Z}model_cohere_select`,perplexity:`${Z}model_perplexity_select`,groq:`${Z}model_groq_select`,nanogpt:`${Z}model_nanogpt_select`,deepseek:`${Z}model_deepseek_select`,electronhub:`${Z}model_electronhub_select`,vertexai:`${Z}model_vertexai_select`,aimlapi:`${Z}model_aimlapi_select`,xai:`${Z}model_xai_select`,pollinations:`${Z}model_pollinations_select`,moonshot:`${Z}model_moonshot_select`,fireworks:`${Z}model_fireworks_select`,cometapi:`${Z}model_cometapi_select`,azure_openai:`${Z}model_azure_openai_select`},W=J[G]||J.openai,q=`${Z}temp_openai`.replace("##","#"),z=`${Z}temp_counter_openai`.replace("##","#");return{model:W,temp:q,tempCounter:z}}function $8(){try{let Z=null,Q=null,G=null,J=!!T4,W=T4||null,q=null;if(J){let X=b7?.find((K)=>K.id===W);if(X)q=X.name,Q=X.chat_id,G=Q,Z=q}else{if(m6&&m6.trim())Z=String(m6).trim();else if(d6!==void 0&&u6&&u6[d6])Z=u6[d6].name;else if(Q8?.character_name)Z=String(Q8.character_name).trim();if(Z&&Z.normalize)Z=Z.normalize("NFC");try{let X=E7();if(X?.chatId)Q=X.chatId,G=Q;else if(typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}catch(X){if(console.warn(`${p1}: Could not get context, trying fallback methods`),typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}}let z=null;if(Q8&&c6 in Q8)z=Q8[c6];let Y=null;try{let X=o(),K=p6(),j=L1(K.temp).val()??L1(K.tempCounter).val(),U=Number.isFinite(parseFloat(j))?parseFloat(j):0.7,O=L1(K.model).val()||"";Y={api:X.api,model:O,temperature:U,completionSource:X.completionSource,source:"current_ui"}}catch(X){console.warn(`${p1}: Could not get current model/temperature settings:`,X),Y=null}let V={characterName:Z,chatId:Q,chatName:G,groupId:W,isGroupChat:J,lorebookName:z,modelSettings:Y};if(J)V.groupName=q;return V}catch(Z){return console.warn(`${p1}: Error getting context:`,Z),{characterName:null,chatId:null,chatName:null,groupId:null,groupName:null,isGroupChat:!1}}}async function J8(){if(!A4.STMemoryBooks.moduleSettings.manualModeEnabled)return Q8?.[c6]||null;let Q=g();if(Q.manualLorebook??null)if(a8.includes(Q.manualLorebook))return Q.manualLorebook;else toastr.error(`The designated manual lorebook "${Q.manualLorebook}" no longer exists. Please select a new one.`),delete Q.manualLorebook;let G=a8.map((z)=>`<option value="${z}">${z}</option>`).join("");if(G.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let J=`
    ...
    `,W=new N4(J,R4.TEXT,"",{okButton:"Select",cancelButton:"Cancel"});if(await W.show()===t8.AFFIRMATIVE){let z=W.dlg.querySelector("#stmb-manual-lorebook-select").value;return Q.manualLorebook=z,Z1(),toastr.success(`"${z}" is now the Memory Book for this chat.`,"STMemoryBooks"),z}return null}async function N0(Z=null){if(a8.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let Q=a8.map((q)=>{return`<option value="${q}"${q===Z?" selected":""}>${q}</option>`}).join(""),G=`
        <h4>Select a Memory Book</h4>
        <div class="world_entry_form_control">
...
${Y}`;try{let X=!!w8?.STMemoryBooks?.moduleSettings?.useRegex,K=w8?.STMemoryBooks?.moduleSettings?.selectedRegexOutgoing;if(X&&Array.isArray(K)&&K.length>0)return p4(V,K)}catch(X){console.warn("STMemoryBooks: outgoing regex application failed",X)}return V}function kQ(Z,Q){let{content:G,title:J,keywords:W}=Z,q=(G||Z.summary||Z.memory_content||"").trim(),z=(J||"Memory").trim(),Y=Array.isArray(W)?W.filter((V)=>V&&typeof V==="string"&&V.trim()!=="").map((V)=>V.trim()):[];return{content:q,extractedTitle:z,suggestedKeys:Y}}s0();import{getContext as hJ}from"../../../extensions.js";import{METADATA_KEY as vJ,loadWorldInfo as PJ,createWorldInfoEntry as JZ,saveWorldInfo as WZ,reloadEditor as qZ}from"../../../world-info.js";import{extension_settings as o4}from"../../../extensions.js";import{moment as n4}from"../../../../lib.js";import{executeSlashCommands as gQ}from"../../../slash-commands.js";import{translate as uQ}from"../../../i18n.js";var Y1="STMemoryBooks-AddLore";function S(Z,Q,G){let J=uQ(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function s4(Z){if(!Z)return null;let Q=Z.split("-");if(Q.length!==2)return null;let G=parseInt(Q[0],10),J=parseInt(Q[1],10);if(isNaN(G)||isNaN(J)||G<0||J<0)return null;return{start:G,end:J}}async function Y6(Z,Q=""){let G=Q?` (${Q})`:"";console.log(S("addlore.log.executingHideCommand",`${Y1}: Executing hide command${G}: {{hideCommand}}`,{hideCommand:Z})),await gQ(Z)}function mQ(Z={}){if(Z.autoHideMode)return Z.autoHideMode;if(Z.autoHideAllMessages)return"all";else if(Z.autoHideLastMemory)return"last";else return"none"}var dQ=["[000] - {{title}} ({{profile}})","{{date}} [000] \uD83C\uDFAC{{title}}, {{messages}} msgs","[000] {{date}} - {{char}} Memory","[00] - {{user}} & {{char}} {{scene}}","\uD83E\uDDE0 [000] ({{messages}} msgs)","\uD83D\uDCDA Memory #[000] - {{profile}} {{date}} {{time}}","[000] - {{scene}}: {{title}}","[000] - {{title}} ({{scene}})","[000] - {{title}}"];async function YZ(Z,Q){try{if(!Z?.content)throw Error(S("addlore.errors.invalidContent","Invalid memory result: missing content"));if(!Q?.valid||!Q.data)throw Error(S("addlore.errors.invalidLorebookValidation","Invalid lorebook validation data"));let G=o4.STMemoryBooks||{},J=Z.titleFormat;if(!J)J=G.titleFormat||S("addlore.titleFormats.8","[000] - {{title}}");let W=G.moduleSettings?.refreshEditor!==!1,q=Z.lorebookSettings||{constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0},z=JZ(Q.name,Q.data);if(!z)throw Error(S("addlore.errors.createEntryFailed","Failed to create new lorebook entry"));let Y=pQ(J,Z,Q.data);if(cQ(z,Z,Y,q),await WZ(Q.name,Q.data,!0),G.moduleSettings?.showNotifications!==!1)toastr.success(S("addlore.toast.added",'Memory "{{entryTitle}}" added to "{{lorebookName}}"',{entryTitle:Y,lorebookName:Q.name}),S("addlore.toast.title","STMemoryBooks"));if(W)try{qZ(Q.name)}catch(X){console.warn(S("addlore.warn.refreshEditorFailed",`${Y1}: reloadEditor failed:`),X)}let V=mQ(G.moduleSettings);if(V!=="none"){let X=G.moduleSettings.unhiddenEntriesCount??2;if(V==="all"){let K=s4(Z.metadata?.sceneRange);if(!K)console.warn(S("addlore.warn.autohideSkippedInvalidRange",`${Y1}: Auto-hide skipped - invalid scene range: "{{range}}"`,{range:Z.metadata?.sceneRange})),toastr.warning(S("addlore.toast.autohideInvalidRange","Auto-hide skipped: invalid scene range metadata"),S("addlore.toast.title","STMemoryBooks"));else{let{start:j,end:U}=K;if(X===0)try{await Y6(`/hide 0-${U}`,S("addlore.hideCommand.allComplete","all mode - complete"))}catch(O){console.warn(S("addlore.warn.autohideFailed",`${Y1}: Auto-hide failed:`),O)}else{let O=U-X;if(O>=0)try{await Y6(`/hide 0-${O}`,S("addlore.hideCommand.allPartial","all mode - partial"))}catch(B){console.warn(S("addlore.warn.autohideFailed",`${Y1}: Auto-hide failed:`),B)}}}}else if(V==="last"){let K=s4(Z.metadata?.sceneRange);if(!K)console.warn(S("addlore.warn.autohideSkippedInvalidRange",`${Y1}: Auto-hide skipped - invalid scene range: "{{range}}"`,{range:Z.metadata?.sceneRange})),toastr.warning(S("addlore.toast.autohideInvalidRange","Auto-hide skipped: invalid scene range metadata"),S("addlore.toast.title","STMemoryBooks"));else{let{start:j,end:U}=K,O=U-j+1;if(X>=O);else if(X===0)try{await Y6(`/hide ${j}-${U}`,S("addlore.hideCommand.lastHideAll","last mode - hide all"))}catch(B){console.warn(S("addlore.warn.autohideFailed",`${Y1}: Auto-hide failed:`),B)}else{let B=U-X;if(B>=j)try{await Y6(`/hide ${j}-${B}`,S("addlore.hideCommand.lastPartial","last mode - partial"))}catch(T){console.warn(S("addlore.warn.autohideFailed",`${Y1}: Auto-hide failed:`),T)}}}}}return sQ(Z),{success:!0,entryId:z.uid,entryTitle:Y,lorebookName:Q.name,keywordCount:Z.suggestedKeys?.length||0,message:S("addlore.result.added",'Memory successfully added to "{{lorebookName}}"',{lorebookName:Q.name})}}catch(G){if(console.error(S("addlore.log.addFailed",`${Y1}: Failed to add memory to lorebook:`),G),o4.STMemoryBooks?.moduleSettings?.showNotifications!==!1)toastr.error(S("addlore.toast.addFailed","Failed to add memory: {{message}}",{message:G.message}),S("addlore.toast.title","STMemoryBooks"));return{success:!1,error:G.message,message:S("addlore.result.addFailed","Failed to add memory to lorebook: {{message}}",{message:G.message})}}}function cQ(Z,Q,G,J){Z.content=Q.content,Z.key=Q.suggestedKeys||[],Z.comment=G;let W=L8(G)||1;switch(J.constVectMode){case"blue":Z.constant=!0,Z.vectorized=!1;break;case"green":Z.constant=!1,Z.vectorized=!1;break;case"link":default:Z.constant=!1,Z.vectorized=!0;break}if(Z.position=J.position,Number(J.position)===7){let q=String(J.outletName||"").trim();if(q)Z.outletName=q}if(J.orderMode==="manual")Z.order=J.orderValue;else Z.order=W;if(Z.preventRecursion=J.preventRecursion,Z.delayUntilRecursion=J.delayUntilRecursion,Z.keysecondary=[],Z.selective=!0,Z.selectiveLogic=0,Z.addMemo=!0,Z.disable=!1,Z.excludeRecursion=!1,Z.probability=100,Z.useProbability=!0,Z.depth=4,Z.group="",Z.groupOverride=!1,Z.groupWeight=100,Z.scanDepth=null,Z.caseSensitive=null,Z.matchWholeWords=null,Z.useGroupScoring=null,Z.automationId="",Z.role=null,Z.sticky=0,Z.cooldown=0,Z.delay=0,Z.displayIndex=W,Z.stmemorybooks=!0,Q.metadata?.sceneRange){let q=Q.metadata.sceneRange.split("-");if(q.length===2)Z.STMB_start=parseInt(q[0],10),Z.STMB_end=parseInt(q[1],10)}}function r4(Z){return Z.stmemorybooks===!0}function pQ(Z,Q,G){let J=Z,W=[{pattern:/\[\[0+\]\]/g,prefix:"[",suffix:"]"},{pattern:/\[0+\]/g,prefix:"",suffix:""},{pattern:/\(\[0+\]\)/g,prefix:"(",suffix:")"},{pattern:/\{\[0+\]\}/g,prefix:"{",suffix:"}"},{pattern:/#\[0+\]/g,prefix:"#",suffix:""}];for(let{pattern:Y,prefix:V,suffix:X}of W){let K=J.match(Y);if(K){let j=iQ(G,Z);K.forEach((U)=>{let O;if(Y.source.includes("\\[\\["))O=U.length-4;else if(Y.source.includes("\\(\\[")||Y.source.includes("\\{\\["))O=U.length-4;else if(Y.source.includes("#\\["))O=U.length-3;else if(Y.source.includes("\\["))O=U.length-2;else O=U.length-2;let B=j.toString().padStart(O,"0"),T=V+B+X;J=J.replace(U,T)});break}}let q=Q.metadata||{},z={"{{title}}":Q.extractedTitle||S("addlore.defaults.title","Memory"),"{{scene}}":S("addlore.defaults.scene","Scene {{range}}",{range:q.sceneRange||S("common.unknown","Unknown")}),"{{char}}":q.characterName||S("common.unknown","Unknown"),"{{user}}":q.userName||S("addlore.defaults.user","User"),"{{messages}}":q.messageCount||0,"{{profile}}":q.profileUsed||S("common.unknown","Unknown"),"{{date}}":n4().format("YYYY-MM-DD"),"{{time}}":n4().format("HH:mm:ss")};return Object.entries(z).forEach(([Y,V])=>{J=J.replace(new RegExp(Y.replace(/[{}]/g,"\\$&"),"g"),V)}),J=nQ(J),J}function iQ(Z,Q=null){if(!Z.entries)return 1;let G=Object.values(Z.entries),J=[];if(G.forEach((q)=>{if(r4(q)&&q.comment){let z=Q?lQ(q.comment,Q):L8(q.comment);if(z!==null)J.push(z)}}),J.length===0)return 1;return Math.max(...J)+1}function lQ(Z,Q){if(!Z||typeof Z!=="string"||!Q||typeof Q!=="string")return null;let G=[/\[0+\]/g,/\(0+\)/g,/\{0+\}/g,/#0+/g],J=[],W=null;for(let z of G){let Y=[...Q.matchAll(z)];if(Y.length>0){J=Y,W=z;break}}if(J.length===0)return L8(Z);let q=oQ(Q);if(q=q.replace(/\\\{\\\{[^}]+\\\}\\\}/g,".*?"),W.source.includes("\\["))q=q.replace(/\\\[0+\\\]/g,"(\\d+)");else if(W.source.includes("\\("))q=q.replace(/\\\(0+\\\)/g,"(\\d+)");else if(W.source.includes("\\{"))q=q.replace(/\\\{0+\\\}/g,"(\\d+)");else if(W.source.includes("#"))q=q.replace(/#0+/g,"(\\d+)");try{let z=Z.match(new RegExp(q));if(z&&z[1]){let Y=parseInt(z[1],10);return isNaN(Y)?null:Y}}catch(z){}return L8(Z)}function oQ(Z){return Z.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function L8(Z){if(!Z||typeof Z!=="string")return null;let Q=Z.match(/\[(\d+)\]/);if(Q){let Y=parseInt(Q[1],10);return isNaN(Y)?null:Y}let G=Z.match(/\((\d+)\)/);if(G){let Y=parseInt(G[1],10);return isNaN(Y)?null:Y}let J=Z.match(/\{(\d+)\}/);if(J){let Y=parseInt(J[1],10);return isNaN(Y)?null:Y}let W=Z.match(/#(\d+)(?:-(\d+))?/);if(W){let Y=parseInt(W[1],10),V=W[2]?parseInt(W[2],10):null,X=V!==null?V:Y;return isNaN(X)?null:X}let q=Z.match(/^(\d+)(?:\s*[-\s])/);if(q){let Y=parseInt(q[1],10);return isNaN(Y)?null:Y}let z=[...Z.matchAll(/(\d+)/g)];for(let Y of z){let V=parseInt(Y[1],10);if(isNaN(V))continue;let X=Y[0],K=Y.index,j=Z.substring(Math.max(0,K-10),K),U=Z.substring(K+X.length,K+X.length+10);if(!(/\d{4}-\d{2}-\d{2}/.test(j+X+U)||/\d{4}-\d{1,2}/.test(j+X)||/-\d{1,2}-\d{1,2}/.test(X+U)))return V}return null}function V8(Z){if(!Z.entries)return[];let Q=Object.values(Z.entries),G=[];return Q.forEach((J)=>{if(r4(J)){let W=L8(J.comment)||0;G.push({number:W,title:J.comment,content:J.content,keywords:J.key||[],entry:J})}}),G.sort((J,W)=>J.number-W.number),G}function nQ(Z){return String(Z??"").replace(/[\u0000-\u001F\u007F-\u009F]/g,"").trim()||S("addlore.sanitize.fallback","Auto Memory")}function q0(){return dQ.map((Z,Q)=>S(`addlore.titleFormats.${Q}`,Z))}function a4(Z){if(typeof Z.STMB_start==="number"&&typeof Z.STMB_end==="number")return{start:Z.STMB_start,end:Z.STMB_end};return null}function sQ(Z){try{console.log(S("addlore.log.updateHighestCalled",`${Y1}: updateHighestMemoryProcessed called with:`),Z);let Q=Z.metadata?.sceneRange;if(console.log(S("addlore.log.sceneRangeExtracted",`${Y1}: sceneRange extracted:`),Q),!Q){console.warn(S("addlore.warn.noSceneRange",`${Y1}: No scene range found in memory result, cannot update highest processed`));return}let G=Q.split("-");if(G.length!==2){console.warn(S("addlore.warn.invalidSceneRangeFormat",`${Y1}: Invalid scene range format: {{range}}`,{range:Q}));return}let J=parseInt(G[1],10);if(isNaN(J)){console.warn(S("addlore.warn.invalidEndMessage",`${Y1}: Invalid end message number: {{end}}`,{end:G[1]}));return}let W=g();if(!W){console.warn(S("addlore.warn.noSceneMarkers",`${Y1}: Could not get scene markers to update highest processed`));return}W.highestMemoryProcessed=J,Z1(),console.log(S("addlore.log.setHighest",`${Y1}: Set highest memory processed to message {{endMessage}}`,{endMessage:J}))}catch(Q){console.error(S("addlore.log.updateHighestError",`${Y1}: Error updating highest memory processed:`),Q)}}function V1(Z,Q){if(!Z||!Z.entries||!Q)return null;let G=Object.values(Z.entries);for(let J of G)if((J.comment||"")===Q)return J;return null}async function C8(Z,Q,G,J={}){let{refreshEditor:W=!0}=J;if(!Z||!Q||!Array.isArray(G))throw Error(S("addlore.upsert.errors.invalidArgs","Invalid arguments to upsertLorebookEntriesBatch"));let q=[];for(let z of G){if(!z||!z.title)continue;let Y=String(z.title),V=z.content!=null?String(z.content):"",X=z.defaults||{},K=z.metadataUpdates||{},j=z.entryOverrides||{},U=V1(Q,Y),O=!1;if(!U){if(U=JZ(Z,Q),!U)throw Error(S("addlore.upsert.errors.createFailed","Failed to create lorebook entry"));if(U.vectorized=!!X.vectorized,U.selective=!!X.selective,typeof X.order==="number")U.order=X.order;if(typeof X.position==="number")U.position=X.position;U.disable=!1,O=!0}if(U.key=Array.isArray(U.key)?U.key:[],U.keysecondary=Array.isArray(U.keysecondary)?U.keysecondary:[],typeof U.disable!=="boolean")U.disable=!1;U.comment=Y,U.content=V;for(let[B,T]of Object.entries(K))U[B]=T;for(let[B,T]of Object.entries(j))U[B]=T;q.push({title:Y,uid:U.uid,created:O})}if(await WZ(Z,Q,!0),W)qZ(Z);return q}async function zZ(Z,Q,G,J,W={}){let{defaults:q={vectorized:!0,selective:!0,order:100,position:0},metadataUpdates:z={},refreshEditor:Y=!0,entryOverrides:V={}}=W;if(!Z||!Q||!G)throw Error(S("addlore.upsert.errors.invalidArgs","Invalid arguments to upsertLorebookEntryByTitle"));let X=V1(Q,G),K=!1;if(!X){if(X=JZ(Z,Q),!X)throw Error(S("addlore.upsert.errors.createFailed","Failed to create lorebook entry"));if(X.vectorized=!!q.vectorized,X.selective=!!q.selective,typeof q.order==="number")X.order=q.order;if(typeof q.position==="number")X.position=q.position;X.key=X.key||[],X.keysecondary=X.keysecondary||[],X.disable=!1,K=!0}X.comment=G,X.content=J!=null?String(J):"";for(let[j,U]of Object.entries(z||{}))X[j]=U;for(let[j,U]of Object.entries(V||{}))X[j]=U;if(await WZ(Z,Q,!0),Y)qZ(Z);return{uid:X.uid,created:K}}import{getCurrentChatId as rQ,name1 as aQ,name2 as tQ,chat_metadata as eQ,saveMetadata as ZG}from"../../../../script.js";import{createNewWorldInfo as QG,METADATA_KEY as GG,world_names as XZ}from"../../../world-info.js";import{translate as $G}from"../../../i18n.js";var z6="STMemoryBooks-AutoCreate";function h1(Z,Q,G){let J=$G(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function JG(Z){if(!Z||Z.trim()==="")Z=h1("STMemoryBooks_LorebookNameTemplatePlaceholder","LTM - {{char}} - {{chat}}");let Q=rQ()||h1("common.unknown","Unknown"),G=tQ||h1("common.unknown","Unknown"),J=aQ||h1("addlore.defaults.user","User"),W=Z.replace(/\{\{chat\}\}/g,Q).replace(/\{\{char\}\}/g,G).replace(/\{\{user\}\}/g,J);if(W=W.replace(/[\/\\:*?"<>|]/g,"_").replace(/_{2,}/g,"_").substring(0,60),!XZ||!XZ.includes(W))return W;for(let q=2;q<=999;q++){let z=`${W} ${q}`;if(!XZ.includes(z))return z}return`${W} ${Date.now()}`}async function X6(Z,Q="chat"){try{let G=JG(Z);if(console.log(h1("autocreate.log.creating",`${z6}: Auto-creating lorebook "{{name}}" for {{context}}`,{name:G,context:Q})),await QG(G))return eQ[GG]=G,await ZG(),console.log(h1("autocreate.log.created",`${z6}: Successfully created and bound lorebook "{{name}}"`,{name:G})),toastr.success(h1("autocreate.toast.createdBound",'Created and bound lorebook "{{name}}"',{name:G}),h1("autocreate.toast.title","STMemoryBooks")),{success:!0,name:G};else return console.error(h1("autocreate.log.createFailed",`${z6}: Failed to create lorebook`)),{success:!1,error:h1("autocreate.errors.failedAutoCreate","Failed to auto-create lorebook.")}}catch(G){return console.error(h1("autocreate.log.createError",`${z6}: Error creating lorebook:`),G),{success:!1,error:h1("autocreate.errors.failedAutoCreateWithMessage","Failed to auto-create lorebook: {{message}}",{message:G.message})}}}s0();S1();import{extension_settings as h8}from"../../../extensions.js";import{chat as V6,chat_metadata as WG}from"../../../../script.js";import{METADATA_KEY as qG,world_names as t4}from"../../../world-info.js";import{Popup as YG,POPUP_TYPE as zG,POPUP_RESULT as e4}from"../../../popup.js";import{translate as XG}from"../../../i18n.js";function n(Z,Q,G){let J=XG(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}async function VG(){let Z=h8.STMemoryBooks,Q;if(!Z.moduleSettings.manualModeEnabled){if(Q=WG?.[qG]||null,!Q&&Z?.moduleSettings?.autoCreateLorebook){let G=Z.moduleSettings.lorebookNameTemplate||n("STMemoryBooks_LorebookNameTemplatePlaceholder","LTM - {{char}} - {{chat}}"),J=await X6(G,"auto-summary");if(J.success)Q=J.name;else return{valid:!1,error:J.error}}}else{let G=g()||{};if(Q=G.manualLorebook??null,!Q){let W=new YG(`
...
=== RESPONSE FORMAT ===
`),q.push(String(J).trim());let Y=q.join("");return D1?.STMemoryBooks?.moduleSettings?.useRegex?M5(Y,H6.USER_INPUT,{isPrompt:!0}):Y}async function vZ(Z,Q=null){let G,J,W,q,z;if(Q&&(Q.api||Q.model))G=z1(Q.api||"openai"),J=Q.model||"",W=typeof Q.temperature==="number"?Q.temperature:0.7,q=Q.endpoint||null,z=Q.apiKey||null,console.debug(`${c}: runLLM using overrides api=${G} model=${J} temp=${W}`);else{let X=o(),K=Q1();G=z1(X.completionSource||X.api||"openai"),J=K.model||"",W=K.temperature??0.7,console.debug(`${c}: runLLM using UI settings api=${G} model=${J} temp=${W}`)}let{text:Y}=await i4({api:G,model:J,prompt:Z,temperature:W,endpoint:q,apiKey:z,extra:{}});return D1?.STMemoryBooks?.moduleSettings?.useRegex?M5(Y||"",H6.AI_OUTPUT):Y||""}function F8(Z=null,Q={}){try{if(Z&&(Z.effectiveConnection||Z.connection)){let Y=i6(Z),{api:V,model:X,temperature:K,endpoint:j,apiKey:U}=Y;return console.debug(`${c}: resolveSidePromptConnection using provided profile api=${V} model=${X} temp=${K}`),{api:V,model:X,temperature:K,endpoint:j,apiKey:U}}let G=D1?.STMemoryBooks,J=G?.profiles||[],W=Q&&Number.isFinite(Q.overrideProfileIndex)?Number(Q.overrideProfileIndex):null;if(W!==null&&J.length>0){if(W<0||W>=J.length)W=0;let Y=J[W];if(Y?.useDynamicSTSettings||Y?.connection?.api==="current_st"){let V=o(),X=Q1(),K=z1(V.completionSource||V.api||"openai"),j=X.model||"",U=X.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection using UI via template override profile index=${W} api=${K} model=${j} temp=${U}`),{api:K,model:j,temperature:U}}else{let V=Y?.connection||{},X=z1(V.api||"openai"),K=V.model||"",j=typeof V.temperature==="number"?V.temperature:0.7,U=V.endpoint||null,O=V.apiKey||null;return console.debug(`${c}: resolveSidePromptConnection using template override profile index=${W} api=${X} model=${K} temp=${j}`),{api:X,model:K,temperature:j,endpoint:U,apiKey:O}}}let q=Number(G?.defaultProfile??0);if(!Array.isArray(J)||J.length===0){let Y=o(),V=Q1(),X=z1(Y.completionSource||Y.api||"openai"),K=V.model||"",j=V.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection fallback to UI (no profiles) api=${X} model=${K} temp=${j}`),{api:X,model:K,temperature:j}}if(!Number.isFinite(q)||q<0||q>=J.length)q=0;let z=J[q];if(z?.useDynamicSTSettings||z?.connection?.api==="current_st"){let Y=o(),V=Q1(),X=z1(Y.completionSource||Y.api||"openai"),K=V.model||"",j=V.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection using UI via dynamic default profile api=${X} model=${K} temp=${j}`),{api:X,model:K,temperature:j}}else{let Y=z?.connection||{},V=z1(Y.api||"openai"),X=Y.model||"",K=typeof Y.temperature==="number"?Y.temperature:0.7,j=Y.endpoint||null,U=Y.apiKey||null;return console.debug(`${c}: resolveSidePromptConnection using default profile api=${V} model=${X} temp=${K}`),{api:V,model:X,temperature:K,endpoint:j,apiKey:U}}}catch(G){let J=o(),W=Q1(),q=z1(J.completionSource||J.api||"openai"),z=W.model||"",Y=W.temperature??0.7;return console.warn(`${c}: resolveSidePromptConnection error; falling back to UI`,G),{api:q,model:z,temperature:Y}}}function x8(Z,Q){let G=Number(Z);return Number.isFinite(G)?G:Q}function PZ(Z){let Q=Z&&Z.settings&&Z.settings.lorebook||{};return{constVectMode:Q.constVectMode||"link",position:x8(Q.position,0),orderMode:Q.orderMode==="manual"?"manual":"auto",orderValue:x8(Q.orderValue,100),preventRecursion:Q.preventRecursion!==!1,delayUntilRecursion:!!Q.delayUntilRecursion,outletName:String(Q.outletName||"")}}function xZ(Z){let Q={vectorized:Z.constVectMode==="link",selective:!0,order:Z.orderMode==="manual"?x8(Z.orderValue,100):100,position:x8(Z.position,0)},G={constant:Z.constVectMode==="blue",vectorized:Z.constVectMode==="link",preventRecursion:!!Z.preventRecursion,delayUntilRecursion:!!Z.delayUntilRecursion};if(Z.orderMode==="manual")G.order=x8(Z.orderValue,100);if(Number(Z.position)===7&&Z.outletName)G.outletName=String(Z.outletName);return{defaults:Q,entryOverrides:G}}async function SZ(){try{let Z=await B6("onInterval");if(!Z||Z.length===0)return;let Q=await hZ(),G=S8.length-1;if(G<0)return;for(let J of Z){let W=`${J.name} (STMB SidePrompt)`,q=`${J.name} (STMB Tracker)`,z=V1(Q.data,W)||V1(Q.data,q),Y=Number((z&&z[`STMB_sp_${J.key}_lastMsgId`])??(z&&z.STMB_tracker_lastMsgId)??-1),V=z?.[`STMB_sp_${J.key}_lastRunAt`]?Date.parse(z[`STMB_sp_${J.key}_lastRunAt`]):z?.STMB_tracker_lastRunAt?Date.parse(z.STMB_tracker_lastRunAt):null,X=Date.now(),K=1e4;if(V&&X-V<1e4)continue;let j=LG(Y,G),U=Math.max(1,Number(J?.triggers?.onInterval?.visibleMessages??50));if(j<U)continue;let O=Math.max(0,Y+1),T=Math.max(O,G-200+1),H=null;try{H=CZ(T,G)}catch(_){console.warn(`${c}: Interval compile failed:`,_);continue}let N=z?.content||"",R=[],w=Number(J?.settings?.previousMemoriesCount??0),v=Math.max(0,Math.min(7,w));if(v>0)try{R=(await v0(v,D1,O6))?.summaries||[]}catch{}let y=MZ(J.prompt,N,H,J.responseFormat,R),h="";try{let _=Number(J?.settings?.overrideProfileIndex),b=!!J?.settings?.overrideProfileEnabled&&Number.isFinite(_)?F8(null,{overrideProfileIndex:_}):F8(null);console.log(`${c}: SidePrompt attempt`,{trigger:"onInterval",name:J.name,key:J.key,range:`${T}-${G}`,visibleSince:j,threshold:U,api:b.api,model:b.model}),h=await vZ(y,b)}catch(_){console.error(`${c}: Interval sideprompt LLM failed:`,_),toastr.error(X0`SidePrompt "${J.name}" failed: ${_.message}`,"STMemoryBooks");continue}try{if(D1?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let P={extractedTitle:W,content:h,suggestedKeys:[]},b={sceneStart:H?.metadata?.sceneStart??T,sceneEnd:H?.metadata?.sceneEnd??G,messageCount:H?.metadata?.messageCount??(H?.messages?.length??0)},f={name:"SidePrompt"},m;if(await P5(async()=>{m=await U8(P,b,f,{lockTitle:!0})}),m?.action==="cancel"||m?.action==="retry"){console.log(`${c}: SidePrompt "${J.name}" canceled or retry requested in preview; skipping save`);continue}else if(m?.action==="edit"&&m.memoryData)h=m.memoryData.content??h}}catch(_){console.warn(`${c}: Preview step failed; proceeding without preview`,_)}try{let _=PZ(J),{defaults:P,entryOverrides:b}=xZ(_),f=H?.metadata?.sceneEnd??G;await zZ(Q.name,Q.data,W,h,{defaults:P,entryOverrides:b,metadataUpdates:{[`STMB_sp_${J.key}_lastMsgId`]:G,[`STMB_sp_${J.key}_lastRunAt`]:new Date().toISOString(),STMB_tracker_lastMsgId:G,STMB_tracker_lastRunAt:new Date().toISOString()},refreshEditor:D1?.STMemoryBooks?.moduleSettings?.refreshEditor!==!1}),console.log(`${c}: SidePrompt success`,{trigger:"onInterval",name:J.name,key:J.key,saved:!0,contentChars:h.length})}catch(_){console.error(`${c}: Interval sideprompt upsert failed:`,_),toastr.error(X0`Failed to update sideprompt entry "${J.name}"`,"STMemoryBooks");continue}}}catch(Z){}}async function EZ(Z,Q=null){try{let G=await hZ(),J=await B6("onAfterMemory");if(!J||J.length===0)return;let W=F8(Q);console.debug(`${c}: runAfterMemory default overrides api=${W.api} model=${W.model} temp=${W.temperature}`);let q=D1?.STMemoryBooks,z=q?.moduleSettings?.refreshEditor!==!1,Y=q?.moduleSettings?.showNotifications!==!1,V=[],X=U1(Number(q?.moduleSettings?.sidePromptsMaxConcurrent??2),1,5),K=[];for(let j=0;j<J.length;j+=X)K.push(J.slice(j,j+X));for(let j of K){let U=j.map(async(H)=>{try{let N=`${H.name} (STMB SidePrompt)`,w=(V1(G.data,N)||V1(G.data,`${H.name} (STMB Plotpoints)`)||V1(G.data,`${H.name} (STMB Scoreboard)`))?.content||"",v=[],y=Number(H?.settings?.previousMemoriesCount??0),h=Math.max(0,Math.min(7,y));if(h>0)try{v=(await v0(h,D1,O6))?.summaries||[]}catch{}let _=MZ(H.prompt,w,Z,H.responseFormat,v),P=Number(H?.settings?.overrideProfileIndex),f=!!H?.settings?.overrideProfileEnabled&&Number.isFinite(P)?F8(null,{overrideProfileIndex:P}):W;console.log(`${c}: SidePrompt attempt`,{trigger:"onAfterMemory",name:H.name,key:H.key,api:f.api,model:f.model});let m=await vZ(_,f);return{ok:!0,tpl:H,text:m}}catch(N){return console.error(`${c}: Wave LLM failed for "${H.name}":`,N),{ok:!1,tpl:H,error:N}}}),O=await Promise.all(U.map((H)=>H.then((N)=>({...N,_completedAt:performance.now()}))));O.sort((H,N)=>H._completedAt-N._completedAt);let B=[],T=[];for(let H of O){if(!H.ok){V.push({name:H.tpl?.name||"unknown",ok:!1,error:H.error});continue}let N=H.text,R=!0;try{if(D1?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let v={extractedTitle:`${H.tpl.name} (STMB SidePrompt)`,content:N,suggestedKeys:[]},y={sceneStart:Z?.metadata?.sceneStart??0,sceneEnd:Z?.metadata?.sceneEnd??0,messageCount:Z?.metadata?.messageCount??(Z?.messages?.length??0)},h={name:"SidePrompt"},_;if(await P5(async()=>{_=await U8(v,y,h,{lockTitle:!0})}),_?.action==="cancel"||_?.action==="retry")R=!1;else if(_?.action==="edit"&&_.memoryData)N=_.memoryData.content??N}}catch(w){console.warn(`${c}: Preview step failed; proceeding without preview`,w)}if(R){let w=H.tpl,v=`${w.name} (STMB SidePrompt)`,y=PZ(w),{defaults:h,entryOverrides:_}=xZ(y);B.push({title:v,content:N,defaults:h,entryOverrides:_,metadataUpdates:{[`STMB_sp_${w.key}_lastRunAt`]:new Date().toISOString()}}),T.push(w.name)}else V.push({name:H.tpl.name,ok:!1,error:Error("User canceled or retry in preview")})}if(B.length>0)try{let H=await v5(G.name);await C8(G.name,H,B,{refreshEditor:z}),G.data=H;for(let N of T){if(V.push({name:N,ok:!0}),Y)toastr.success(X0`SidePrompt "${N}" updated.`,"STMemoryBooks");console.log(`${c}: SidePrompt success`,{trigger:"onAfterMemory",name:N,saved:!0})}}catch(H){console.error(`${c}: Wave save failed:`,H),toastr.error(H1("Failed to save SidePrompt updates for this wave","STMemoryBooks_Toast_FailedToSaveWave"),"STMemoryBooks");for(let N of T)V.push({name:N,ok:!1,error:H})}}if(Y&&V.length>0){let j=V.filter((H)=>H.ok).map((H)=>H.name),U=V.filter((H)=>!H.ok).map((H)=>H.name),O=j.length,B=U.length,T=(H)=>{if(H.length===0)return"";let R=H.slice(0,5).join(", "),w=H.length>5?`, +${H.length-5} more`:"";return`${R}${w}`};if(B===0)toastr.info(X0`Side Prompts after memory: ${O} succeeded. ${T(j)}`,"STMemoryBooks");else toastr.warning(X0`Side Prompts after memory: ${O} succeeded, ${B} failed. ${B?"Failed: "+T(U):""}`,"STMemoryBooks")}}catch(G){}}async function bZ(Z){try{let Q=await hZ(),{name:G,range:J}=CG(Z);if(!G)return toastr.error(H1('SidePrompt name not provided. Usage: /sideprompt "Name" [X-Y]',"STMemoryBooks_Toast_SidePromptNameNotProvided"),"STMemoryBooks"),"";let W=await NZ(G);if(!W)return toastr.error(H1("SidePrompt template not found. Check name.","STMemoryBooks_Toast_SidePromptNotFound"),"STMemoryBooks"),"";if(!(Array.isArray(W?.triggers?.commands)&&W.triggers.commands.some((H)=>String(H).toLowerCase()==="sideprompt")))return toastr.error(H1('Manual run is disabled for this template. Enable "Allow manual run via /sideprompt" in the template settings.',"STMemoryBooks_Toast_ManualRunDisabled"),"STMemoryBooks"),"";let z=S8.length-1;if(z<0)return toastr.error(H1("No messages available.","STMemoryBooks_Toast_NoMessagesAvailable"),"STMemoryBooks"),"";let Y=null;if(J){let H=String(J).trim().match(/^(\d+)\s*[-–—]\s*(\d+)$/);if(!H)return toastr.error(H1("Invalid range format. Use X-Y","STMemoryBooks_Toast_InvalidRangeFormat"),"STMemoryBooks"),"";let N=parseInt(H[1],10),R=parseInt(H[2],10);if(!(N>=0&&R>=N&&R<S8.length))return toastr.error(H1("Invalid message range for /sideprompt","STMemoryBooks_Toast_InvalidMessageRange"),"STMemoryBooks"),"";try{Y=CZ(N,R)}catch(w){return toastr.error(H1("Failed to compile the specified range","STMemoryBooks_Toast_FailedToCompileRange"),"STMemoryBooks"),""}}else{if(!h5)toastr.info(H1('Tip: You can run a specific range with /sideprompt "Name" X-Y (e.g., /sideprompt "Scoreboard" 100-120). Running without a range uses messages since the last checkpoint.',"STMemoryBooks_Toast_SidePromptRangeTip"),"STMemoryBooks"),h5=!0;let H=`${W.name} (STMB SidePrompt)`,N=V1(Q.data,H)||V1(Q.data,`${W.name} (STMB Scoreboard)`)||V1(Q.data,`${W.name} (STMB Plotpoints)`)||V1(Q.data,`${W.name} (STMB Tracker)`),R=Number((N&&N[`STMB_sp_${W.key}_lastMsgId`])??(N&&N.STMB_score_lastMsgId)??(N&&N.STMB_tracker_lastMsgId)??-1),w=Math.max(0,R+1),y=Math.max(w,z-200+1);try{Y=CZ(y,z)}catch(h){return toastr.error(H1("Failed to compile messages for /sideprompt","STMemoryBooks_Toast_FailedToCompileMessages"),"STMemoryBooks"),""}}let V=`${W.name} (STMB SidePrompt)`,K=(V1(Q.data,V)||V1(Q.data,`${W.name} (STMB Scoreboard)`)||V1(Q.data,`${W.name} (STMB Plotpoints)`)||V1(Q.data,`${W.name} (STMB Tracker)`))?.content||"",j=[],U=Number(W?.settings?.previousMemoriesCount??0),O=Math.max(0,Math.min(7,U));if(O>0)try{j=(await v0(O,D1,O6))?.summaries||[]}catch{}let B=MZ(W.prompt,K,Y,W.responseFormat,j),T="";try{let H=Number(W?.settings?.overrideProfileIndex),R=!!W?.settings?.overrideProfileEnabled&&Number.isFinite(H)?F8(null,{overrideProfileIndex:H}):F8(null);console.log(`${c}: SidePrompt attempt`,{trigger:"manual",name:W.name,key:W.key,rangeProvided:!!J,api:R.api,model:R.model}),T=await vZ(B,R);try{if(D1?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let P={extractedTitle:V,content:T,suggestedKeys:[]},b={sceneStart:Y?.metadata?.sceneStart??0,sceneEnd:Y?.metadata?.sceneEnd??0,messageCount:Y?.metadata?.messageCount??(Y?.messages?.length??0)},m=await U8(P,b,{name:"SidePrompt"},{lockTitle:!0});if(m?.action==="cancel"||m?.action==="retry")return toastr.info(X0`SidePrompt "${W.name}" canceled.`,"STMemoryBooks"),"";else if(m?.action==="edit"&&m.memoryData)T=m.memoryData.content??T}}catch(_){console.warn(`${c}: Preview step failed; proceeding without preview`,_)}let w=PZ(W),{defaults:v,entryOverrides:y}=xZ(w),h=Y?.metadata?.sceneEnd??z;await zZ(Q.name,Q.data,V,T,{defaults:v,entryOverrides:y,metadataUpdates:{[`STMB_sp_${W.key}_lastMsgId`]:h,[`STMB_sp_${W.key}_lastRunAt`]:new Date().toISOString(),STMB_tracker_lastMsgId:h,STMB_tracker_lastRunAt:new Date().toISOString()},refreshEditor:D1?.STMemoryBooks?.moduleSettings?.refreshEditor!==!1}),console.log(`${c}: SidePrompt success`,{trigger:"manual",name:W.name,key:W.key,saved:!0,contentChars:T.length})}catch(H){return console.error(`${c}: /sideprompt failed:`,H),toastr.error(X0`SidePrompt "${W.name}" failed: ${H.message}`,"STMemoryBooks"),""}return toastr.success(X0`SidePrompt "${W.name}" updated.`,"STMemoryBooks"),""}catch(Q){return""}}function CG(Z){let Q=String(Z||"").trim();if(!Q)return{name:"",range:null};let G="",J="",W=Q.match(/^"([^"]+)"\s*(.*)$/),q=!W&&Q.match(/^'([^']+)'\s*(.*)$/);if(W)G=W[1],J=W[2]||"";else if(q)G=q[1],J=q[2]||"";else{let Y=Q.match(/(\d+)\s*[-–—]\s*(\d+)\s*$/);if(Y)G=Q.slice(0,Y.index).trim(),J=Q.slice(Y.index);else G=Q,J=""}let z=null;if(J){let Y=J.match(/(\d+)\s*[-–—]\s*(\d+)/);if(Y)z=`${Y[1]}-${Y[2]}`}return{name:G,range:z}}P8();import{Popup as E8,POPUP_TYPE as x0,POPUP_RESULT as K0}from"../../../popup.js";import{DOMPurify as A6}from"../../../../lib.js";import{escapeHtml as D}from"../../../utils.js";import{extension_settings as l1}from"../../../extensions.js";import{saveSettingsDebounced as MG}from"../../../../script.js";import{Handlebars as hG}from"../../../../lib.js";var x5=hG.compile(`
...
`);import{translate as A,applyLocale as S5}from"../../../i18n.js";function t1(Z,Q,G){let J=A(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function E5(Z){let Q=[],G=Z?.triggers||{};if(G.onInterval&&Number(G.onInterval.visibleMessages)>=1)Q.push(`${A("Interval","STMemoryBooks_Interval")}:${Number(G.onInterval.visibleMessages)}`);if(G.onAfterMemory&&!!G.onAfterMemory.enabled)Q.push(A("AfterMemory","STMemoryBooks_AfterMemory"));if(Array.isArray(G.commands)&&G.commands.some((J)=>String(J).toLowerCase()==="sideprompt"))Q.push(A("Manual","STMemoryBooks_Manual"));return Q}function vG(Z){let Q=(Z||[]).map((G)=>({key:String(G.key||""),name:String(G.name||""),badges:E5(G)}));return x5({items:Q})}async function V0(Z,Q=null){let G=Z?.dlg?.querySelector("#stmb-sp-list");if(!G)return;let J=(Z?.dlg?.querySelector("#stmb-sp-search")?.value||"").toLowerCase(),W=await z0(),q=J?W.filter((z)=>{let Y=z.name.toLowerCase().includes(J),V=E5(z).join(" ").toLowerCase();return Y||V.includes(J)}):W;G.innerHTML=A6.sanitize(vG(q));try{S5(G)}catch(z){}if(Q){let z=G.querySelector(`tr[data-tpl-key="${CSS.escape(Q)}"]`);if(z)z.style.backgroundColor="var(--cobalt30a)",z.style.border=""}}async function PG(Z,Q){try{let G=await TZ(Q);if(!G){toastr.error(t1("STMemoryBooks_TemplateNotFound",'Template "{{key}}" not found',{key:Q}),A("STMemoryBooks","index.toast.title"));return}let J=!!G.enabled,W=G.settings||{},q=G.triggers||{},z=!!(q.onInterval&&Number(q.onInterval.visibleMessages)>=1),Y=z?Math.max(1,Number(q.onInterval.visibleMessages)):50,V=!!(q.onAfterMemory&&q.onAfterMemory.enabled),X=Array.isArray(q.commands)?q.commands.some((M)=>String(M).toLowerCase()==="sideprompt"):!1,K=l1?.STMemoryBooks?.profiles||[],j=Number.isFinite(W.overrideProfileIndex)?Number(W.overrideProfileIndex):l1?.STMemoryBooks?.defaultProfile??0;if(!(j>=0&&j<K.length))j=0;let U=!!W.overrideProfileEnabled,O=K.map((M,r)=>`<option value="${r}" ${r===j?"selected":""}>${D(M?.name||"Profile "+(r+1))}</option>`).join(""),B=`
        ...
        `,T=Number.isFinite(W.previousMemoriesCount)?Number(W.previousMemoriesCount):0,H=W&&W.lorebook||{},N=H.constVectMode||"link",R=Number.isFinite(H.position)?Number(H.position):0,w=H.orderMode==="manual",v=Number.isFinite(H.orderValue)?Number(H.orderValue):100,y=H.preventRecursion!==!1,h=!!H.delayUntilRecursion,_=`
                ...
                <div class="flex-container" style="gap:12px; flex-wrap: wrap;">
                    <label>
                        ...
                        <select id="stmb-sp-edit-lb-mode" class="text_pole">
                            <option value="link" ${N==="link"?"selected":""}>${D(A("\uD83D\uDD17 Vectorized (Default)","STMemoryBooks_Vectorized"))}</option>
                            <option value="green" ${N==="green"?"selected":""}>${D(A("\uD83D\uDFE2 Normal","STMemoryBooks_Normal"))}</option>
                            <option value="blue" ${N==="blue"?"selected":""}>${D(A("\uD83D\uDD35 Constant","STMemoryBooks_Constant"))}</option>
                        </select>
                    </label>
                    <label>
...
<input type="number" id="stmb-sp-edit-prev-mem-count" class="text_pole" min="0" max="7" step="1" value="${T}">
                </label>
        ...
        `,P=new E8(A6.sanitize(_),x0.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:A("Save","STMemoryBooks_Save"),cancelButton:A("Cancel","STMemoryBooks_Cancel")}),b=()=>{let M=P.dlg;if(!M)return;let r=M.querySelector("#stmb-sp-edit-trg-interval"),g1=M.querySelector("#stmb-sp-edit-interval-container");r?.addEventListener("change",()=>{if(g1)g1.style.display=r.checked?"block":"none";if(r.checked)M.querySelector("#stmb-sp-edit-interval")?.focus()});let v1=M.querySelector("#stmb-sp-edit-override-enabled"),$1=M.querySelector("#stmb-sp-edit-override-container");v1?.addEventListener("change",()=>{if($1)$1.style.display=v1.checked?"block":"none"});let F1=M.querySelector("#stmb-sp-edit-lb-order-auto"),o1=M.querySelector("#stmb-sp-edit-lb-order-manual"),A1=M.querySelector("#stmb-sp-edit-lb-order-value-container"),Q0=()=>{if(A1)A1.style.display=o1?.checked?"block":"none"};F1?.addEventListener("change",Q0),o1?.addEventListener("change",Q0);let I1=M.querySelector("#stmb-sp-edit-lb-position"),u1=M.querySelector("#stmb-sp-edit-lb-outlet-name-container");I1?.addEventListener("change",()=>{if(u1)u1.style.display=I1.value==="7"?"block":"none"})},f=P.show();if(b(),await f===K0.AFFIRMATIVE){let M=P.dlg,r=M.querySelector("#stmb-sp-edit-name")?.value.trim()||"",g1=M.querySelector("#stmb-sp-edit-prompt")?.value.trim()||"",v1=M.querySelector("#stmb-sp-edit-response-format")?.value.trim()||"",$1=!!M.querySelector("#stmb-sp-edit-enabled")?.checked;if(!g1){toastr.error(A("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),A("STMemoryBooks","index.toast.title"));return}if(!r)toastr.info(A("Name was empty. Keeping previous name.","STMemoryBooks_NameEmptyKeepPrevious"),A("STMemoryBooks","index.toast.title"));let F1={},o1=!!M.querySelector("#stmb-sp-edit-trg-interval")?.checked,A1=!!M.querySelector("#stmb-sp-edit-trg-aftermem")?.checked,Q0=!!M.querySelector("#stmb-sp-edit-trg-manual")?.checked;if(o1){let T8=parseInt(M.querySelector("#stmb-sp-edit-interval")?.value??"50",10),R7=Math.max(1,isNaN(T8)?50:T8);F1.onInterval={visibleMessages:R7}}if(A1)F1.onAfterMemory={enabled:!0};if(Q0)F1.commands=["sideprompt"];let I1={...G.settings||{}},u1=!!M.querySelector("#stmb-sp-edit-override-enabled")?.checked;if(I1.overrideProfileEnabled=u1,u1){let T8=parseInt(M.querySelector("#stmb-sp-edit-override-index")?.value??"",10);if(!isNaN(T8))I1.overrideProfileIndex=T8}else delete I1.overrideProfileIndex;let d8=M.querySelector("#stmb-sp-edit-lb-mode")?.value||"link",A8=parseInt(M.querySelector("#stmb-sp-edit-lb-position")?.value??"0",10),k=!!M.querySelector("#stmb-sp-edit-lb-order-manual")?.checked,p=parseInt(M.querySelector("#stmb-sp-edit-lb-order-value")?.value??"100",10),J1=!!M.querySelector("#stmb-sp-edit-lb-prevent")?.checked,P1=!!M.querySelector("#stmb-sp-edit-lb-delay")?.checked,m1=A8===7?M.querySelector("#stmb-sp-edit-lb-outlet-name")?.value?.trim()||"":"",P6=parseInt(M.querySelector("#stmb-sp-edit-prev-mem-count")?.value??"0",10);I1.previousMemoriesCount=Number.isFinite(P6)&&P6>0?Math.min(P6,7):0,I1.lorebook={constVectMode:["link","green","blue"].includes(d8)?d8:"link",position:Number.isFinite(A8)?A8:0,orderMode:k?"manual":"auto",orderValue:Number.isFinite(p)?p:100,preventRecursion:J1,delayUntilRecursion:P1,...A8===7&&m1?{outletName:m1}:{}},await F6({key:G.key,name:r,enabled:$1,prompt:g1,responseFormat:v1,settings:I1,triggers:F1}),toastr.success(t1("STMemoryBooks_Toast_SidePromptUpdated",'SidePrompt "{{name}}" updated.',{name:r||G.name}),A("STMemoryBooks","index.toast.title")),window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated")),await V0(Z,G.key)}}catch(G){console.error("STMemoryBooks: Error editing side prompt:",G),toastr.error(A("Failed to edit SidePrompt","STMemoryBooks_FailedToEditSidePrompt"),A("STMemoryBooks","index.toast.title"))}}async function xG(Z){let Q=l1?.STMemoryBooks?.profiles||[],G=Number(l1?.STMemoryBooks?.defaultProfile??0);if(!(G>=0&&G<Q.length))G=0;let J=Q.map((X,K)=>`<option value="${K}" ${K===G?"selected":""}>${D(X?.name||"Profile "+(K+1))}</option>`).join(""),W=`
...
Return ONLY the JSON, no other text.`,STMemoryBooks_DisplayName_summary:"Summary - Detailed beat-by-beat summaries in narrative prose",STMemoryBooks_DisplayName_summarize:"Summarize - Bullet-point format",STMemoryBooks_DisplayName_synopsis:"Synopsis - Long and comprehensive (beats, interactions, details) with headings",STMemoryBooks_DisplayName_sumup:"Sum Up - Concise story beats in narrative prose",STMemoryBooks_DisplayName_minimal:"Minimal - Brief 1-2 sentence summary",STMemoryBooks_DisplayName_northgate:"Northgate - Intended for creative writing. By Northgate on ST Discord",STMemoryBooks_DisplayName_aelemar:"Aelemar - Focuses on plot points and character memories. By Aelemar on ST Discord",STMemoryBooks_DisplayName_comprehensive:"Comprehensive - Synopsis plus improved keywords extraction",STMemoryBooks_PromptManager_RecreateBuiltins:"♻️ Recreate Built-in Prompts",STMemoryBooks_RecreateBuiltinsTitle:"Recreate Built-in Prompts",STMemoryBooks_RecreateBuiltinsWarning:"This will remove overrides for all built‑in presets (summary, summarize, synopsis, sumup, minimal, northgate, aelemar, comprehensive). Any customizations to these built-ins will be lost. After this, built-ins will follow the current app locale.",STMemoryBooks_RecreateBuiltinsDoesNotAffectCustom:"This does not affect your other custom presets.",STMemoryBooks_RecreateBuiltinsOverwrite:"Overwrite",STMemoryBooks_RegexSelection_Title:"\uD83D\uDCD0 Regex selection",STMemoryBooks_RegexSelection_Desc:"Selecting a regex here will run it REGARDLESS of whether it is enabled or disabled.",STMemoryBooks_RegexSelection_Outgoing:"Run regex before sending to AI",STMemoryBooks_RegexSelection_Incoming:"Run regex before adding to lorebook (before previews)",STMemoryBooks_RegexSelect_PlaceholderOutgoing:"Select outgoing regex…",STMemoryBooks_RegexSelect_PlaceholderIncoming:"Select incoming regex…",STMemoryBooks_RegexSelectionsSaved:"Regex selections saved",STMemoryBooks_FailedToSaveRegexSelections:"Failed to save regex selections",STMemoryBooks_UseRegexAdvanced:"Use regex (advanced)",STMemoryBooks_ConfigureRegex:"\uD83D\uDCD0 Configure regex…"},b0={en:iG};import{getRegexScripts as F7}from"../../../extensions/regex/engine.js";import"../../../../lib/select2.min.js";async function B7(Z){try{if(Z?.prompt&&String(Z.prompt).trim())return Z.prompt;if(Z?.preset)return await G0(Z.preset)}catch(Q){console.warn(F("STMemoryBooks: getEffectivePromptAsync fallback due to error:","index.warn.getEffectivePromptAsync"),Q)}return d1()}async function Z$(){return String(J4())}function $5(){return O1}var j1="STMemoryBooks",q7=!1;var H7={moduleSettings:{alwaysUseDefault:!0,showMemoryPreviews:!1,showNotifications:!0,unhideBeforeMemory:!1,refreshEditor:!0,tokenWarningThreshold:50000,defaultMemoryCount:0,autoClearSceneAfterMemory:!1,manualModeEnabled:!1,allowSceneOverlap:!1,autoHideMode:"all",unhiddenEntriesCount:2,autoSummaryEnabled:!1,autoSummaryInterval:50,autoSummaryBuffer:2,autoCreateLorebook:!1,lorebookNameTemplate:"LTM - {{char}} - {{chat}}",useRegex:!1,selectedRegexOutgoing:[],selectedRegexIncoming:[]},titleFormat:"[000] - {{title}}",profiles:[],defaultProfile:0,migrationVersion:4},d=null,O1=!1,lZ=!1,w6=null,Y7=!1,g8=null,k0=null,u0=null,L6=null,B8=null,H8=null;var B0=null,u8=null;function Q$(Z){let Q=[];if(Z.matches&&Z.matches("#chat .mes[mesid]")){if(!Z.querySelector(".mes_stmb_start"))o8(Z),Q.push(Z)}else if(Z.querySelectorAll)Z.querySelectorAll("#chat .mes[mesid]").forEach((J)=>{if(!J.querySelector(".mes_stmb_start"))o8(J),Q.push(J)});return Q}function G$(){if(B0)B0.disconnect(),B0=null;let Z=document.getElementById("chat");if(!Z)throw Error(F("STMemoryBooks: Chat container not found. SillyTavern DOM structure may have changed.","index.error.chatContainerNotFound"));let Q=Y4();if(!Q||Q.start===null&&Q.end===null)n8();B0=new MutationObserver((G)=>{let J=[];for(let W of G)for(let q of W.addedNodes)if(q.nodeType===Node.ELEMENT_NODE)try{let z=Q$(q);J.push(...z)}catch(z){console.error(F("STMemoryBooks: Error processing new chat elements:","index.error.processingChatElements"),z)}if(J.length>0)clearTimeout(u8),u8=setTimeout(()=>{try{W4(J)}catch(W){console.error(F("STMemoryBooks: Error updating button states:","index.error.updatingButtonStates"),W)}},S6.CHAT_OBSERVER_DEBOUNCE_MS)}),B0.observe(Z,{childList:!0,subtree:!0}),console.log(F("STMemoryBooks: Chat observer initialized","index.log.chatObserverInitialized"))}function $$(){if(B0)B0.disconnect(),B0=null,console.log(F("STMemoryBooks: Chat observer disconnected","index.log.chatObserverDisconnected"));if(u8)clearTimeout(u8),u8=null}function J$(){console.log(F("STMemoryBooks: Chat changed - updating scene state","index.log.chatChanged")),n8(),O7(),setTimeout(()=>{try{N7()}catch(Z){console.error(F("STMemoryBooks: Error processing messages after chat change:","index.error.processingMessagesAfterChange"),Z)}},S6.CHAT_OBSERVER_DEBOUNCE_MS)}function O7(){let Z=g()||{},{sceneStart:Q,sceneEnd:G}=Z;if(Q!==null||G!==null){if(console.log(x`Found orphaned scene markers: start=${Q}, end=${G}`),!O1&&i[j1].moduleSettings.autoSummaryEnabled)n0()}}async function W$(){try{setTimeout(l0,x1.VALIDATION_DELAY_MS),await Q5(),await SZ()}catch(Z){console.error(F("STMemoryBooks: Error in handleMessageReceived:","index.error.handleMessageReceived"),Z)}}async function q$(){try{setTimeout(l0,x1.VALIDATION_DELAY_MS),await G5(),await SZ()}catch(Z){console.error(F("STMemoryBooks: Error in handleGroupWrapperFinished:","index.error.handleGroupWrapperFinished"),Z)}}async function Y$(Z,Q){if(!await D8())return console.error(F("STMemoryBooks: No scene markers set for createMemory command","index.error.noSceneMarkersForCreate")),toastr.error(F("No scene markers set. Use chevron buttons to mark start and end points first.","STMemoryBooks_NoSceneMarkersToastr"),F("STMemoryBooks","index.toast.title")),"";return v6(),""}async function z$(Z,Q){let G=String(Q||"").trim();if(!G)return toastr.error(F("Missing range argument. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_MissingRangeArgument"),F("STMemoryBooks","index.toast.title")),"";let J=G.match(/^(\d+)\s*[-–—]\s*(\d+)$/);if(!J)return toastr.error(F("Invalid format. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_InvalidFormat"),F("STMemoryBooks","index.toast.title")),"";let W=Number(J[1]),q=Number(J[2]);if(!Number.isFinite(W)||!Number.isFinite(q))return toastr.error(F("Invalid message IDs parsed. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_InvalidMessageIDs"),F("STMemoryBooks","index.toast.title")),"";if(W>q)return toastr.error(F("Start message cannot be greater than end message","STMemoryBooks_StartGreaterThanEnd"),F("STMemoryBooks","index.toast.title")),"";let z=j7;if(W<0||q>=z.length)return toastr.error(x`Message IDs out of range. Valid range: 0-${z.length-1}`,F("STMemoryBooks","index.toast.title")),"";if(!z[W]||!z[q])return toastr.error(F("One or more specified messages do not exist","STMemoryBooks_MessagesDoNotExist"),F("STMemoryBooks","index.toast.title")),"";E6(W,q);let Y=$8(),V=Y.isGroupChat?` in group "${Y.groupName}"`:"";return toastr.info(x`Scene set: messages ${W}-${q}${V}`,F("STMemoryBooks","index.toast.title")),v6(),""}async function X$(Z,Q){try{if(O1)return toastr.info(F("Memory creation is already in progress","STMemoryBooks_MemoryAlreadyInProgress"),F("STMemoryBooks","index.toast.title")),"";let G=await aZ();if(!G.valid)return toastr.error(F("No lorebook available: "+G.error,"STMemoryBooks_NoLorebookAvailable"),F("STMemoryBooks","index.toast.title")),"";let J=g()||{},W=j7.length-1;if(W<0)return toastr.info(F("There are no messages to summarize yet.","STMemoryBooks_NoMessagesToSummarize"),F("STMemoryBooks","index.toast.title")),"";let q=typeof J.highestMemoryProcessed==="number"?J.highestMemoryProcessed:null,z=q===null?0:q+1,Y=W;if(z>Y)return toastr.info(F("No new messages since the last memory.","STMemoryBooks_NoNewMessagesSinceLastMemory"),F("STMemoryBooks","index.toast.title")),"";E6(z,Y),await v6()}catch(G){console.error(F("STMemoryBooks: /nextmemory failed:","index.error.nextMemoryFailed"),G),toastr.error(F("Failed to run /nextmemory: "+G.message,"STMemoryBooks_NextMemoryFailed"),F("STMemoryBooks","index.toast.title"))}return""}async function V$(Z,Q){let G=String(Q||"").trim();if(!G)return toastr.info(F('SidePrompt guide: Type a template name after the space to see suggestions. Usage: /sideprompt "Name" [X-Y]. Quote names with spaces.',"STMemoryBooks_SidePromptGuide"),F("STMemoryBooks","index.toast.title")),"";let J=G.match(/^["']([^"']+)["']\s*(.*)$/)||G.match(/^(.+?)(\s+\d+\s*[-–—]\s*\d+)?$/),W=J?(J[1]||G).trim():G;try{let z=(await z0()).filter((Y)=>Y.name.toLowerCase().includes(W.toLowerCase()));if(z.length>1){let Y=z.slice(0,5).map((X)=>X.name).join(", "),V=z.length>5?`, +${z.length-5} more`:"";return toastr.info(x`Multiple matches: ${Y}${V}. Refine the name or use quotes. Usage: /sideprompt "Name" [X-Y]`,F("STMemoryBooks","index.toast.title")),""}return bZ(G)}catch{return bZ(G)}}async function A7(Z,Q,G){let J=String(Q||"").trim();if(!J)return toastr.error(F(G?'Missing name. Use: /sideprompt-on "Name" OR /sideprompt-on all':'Missing name. Use: /sideprompt-off "Name" OR /sideprompt-off all',"STMemoryBooks_SidePromptToggle_MissingName"),F("STMemoryBooks","index.toast.title")),"";try{let{findTemplateByName:W,upsertTemplate:q,listTemplates:z}=await Promise.resolve().then(() => (P8(),L5));if(J.toLowerCase()==="all"){let V=await z(),X=0;for(let K of V)if(K.enabled!==G)await q({key:K.key,enabled:G}),X++;try{window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated"))}catch(K){}return toastr.success(x`${G?"Enabled":"Disabled"} ${X} side prompt${X===1?"":"s"}`,F("STMemoryBooks","index.toast.title")),""}let Y=await W(J);if(!Y)return toastr.error(x`Side Prompt not found: ${J}`,F("STMemoryBooks","index.toast.title")),"";if(Y.enabled===G)return toastr.info(x`"${Y.name}" is already ${G?"enabled":"disabled"}`,F("STMemoryBooks","index.toast.title")),"";await q({key:Y.key,enabled:G});try{window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated"))}catch(V){}toastr.success(x`${G?"Enabled":"Disabled"} "${Y.name}"`,F("STMemoryBooks","index.toast.title"))}catch(W){console.error("STMemoryBooks: sideprompt enable/disable failed:",W),toastr.error(x`Failed to toggle side prompt: ${W.message}`,F("STMemoryBooks","index.toast.title"))}return""}async function K$(Z,Q){return A7(Z,Q,!0)}async function U$(Z,Q){return A7(Z,Q,!1)}var T7=[];async function rZ(){try{T7=(await z0()||[]).filter((Q)=>{let G=Q?.triggers?.commands;if(!("commands"in(Q?.triggers||{})))return!0;return Array.isArray(G)&&G.some((J)=>String(J).toLowerCase()==="sideprompt")}).map((Q)=>Q.name)}catch(Z){console.warn(F("STMemoryBooks: side prompt cache refresh failed","index.warn.sidePromptCacheRefreshFailed"),Z)}}window.addEventListener("stmb-sideprompts-updated",rZ);try{rZ()}catch(Z){}var oZ=()=>T7.map((Z)=>new nZ(Z));function _1(){if(i.STMemoryBooks=i.STMemoryBooks||G8(H7),(i.STMemoryBooks.migrationVersion??1)<4){if(!i.STMemoryBooks.profiles?.some((W)=>W.useDynamicSTSettings||W?.connection?.api==="current_st")){if(!i.STMemoryBooks.profiles)i.STMemoryBooks.profiles=[];let W={name:"Current SillyTavern Settings",connection:{api:"current_st"},preset:"summary",constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0};if(i.STMemoryBooks.profiles.unshift(W),i.STMemoryBooks.defaultProfile!==void 0)i.STMemoryBooks.defaultProfile+=1;console.log(x`${j1}: Added dynamic profile for existing installation (migration to v3)`)}i.STMemoryBooks.profiles.forEach((W)=>{if(W.useDynamicSTSettings&&W.titleFormat)delete W.titleFormat,console.log(x`${j1}: Removed static titleFormat from dynamic profile`)}),i.STMemoryBooks.migrationVersion=4,s()}if(!i.STMemoryBooks.profiles||i.STMemoryBooks.profiles.length===0){let J={name:"Current SillyTavern Settings",connection:{api:"current_st"},preset:"summary",constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0};i.STMemoryBooks.profiles=[J],console.log(x`${j1}: Created dynamic profile for fresh installation`)}let Q=j$(i.STMemoryBooks),G=UZ(i.STMemoryBooks);if(G.fixes.length>0)console.log(x`${j1}: Applied profile fixes:`,G.fixes),s();return Q}function j$(Z){if(!Z.profiles||Z.profiles.length===0)Z.profiles=[],Z.defaultProfile=0;if(Z.defaultProfile>=Z.profiles.length)Z.defaultProfile=0;if(!Z.moduleSettings)Z.moduleSettings=G8(H7.moduleSettings);if(!Z.moduleSettings.tokenWarningThreshold||Z.moduleSettings.tokenWarningThreshold<1000)Z.moduleSettings.tokenWarningThreshold=30000;if(Z.moduleSettings.defaultMemoryCount=U1(Z.moduleSettings.defaultMemoryCount??0,0,7),Z.moduleSettings.unhiddenEntriesCount===void 0||Z.moduleSettings.unhiddenEntriesCount===null)Z.moduleSettings.unhiddenEntriesCount=2;if(Z.moduleSettings.autoSummaryEnabled===void 0)Z.moduleSettings.autoSummaryEnabled=!1;if(Z.moduleSettings.autoSummaryInterval===void 0||Z.moduleSettings.autoSummaryInterval<10)Z.moduleSettings.autoSummaryInterval=100;if(Z.moduleSettings.autoSummaryBuffer=U1(Z.moduleSettings.autoSummaryBuffer??0,0,50),Z.moduleSettings.autoCreateLorebook===void 0)Z.moduleSettings.autoCreateLorebook=!1;if(Z.moduleSettings.unhideBeforeMemory===void 0)Z.moduleSettings.unhideBeforeMemory=!1;if(!Z.moduleSettings.lorebookNameTemplate)Z.moduleSettings.lorebookNameTemplate="LTM - {{char}} - {{chat}}";if(Z.moduleSettings.manualModeEnabled&&Z.moduleSettings.autoCreateLorebook)Z.moduleSettings.autoCreateLorebook=!1,console.warn(F("STMemoryBooks: Both manualModeEnabled and autoCreateLorebook were true - setting autoCreateLorebook to false","index.warn.mutualExclusion"));if(!Z.migrationVersion||Z.migrationVersion<2)console.log(x`${j1}: Migrating to JSON-based architecture (v2)`),Z.migrationVersion=2,Z.profiles.forEach((Q)=>{if(Q.prompt&&Q.prompt.includes("createMemory"))console.log(x`${j1}: Updating profile "${Q.name}" to use JSON output`),Q.prompt=d1()});return Z}async function aZ(Z=!1){let Q=i.STMemoryBooks,G=await J8();if(!Z){if(!G&&Q?.moduleSettings?.autoCreateLorebook&&!Q?.moduleSettings?.manualModeEnabled){let J=Q.moduleSettings.lorebookNameTemplate||"LTM - {{char}} - {{chat}}",W=await X6(J,"chat");if(W.success)G=W.name;else return{valid:!1,error:W.error}}}if(!G)return{valid:!1,error:"No lorebook available or selected."};if(!C6||!C6.includes(G))return{valid:!1,error:`Selected lorebook "${G}" not found.`};try{let J=await nG(G);return{valid:!!J,data:J,name:G}}catch(J){return{valid:!1,error:"Failed to load the selected lorebook."}}}async function F$(Z,Q,G=null){let J=_1(),W=J.moduleSettings.tokenWarningThreshold??30000,q=!J.moduleSettings.alwaysUseDefault||Z.estimatedTokens>W,z=null;if(q){let X=G!==null?G:J.defaultProfile;if(z=await A5(Z,J,Q1(),o(),g0,X),!z.confirmed)return null}else{let X=J.profiles[J.defaultProfile];z={confirmed:!0,profileSettings:{...X,effectivePrompt:await B7(X)},advancedOptions:{memoryCount:U1(J.moduleSettings.defaultMemoryCount??0,0,7),overrideSettings:!1}}}let{profileSettings:Y,advancedOptions:V}=z;if(Y?.connection?.api==="current_st"||V.overrideSettings){let X=o(),K=Q1();if(Y.effectiveConnection={api:X.completionSource||"openai",model:K.model||"",temperature:K.temperature??0.7},Y.useDynamicSTSettings)console.log("STMemoryBooks: Using dynamic ST settings profile - current settings:",Y.effectiveConnection);else console.log("STMemoryBooks: Using current SillyTavern settings override for memory creation")}else Y.effectiveConnection={...Y.connection},console.log("STMemoryBooks: Using profile connection settings for memory creation");return{profileSettings:Y,summaryCount:V.memoryCount??0,tokenThreshold:W,settings:J}}function B$(Z){if(Z&&Z.name==="AIResponseError"){if(typeof Z.recoverable==="boolean")return Z.recoverable;if(Z.code&&String(Z.code).toUpperCase().includes("TRUNCATION"))return!0}if(["TokenWarningError","InvalidProfileError"].includes(Z?.name))return!1;if(Z?.message&&(Z.message.includes("Scene compilation failed")||Z.message.includes("Invalid memory result")||Z.message.includes("Invalid lorebook")))return!1;return!0}async function sZ(Z,Q,G,J=0){let{profileSettings:W,summaryCount:q,tokenThreshold:z,settings:Y}=G;w6=W;let V=null,X=null,K=null;try{if(Y?.moduleSettings?.convertExistingRecursion&&Q?.valid&&Q.data?.entries){let U=V8(Q.data)||[],O=U.length>0?U[0].entry:null,B=!!W.preventRecursion,T=!!W.delayUntilRecursion,H=!1;if(!O)H=!1;else{let N=!!O.preventRecursion,R=!!O.delayUntilRecursion;H=N!==B||R!==T}if(H){let N=0,R=0,w=Object.values(Q.data.entries||{});for(let v of w)if(v&&v.stmemorybooks===!0){N++;let y=v.preventRecursion!==B,h=v.delayUntilRecursion!==T;if(y||h)v.preventRecursion=B,v.delayUntilRecursion=T,R++}if(R>0){try{if(await sG(Q.name,Q.data,!0),Y.moduleSettings?.refreshEditor)try{rG(Q.name)}catch(v){}}catch(v){console.warn("STMemoryBooks: Failed to save lorebook during recursion conversion:",v)}try{toastr.info(x`Updated recursion flags on ${R} of ${N} memory entr${R===1?"y":"ies"}`,"STMemoryBooks")}catch(v){}}}}}catch(U){console.warn("STMemoryBooks: convertExistingRecursion check failed:",U)}let j=c8.MAX_RETRIES;try{if(Y?.moduleSettings?.unhideBeforeMemory)try{await oG(`/unhide ${Z.sceneStart}-${Z.sceneEnd}`)}catch(h){console.warn("STMemoryBooks: /unhide command failed or unavailable:",h)}let U=a0(Z.sceneStart,Z.sceneEnd);V=r0(U);let O=w4(V);if(!O.valid)throw Error(`Scene compilation failed: ${O.errors.join(", ")}`);let B=[];if(X={summaries:[],actualCount:0,requestedCount:0},q>0)if(X=await v0(q,Y,g0),B=X.summaries,X.actualCount>0){if(X.actualCount<X.requestedCount)toastr.warning(x`Only ${X.actualCount} of ${X.requestedCount} requested memories available`,"STMemoryBooks");console.log(`STMemoryBooks: Including ${X.actualCount} previous memories as context`)}else toastr.warning(F("No previous memories found in lorebook","STMemoryBooks_NoPreviousMemoriesFound"),"STMemoryBooks");let T;if(J>0)T=`Retrying memory creation (attempt ${J+1}/${j+1})...`;else T=X.actualCount>0?`Creating memory with ${X.actualCount} context memories...`:"Creating memory...";toastr.info(x`${T}`,"STMemoryBooks",{timeOut:0}),V.previousSummariesContext=B,K=await I4(V);let H=K?.estimatedTokens,N=await l4(V,W,{tokenWarningThreshold:z}),R=N;if(Y.moduleSettings.showMemoryPreviews){toastr.clear();let h=await U8(N,Z,W);if(h.action==="cancel")return;else if(h.action==="retry"){let P=J>=j?J-j:0;if(P>=3)return toastr.warning(x`Maximum retry attempts (${3}) reached`,"STMemoryBooks"),{action:"cancel"};toastr.info(x`Retrying memory generation (${P+1}/${3})...`,"STMemoryBooks");let b=Math.max(J+1,j+P+1);return await sZ(Z,Q,G,b)}if(h.action==="accept")R=N;else if(h.action==="edit"){if(!h.memoryData){console.error("STMemoryBooks: Edit action missing memoryData"),toastr.error(F("Unable to retrieve edited memory data","STMemoryBooks_UnableToRetrieveEditedMemoryData"),"STMemoryBooks");return}if(!h.memoryData.extractedTitle||!h.memoryData.content){console.error("STMemoryBooks: Edited memory data missing required fields"),toastr.error(F("Edited memory data is incomplete","STMemoryBooks_EditedMemoryDataIncomplete"),"STMemoryBooks");return}R=h.memoryData}else console.warn(`STMemoryBooks: Unexpected preview action: ${h.action}`),R=N}let w=await YZ(R,Q);if(!w.success)throw Error(w.error||"Failed to add memory to lorebook");try{let h=W?.effectiveConnection||W?.connection||{};console.debug("STMemoryBooks: Passing profile to runAfterMemory",{api:h.api,model:h.model,temperature:h.temperature}),await EZ(V,W)}catch(h){console.warn("STMemoryBooks: runAfterMemory failed:",h)}try{let h=g()||{};h.highestMemoryProcessed=Z.sceneEnd,Z1()}catch(h){console.warn("STMemoryBooks: Failed to update highestMemoryProcessed baseline:",h)}VZ();let v=X.actualCount>0?` (with ${X.actualCount} context ${X.actualCount===1?"memory":"memories"})`:"";toastr.clear(),k0=null,g8=null,u0=null;let y=J>0?` (succeeded on attempt ${J+1})`:"";toastr.success(x`Memory "${w.entryTitle}" created successfully${v}${y}!`,"STMemoryBooks")}catch(U){if(console.error("STMemoryBooks: Error creating memory:",U),J<j&&B$(U))return toastr.warning(x`Memory creation failed (attempt ${J+1}). Retrying in ${Math.round(c8.RETRY_DELAY_MS/1000)} seconds...`,"STMemoryBooks",{timeOut:3000}),await new Promise((H)=>setTimeout(H,c8.RETRY_DELAY_MS)),await sZ(Z,Q,G,J+1);let B=J>0?` (failed after ${J+1} attempts)`:"",T=U&&U.code?` [${U.code}]`:"";if(U.name==="TokenWarningError")toastr.error(x`Scene is too large (${U.tokenCount} tokens). Try selecting a smaller range${B}.`,"STMemoryBooks",{timeOut:8000});else if(U.name==="AIResponseError"){try{toastr.clear(k0)}catch(H){}g8=U,u0={sceneData:Z,compiledScene:V,profileSettings:W,lorebookValidation:Q,memoryFetchResult:X,sceneStats:K,settings:Y,summaryCount:q,tokenThreshold:z,sceneRange:V?.metadata?.sceneStart!==void 0?`${V.metadata.sceneStart}-${V.metadata.sceneEnd}`:`${Z.sceneStart}-${Z.sceneEnd}`},k0=toastr.error(x`AI failed to generate valid memory${T}: ${U.message}${B}`,"STMemoryBooks",{timeOut:0,extendedTimeOut:0,closeButton:!0,tapToDismiss:!1,onclick:()=>{try{f$(g8)}catch(H){console.error(H)}}})}else if(U.name==="InvalidProfileError")toastr.error(x`Profile configuration error: ${U.message}${B}`,"STMemoryBooks",{timeOut:8000});else toastr.error(x`Failed to create memory: ${U.message}${B}`,"STMemoryBooks")}}async function v6(Z=null){let Q=$8();if(!Q.isGroupChat){if(!pZ||pZ.length===0||!pZ[lG]){toastr.error(F("SillyTavern is still loading character data, please wait a few seconds and try again.","STMemoryBooks_LoadingCharacterData"),"STMemoryBooks");return}}else if(!Q.groupId||!Q.groupName){toastr.error(F("Group chat data not available, please wait a few seconds and try again.","STMemoryBooks_GroupChatDataUnavailable"),"STMemoryBooks");return}if(O1)return;O1=!0;try{let G=_1(),J=await D8();if(!J){console.error("STMemoryBooks: No scene selected for memory initiation"),toastr.error(F("No scene selected","STMemoryBooks_NoSceneSelected"),"STMemoryBooks"),O1=!1;return}let W=await aZ();if(!W.valid){console.error("STMemoryBooks: Lorebook validation failed:",W.error),toastr.error(F(W.error,"STMemoryBooks_LorebookValidationError"),"STMemoryBooks"),O1=!1;return}let q=V8(W.data),z=J.sceneStart,Y=J.sceneEnd;if(!G.moduleSettings.allowSceneOverlap)for(let X of q){let K=a4(X.entry);if(K&&K.start!==null&&K.end!==null){let j=Number(K.start),U=Number(K.end),O=Number(z),B=Number(Y);if(console.debug(`STMemoryBooks: OverlapCheck new=[${O}-${B}] existing="${X.title}" [${j}-${U}] cond1(ns<=e)=${O<=U} cond2(ne>=s)=${B>=j}`),O<=U&&B>=j){console.error(`STMemoryBooks: Scene overlap detected with memory: ${X.title} [${j}-${U}] vs new [${O}-${B}]`),toastr.error(x`Scene overlaps with existing memory: "${X.title}" (messages ${j}-${U})`,"STMemoryBooks"),O1=!1;return}}}let V=await F$(J,W,Z);if(!V){O1=!1;return}if(d)d.completeCancelled(),d=null;await sZ(J,W,V)}catch(G){console.error("STMemoryBooks: Critical error during memory initiation:",G),toastr.error(x`An unexpected error occurred: ${G.message}`,"STMemoryBooks")}finally{O1=!1}}function h6(Z){if(Z.autoHideMode)return Z.autoHideMode;if(Z.autoHideAllMessages)return"all";else if(Z.autoHideLastMemory)return"last";else return"none"}function z7(){let Z=i.STMemoryBooks;if(!Z)return;let Q=g()||{},G=Z.moduleSettings.manualModeEnabled,J=document.querySelector("#stmb-mode-badge");if(J)J.textContent=G?F("Manual","STMemoryBooks_Manual"):F("Automatic (Chat-bound)","STMemoryBooks_AutomaticChatBound");let W=document.querySelector("#stmb-active-lorebook");if(W){let K=G?Q.manualLorebook:g0?.[m8];W.textContent=K||F("None selected","STMemoryBooks_NoneSelected"),W.className=K?"":"opacity50p"}let q=document.querySelector("#stmb-manual-controls");if(q)q.style.display=G?"block":"none";let z=document.querySelector("#stmb-automatic-info");if(z){z.style.display=G?"none":"block";let K=z.querySelector("small");if(K){let j=g0?.[m8]??null;K.innerHTML=j?x`Using chat-bound lorebook "<strong>${j}</strong>"`:F("No chat-bound lorebook. Memories will require lorebook selection.","STMemoryBooks_NoChatBoundLorebook")}}let Y=document.querySelector("#stmb-auto-create-lorebook"),V=document.querySelector("#stmb-manual-mode-enabled"),X=document.querySelector("#stmb-lorebook-name-template");if(Y&&V){let K=Z.moduleSettings.autoCreateLorebook;if(Y.disabled=G,V.disabled=K,X)X.disabled=!K}}function M6(){if(!d?.dlg)return;let Z=_1(),Q=g()||{},G=d.content.querySelector("#stmb-manual-lorebook-buttons"),J=d.content.querySelector("#stmb-profile-buttons"),W=d.content.querySelector("#stmb-extra-function-buttons"),q=d.content.querySelector("#stmb-prompt-manager-buttons");if(G&&Z.moduleSettings.manualModeEnabled){let X=Q.manualLorebook??null,K=[{text:`\uD83D\uDCD5 ${X?F("Change","STMemoryBooks_ChangeManualLorebook"):F("Select","STMemoryBooks_SelectManualLorebook")} `+F("Manual Lorebook","STMemoryBooks_ManualLorebook"),id:"stmb-select-manual-lorebook",action:async()=>{try{if(await N0(X?Q.manualLorebook:null))Z0()}catch(j){console.error("STMemoryBooks: Error selecting manual lorebook:",j),toastr.error(F("Failed to select manual lorebook","STMemoryBooks_FailedToSelectManualLorebook"),"STMemoryBooks")}}}];if(X)K.push({text:"❌ "+F("Clear Manual Lorebook","STMemoryBooks_ClearManualLorebook"),id:"stmb-clear-manual-lorebook",action:()=>{try{let j=g()||{};delete j.manualLorebook,Z1(),Z0(),toastr.success(F("Manual lorebook cleared","STMemoryBooks_ManualLorebookCleared"),"STMemoryBooks")}catch(j){console.error("STMemoryBooks: Error clearing manual lorebook:",j),toastr.error(F("Failed to clear manual lorebook","STMemoryBooks_FailedToClearManualLorebook"),"STMemoryBooks")}}});G.innerHTML="",K.forEach((j)=>{let U=document.createElement("div");U.className="menu_button interactable whitespacenowrap",U.id=j.id,U.textContent=j.text,U.addEventListener("click",j.action),G.appendChild(U)})}if(!J||!W)return;let z=[{text:"⭐ "+F("Set as Default","STMemoryBooks_SetAsDefault"),id:"stmb-set-default-profile",action:()=>{let X=d?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let K=U1(W1(X,Z.defaultProfile??0),0,Z.profiles.length-1);if(K===Z.defaultProfile)return;Z.defaultProfile=K,s();let j=Z.profiles[K]?.connection?.api==="current_st"?F("Current SillyTavern Settings","STMemoryBooks_Profile_CurrentST"):Z.profiles[K].name;toastr.success(x`"${j}" is now the default profile.`,"STMemoryBooks"),Z0()}},{text:"✏️ "+F("Edit Profile","STMemoryBooks_EditProfile"),id:"stmb-edit-profile",action:async()=>{try{let X=d?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let K=U1(W1(X,Z.defaultProfile??0),0,Z.profiles.length-1),j=Z.profiles[K];if(j.useDynamicSTSettings)j.connection=j.connection||{},j.connection.api="current_st",delete j.useDynamicSTSettings,s();await Y5(Z,K,Z0)}catch(X){console.error(`${j1}: Error in edit profile:`,X),toastr.error(F("Failed to edit profile","STMemoryBooks_FailedToEditProfile"),"STMemoryBooks")}}},{text:"➕ "+F("New Profile","STMemoryBooks_NewProfile"),id:"stmb-new-profile",action:async()=>{try{await z5(Z,Z0)}catch(X){console.error(`${j1}: Error in new profile:`,X),toastr.error(F("Failed to create profile","STMemoryBooks_FailedToCreateProfile"),"STMemoryBooks")}}},{text:"\uD83D\uDDD1️ "+F("Delete Profile","STMemoryBooks_DeleteProfile"),id:"stmb-delete-profile",action:async()=>{try{let X=d?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let K=W1(X,Z.defaultProfile??0);await X5(Z,K,Z0)}catch(X){console.error(`${j1}: Error in delete profile:`,X),toastr.error(F("Failed to delete profile","STMemoryBooks_FailedToDeleteProfile"),"STMemoryBooks")}}}],Y=[{text:"\uD83D\uDCE4 "+F("Export Profiles","STMemoryBooks_ExportProfiles"),id:"stmb-export-profiles",action:()=>{try{V5(Z)}catch(X){console.error(`${j1}: Error in export profiles:`,X),toastr.error(F("Failed to export profiles","STMemoryBooks_FailedToExportProfiles"),"STMemoryBooks")}}},{text:"\uD83D\uDCE5 "+F("Import Profiles","STMemoryBooks_ImportProfiles"),id:"stmb-import-profiles",action:()=>{let X=d?.dlg?.querySelector("#stmb-import-file");if(X)X.click()}}],V=[{text:"\uD83E\uDDE9 "+F("Summary Prompt Manager","STMemoryBooks_SummaryPromptManager"),id:"stmb-prompt-manager",action:async()=>{try{await d0()}catch(X){console.error(`${j1}: Error opening prompt manager:`,X),toastr.error(F("Failed to open Summary Prompt Manager","STMemoryBooks_FailedToOpenSummaryPromptManager"),"STMemoryBooks")}}},{text:"\uD83E\uDDF1 "+F("Arc Prompt Manager","STMemoryBooks_ArcPromptManager"),id:"stmb-arc-prompt-manager",action:async()=>{try{await c0()}catch(X){console.error(`${j1}: Error opening Arc Prompt Manager:`,X),toastr.error(F("Failed to open Arc Prompt Manager","STMemoryBooks_FailedToOpenArcPromptManager"),"STMemoryBooks")}}},{text:"\uD83C\uDFA1 "+F("Trackers & Side Prompts","STMemoryBooks_SidePrompts"),id:"stmb-side-prompts",action:async()=>{try{await b5()}catch(X){console.error(`${j1}: Error opening Trackers & Side Prompts Manager:`,X),toastr.error(F("Failed to open Trackers & Side Prompts Manager","STMemoryBooks_FailedToOpenSidePrompts"),"STMemoryBooks")}}}];J.innerHTML="",W.innerHTML="",q.innerHTML="",z.forEach((X)=>{let K=document.createElement("div");K.className="menu_button interactable whitespacenowrap",K.id=X.id,K.textContent=X.text,K.addEventListener("click",X.action),J.appendChild(K)}),Y.forEach((X)=>{let K=document.createElement("div");K.className="menu_button interactable whitespacenowrap",K.id=X.id,K.textContent=X.text,K.addEventListener("click",X.action),W.appendChild(K)}),V.forEach((X)=>{let K=document.createElement("div");K.className="menu_button interactable whitespacenowrap",K.id=X.id,K.textContent=X.text,K.addEventListener("click",X.action),q.appendChild(K)})}async function d0(){try{let Z=i.STMemoryBooks;await Z8(Z);let Q=await A0(),G='<h3 data-i18n="STMemoryBooks_PromptManager_Title">\uD83E\uDDE9 Summary Prompt Manager</h3>';G+='<div class="world_entry_form_control">',G+='<p data-i18n="STMemoryBooks_PromptManager_Desc">Manage your summary generation prompts. All presets are editable.</p>',G+="</div>",G+='<div class="world_entry_form_control">',G+='<input type="text" id="stmb-prompt-search" class="text_pole" placeholder="Search presets..." aria-label="Search presets" data-i18n="[placeholder]STMemoryBooks_PromptManager_Search;[aria-label]STMemoryBooks_PromptManager_Search" />',G+="</div>",G+='<div id="stmb-preset-list" class="padding10 marginBot10" style="max-height: 400px; overflow-y: auto;"></div>',G+='<div class="buttons_block justifyCenter gap10px whitespacenowrap">',G+='<button id="stmb-pm-new" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_New">➕ New Preset</button>',G+='<button id="stmb-pm-export" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_Export">\uD83D\uDCE4 Export JSON</button>',G+='<button id="stmb-pm-import" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_Import">\uD83D\uDCE5 Import JSON</button>',G+='<button id="stmb-pm-recreate-builtins" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_RecreateBuiltins">♻️ Recreate Built-in Prompts</button>',G+='<button id="stmb-pm-apply" class="menu_button whitespacenowrap" disabled data-i18n="STMemoryBooks_PromptManager_ApplyToProfile">✅ Apply to Selected Profile</button>',G+="</div>",G+=`<small>${F(`\uD83D\uDCA1 When creating a new prompt, copy one of the other built-in prompts and then amend it. Don't change the "respond with JSON" instructions, \uD83D\uDCD5Memory Books uses that to process the returned result from the AI.`,"STMemoryBooks_PromptManager_Hint")}</small>`,G+='<input type="file" id="stmb-pm-import-file" accept=".json" style="display: none;" />';let J=new G1(G,a.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:!1,cancelButton:F("Close","STMemoryBooks_Close")});H$(J);let W=J.dlg?.querySelector("#stmb-preset-list");if(W){let q=(Q||[]).map((z)=>({key:String(z.key||""),displayName:String(z.displayName||"")}));W.innerHTML=m0.sanitize(cZ({items:q}))}await J.show()}catch(Z){console.error("STMemoryBooks: Error showing prompt manager:",Z),toastr.error(F("Failed to open Summary Prompt Manager","STMemoryBooks_FailedToOpenSummaryPromptManager"),"STMemoryBooks")}}function H$(Z){let Q=Z.dlg,G=null;Q.addEventListener("click",async(W)=>{let q=W.target.closest(".stmb-action");if(q){W.preventDefault(),W.stopPropagation();let Y=q.closest("tr[data-preset-key]"),V=Y?.dataset.presetKey;if(!V)return;if(Q.querySelectorAll("tr[data-preset-key]").forEach((K)=>{K.classList.remove("ui-state-active"),K.style.backgroundColor="",K.style.border=""}),Y)Y.style.backgroundColor="var(--cobalt30a)",Y.style.border="",G=V;let X=Q.querySelector("#stmb-pm-apply");if(X)X.disabled=!1;if(q.classList.contains("stmb-action-edit"))await X7(Z,V);else if(q.classList.contains("stmb-action-duplicate"))await V7(Z,V);else if(q.classList.contains("stmb-action-delete"))await K7(Z,V);return}let z=W.target.closest("tr[data-preset-key]");if(z){Q.querySelectorAll("tr[data-preset-key]").forEach((V)=>{V.classList.remove("ui-state-active"),V.style.backgroundColor="",V.style.border=""}),z.style.backgroundColor="var(--cobalt30a)",z.style.border="",G=z.dataset.presetKey;let Y=Q.querySelector("#stmb-pm-apply");if(Y)Y.disabled=!1}});let J=Q.querySelector("#stmb-prompt-search");if(J)J.addEventListener("input",(W)=>{let q=W.target.value.toLowerCase();Q.querySelectorAll("tr[data-preset-key]").forEach((z)=>{let Y=z.querySelector("td:first-child").textContent.toLowerCase();z.style.display=Y.includes(q)?"":"none"})});Q.querySelector("#stmb-pm-new")?.addEventListener("click",async()=>{await O$(Z)}),Q.querySelector("#stmb-pm-edit")?.addEventListener("click",async()=>{if(G)await X7(Z,G)}),Q.querySelector("#stmb-pm-duplicate")?.addEventListener("click",async()=>{if(G)await V7(Z,G)}),Q.querySelector("#stmb-pm-delete")?.addEventListener("click",async()=>{if(G)await K7(Z,G)}),Q.querySelector("#stmb-pm-export")?.addEventListener("click",async()=>{await A$()}),Q.querySelector("#stmb-pm-import")?.addEventListener("click",()=>{Q.querySelector("#stmb-pm-import-file")?.click()}),Q.querySelector("#stmb-pm-import-file")?.addEventListener("change",async(W)=>{await T$(W,Z)}),Q.querySelector("#stmb-pm-recreate-builtins")?.addEventListener("click",async()=>{try{let W=`
    ...
    `,a.TEXT,"",{okButton:F("Create","STMemoryBooks_Create"),cancelButton:F("Cancel","STMemoryBooks_Cancel")});if(await G.show()===l.AFFIRMATIVE){let W=G.dlg.querySelector("#stmb-apm-new-display-name").value.trim(),q=G.dlg.querySelector("#stmb-apm-new-prompt").value.trim();if(!q){toastr.error(F("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),"STMemoryBooks");return}try{await mZ(null,q,W||null),toastr.success(F("Preset created successfully","STMemoryBooks_PresetCreatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Z.completeAffirmative(),await c0()}catch(z){console.error("STMemoryBooks: Error creating arc preset:",z),toastr.error(F("Failed to create preset","STMemoryBooks_FailedToCreatePreset"),"STMemoryBooks")}}}async function D$(Z,Q){try{let G=await uZ(Q),J=await N6(Q),W=`
            <h3 data-i18n="STMemoryBooks_EditPresetTitle">Edit Preset</h3>
            <div class="world_entry_form_control">
        ...
        `,q=new G1(W,a.TEXT,"",{okButton:F("Save","STMemoryBooks_Save"),cancelButton:F("Cancel","STMemoryBooks_Cancel")});if(await q.show()===l.AFFIRMATIVE){let Y=q.dlg.querySelector("#stmb-apm-edit-display-name").value.trim(),V=q.dlg.querySelector("#stmb-apm-edit-prompt").value.trim();if(!V){toastr.error(F("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),"STMemoryBooks");return}await mZ(Q,V,Y||null),toastr.success(F("Preset updated successfully","STMemoryBooks_PresetUpdatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Z.completeAffirmative(),await c0()}}catch(G){console.error("STMemoryBooks: Error editing arc preset:",G),toastr.error(F("Failed to edit preset","STMemoryBooks_FailedToEditPreset"),"STMemoryBooks")}}async function _$(Z,Q){try{let G=await m5(Q);toastr.success(F("Preset duplicated successfully","STMemoryBooks_PresetDuplicatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Z.completeAffirmative(),await c0()}catch(G){console.error("STMemoryBooks: Error duplicating arc preset:",G),toastr.error(F("Failed to duplicate preset","STMemoryBooks_FailedToDuplicatePreset"),"STMemoryBooks")}}async function I$(Z,Q){let G=await uZ(Q),J=new G1(`<h3 data-i18n="STMemoryBooks_DeletePresetTitle">Delete Preset</h3><p>${E(F('Are you sure you want to delete "{{name}}"?',"STMemoryBooks_DeletePresetConfirm",{name:G}))}</p>`,a.CONFIRM,"",{okButton:F("Delete","STMemoryBooks_Delete"),cancelButton:F("Cancel","STMemoryBooks_Cancel")});try{O8(J.dlg)}catch(q){}if(await J.show()===l.AFFIRMATIVE)try{await d5(Q),toastr.success(F("Preset deleted successfully","STMemoryBooks_PresetDeletedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Z.completeAffirmative(),await c0()}catch(q){console.error("STMemoryBooks: Error deleting arc preset:",q),toastr.error(F("Failed to delete preset","STMemoryBooks_FailedToDeletePreset"),"STMemoryBooks")}}async function w$(){try{let Z=await c5(),Q=new Blob([Z],{type:"application/json"}),G=URL.createObjectURL(Q),J=document.createElement("a");J.href=G,J.download="stmb-arc-prompts.json",J.click(),URL.revokeObjectURL(G),toastr.success(F("Prompts exported successfully","STMemoryBooks_PromptsExportedSuccessfully"),"STMemoryBooks")}catch(Z){console.error("STMemoryBooks: Error exporting arc prompts:",Z),toastr.error(F("Failed to export prompts","STMemoryBooks_FailedToExportPrompts"),"STMemoryBooks")}}async function L$(Z,Q){let G=Z.target.files[0];if(!G)return;try{let J=await G.text();await p5(J),toastr.success(F("Prompts imported successfully","STMemoryBooks_PromptsImportedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Q.completeAffirmative(),await c0()}catch(J){console.error("STMemoryBooks: Error importing arc prompts:",J),toastr.error(x`Failed to import prompts: ${J.message}`,"STMemoryBooks")}}async function C$(){try{let Z=await aZ(!0),Q=Z?.name||null,G=Z?.data||{entries:{}};if(!Z?.valid||!Q)toastr.info("No memory lorebook currently assigned, no memories found.","SillyTavern Memory Books"),Q=null,G={entries:{}};let J=Object.values(G.entries||{}),W=(_)=>{if(typeof _!=="string")return 0;let P=_.match(/\[(\d+)\]/);if(P)return parseInt(P[1],10);let b=_.match(/^(\d+)[\s-]/);if(b)return parseInt(b[1],10);return 0},q=J.filter((_)=>_&&_.stmemorybooks===!0&&_.stmbArc!==!0&&!_.disable).sort((_,P)=>W(_.comment||"")-W(P.comment||""));await gZ(i?.STMemoryBooks);let z=await T6(),Y="arc_default",X=_1()?.moduleSettings?.tokenWarningThreshold??30000,K="";K+=`<h3>${E(F("\uD83C\uDF08 Consolidate Memories into Arcs","STMemoryBooks_ConsolidateArcs_Title"))}</h3>`,K+='<div class="world_entry_form_control">',K+=`<label><strong>${E(F("Preset","STMemoryBooks_ConsolidateArcs_Preset"))}:</strong> `,K+='<select id="stmb-arc-preset" class="text_pole">';for(let _ of z){let P=String(_.key||""),b=String(_.displayName||P),f=P===Y?" selected":"";K+=`<option value="${E(P)}"${f}>${E(b)}</option>`}K+=`</select></label> <button id="stmb-arc-rebuild-builtins" class="menu_button whitespacenowrap">${E(F("Rebuild from built-ins","STMemoryBooks_Arc_RebuildBuiltins"))}</button></div>`,K+='<div class="flex-container flexGap10">',K+=`<label>${E(F("Maximum number of memories to process in each pass","STMemoryBooks_Arc_MaxPerPass"))} <input id="stmb-arc-maxpass" type="number" min="1" max="50" value="12" class="text_pole" style="width:80px"/></label>`,K+=`<label>${E(F("Number of automatic arc attempts","STMemoryBooks_Arc_MaxPasses"))} <input id="stmb-arc-maxpasses" type="number" min="1" max="50" value="10" class="text_pole" style="width:100px"/></label>`,K+=`<label>${E(F("Minimum number of memories in each arc","STMemoryBooks_Arc_MinAssigned"))} <input id="stmb-arc-minassigned" type="number" min="1" max="12" value="2" class="text_pole" style="width:110px"/></label>`,K+=`<label>${E(F("Token Budget","STMemoryBooks_Arc_TokenBudget"))} <input id="stmb-arc-token" type="number" min="1000" max="100000" value="${X}" class="text_pole" style="width:120px"/></label>`,K+="</div>",K+='<div class="world_entry_form_control">',K+=`<label><input id="stmb-arc-disable-originals" type="checkbox"/> ${E(F("Disable originals after creating arcs","STMemoryBooks_ConsolidateArcs_DisableOriginals"))}</label>`,K+="</div>",K+='<div class="world_entry_form_control"><div class="flex-container flexGap10 marginBot5">',K+=`<button id="stmb-arc-select-all" class="menu_button">${E(F("Select All","STMemoryBooks_SelectAll"))}</button>`,K+=`<button id="stmb-arc-deselect-all" class="menu_button">${E(F("Deselect All","STMemoryBooks_DeselectAll"))}</button>`,K+="</div>",K+='<div id="stmb-arc-list" style="max-height:300px; overflow-y:auto; border:1px solid var(--SmartHover2); padding:6px">';for(let _ of q){let P=_.comment||"(untitled)",b=String(_.uid),f=W(P);K+=`<label class="flex-container flexGap10" style="align-items:center; margin:2px 0;"><input type="checkbox" class="stmb-arc-item" value="${E(b)}" checked /> <span class="opacity70p">[${String(f).padStart(3,"0")}]</span> <span>${E(P)}</span></label>`}K+="</div>",K+=`<small class="opacity70p">${E(F("Tip: uncheck memories that should not be included.","STMemoryBooks_ConsolidateArcs_Tip"))}</small>`,K+="</div>";let j=new G1(m0.sanitize(K),a.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:F("Run","STMemoryBooks_Run"),cancelButton:F("Cancel","STMemoryBooks_Cancel")}),U=j.dlg;try{O8(U)}catch(_){}if(U.querySelector("#stmb-arc-select-all")?.addEventListener("click",(_)=>{_.preventDefault(),U.querySelectorAll(".stmb-arc-item").forEach((P)=>P.checked=!0)}),U.querySelector("#stmb-arc-deselect-all")?.addEventListener("click",(_)=>{_.preventDefault(),U.querySelectorAll(".stmb-arc-item").forEach((P)=>P.checked=!1)}),U.querySelector("#stmb-arc-rebuild-builtins")?.addEventListener("click",async(_)=>{_.preventDefault();try{let P=`
                ...
                `;if(await new G1(P,a.CONFIRM,"",{okButton:F("Rebuild","STMemoryBooks_Rebuild"),cancelButton:F("Cancel","STMemoryBooks_Cancel")}).show()!==l.AFFIRMATIVE)return;let m=await l5({backup:!0}),M=await T6(),r=U.querySelector("#stmb-arc-preset");if(r){let v1=r.value||Y;r.innerHTML="";for(let $1 of M){let F1=String($1.key||""),o1=String($1.displayName||F1),A1=document.createElement("option");A1.value=F1,A1.textContent=o1,r.appendChild(A1)}if(Array.from(r.options).some(($1)=>$1.value===v1))r.value=v1;else r.value=Y}try{window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated"))}catch(v1){}let g1=m?.backupName?` (backup: ${m.backupName}) `:"";toastr.success(x`Rebuilt Arc prompts (${m?.count||0} presets)${g1}`,"STMemoryBooks")}catch(P){console.error("STMemoryBooks: Arc prompts rebuild failed:",P),toastr.error(x`Failed to rebuild Arc prompts: ${P.message}`,"STMemoryBooks")}}),await j.show()!==l.AFFIRMATIVE)return;let B=Array.from(U.querySelectorAll(".stmb-arc-item")).filter((_)=>_.checked).map((_)=>_.value);if(B.length===0){toastr.error(F("Select at least one memory to consolidate.","STMemoryBooks_SelectAtLeastOne"),"STMemoryBooks");return}if(!Q){toastr.info("Arc consolidation requires a memory lorebook. No lorebook assigned.","STMemoryBooks");return}let H={presetKey:String(U.querySelector("#stmb-arc-preset")?.value||"arc_default"),maxItemsPerPass:Math.max(1,W1(U.querySelector("#stmb-arc-maxpass"),12)),maxPasses:Math.max(1,W1(U.querySelector("#stmb-arc-maxpasses"),10)),minAssigned:Math.max(1,W1(U.querySelector("#stmb-arc-minassigned"),2)),tokenTarget:Math.max(1000,W1(U.querySelector("#stmb-arc-token"),X))},N=!!U.querySelector("#stmb-arc-disable-originals")?.checked,R=new Map(q.map((_)=>[String(_.uid),_])),w=B.map((_)=>R.get(String(_))).filter(Boolean);toastr.info(F("Consolidating memories into arcs...","STMemoryBooks_ConsolidatingArcs"),"STMemoryBooks",{timeOut:0});let v;try{v=await $7(w,H,null)}catch(_){try{toastr.clear(B8)}catch(P){}if(L6=_,H8={lorebookName:Q,lorebookData:G,selectedEntries:w,options:H,disableOriginals:N},_?.name==="ArcAIResponseError")B8=toastr.error(x`Arc analysis failed (invalid JSON): ${_.message}`,"STMemoryBooks",{timeOut:0,extendedTimeOut:0,closeButton:!0,tapToDismiss:!1,onclick:()=>{try{y$(L6)}catch(P){console.error(P)}}});else toastr.error(x`Arc analysis failed: ${_.message}`,"STMemoryBooks");return}let{arcCandidates:y,leftovers:h}=v||{arcCandidates:[],leftovers:[]};if(!y||y.length===0){toastr.warning(F("No arcs were produced. Try different settings or selection.","STMemoryBooks_NoArcsProduced"),"STMemoryBooks");return}try{let _=await dZ({lorebookName:Q,lorebookData:G,arcCandidates:y,disableOriginals:N}),P=Array.isArray(_?.results)?_.results.length:y.length,b=`Created ${P} arc${P===1?"":"s"}${h?.length?`, ${h.length} leftover`:""}.`;if(P===1&&(!h||h.length===0))b+=" (all selected memories were consumed into a single arc)";toastr.success(x`${b}`,"STMemoryBooks"),L6=null,H8=null;try{toastr.clear(B8)}catch(f){}B8=null}catch(_){toastr.error(x`Failed to commit arcs: ${_.message}`,"STMemoryBooks")}}catch(Z){console.error("STMemoryBooks: showArcConsolidationPopup failed:",Z),toastr.error(x`Failed to open consolidate popup: ${Z.message}`,"STMemoryBooks")}}async function h$(){let Z=_1();await Z8(Z);let Q=await D8(),G=Array.isArray(Z.moduleSettings.selectedRegexOutgoing)?Z.moduleSettings.selectedRegexOutgoing:[],J=Array.isArray(Z.moduleSettings.selectedRegexIncoming)?Z.moduleSettings.selectedRegexIncoming:[],W=[];try{(F7({allowedOnly:!1})||[]).forEach((T,H)=>{let N=`idx:${H}`,R=`${T?.scriptName||"Untitled"}${T?.disabled?" (disabled)":""}`;W.push({key:N,label:R,selectedOutgoing:G.includes(N),selectedIncoming:J.includes(N)})})}catch(B){console.warn("STMemoryBooks: Failed to enumerate Regex scripts for UI",B)}let q=Z.profiles[Z.defaultProfile],z=g(),Y=Z.moduleSettings.manualModeEnabled,V=g0?.[m8]??null,X=z?.manualLorebook??null,K={hasScene:!!Q,sceneData:Q,highestMemoryProcessed:z?.highestMemoryProcessed,alwaysUseDefault:Z.moduleSettings.alwaysUseDefault,showMemoryPreviews:Z.moduleSettings.showMemoryPreviews,showNotifications:Z.moduleSettings.showNotifications,unhideBeforeMemory:Z.moduleSettings.unhideBeforeMemory||!1,refreshEditor:Z.moduleSettings.refreshEditor,allowSceneOverlap:Z.moduleSettings.allowSceneOverlap,manualModeEnabled:Z.moduleSettings.manualModeEnabled,lorebookMode:Y?"Manual":"Automatic (Chat-bound)",currentLorebookName:Y?X:V,manualLorebookName:X,chatBoundLorebookName:V,availableLorebooks:C6??[],autoHideMode:h6(Z.moduleSettings),unhiddenEntriesCount:Z.moduleSettings.unhiddenEntriesCount??2,tokenWarningThreshold:Z.moduleSettings.tokenWarningThreshold??50000,defaultMemoryCount:Z.moduleSettings.defaultMemoryCount??0,autoSummaryEnabled:Z.moduleSettings.autoSummaryEnabled??!1,autoSummaryInterval:Z.moduleSettings.autoSummaryInterval??50,autoSummaryBuffer:Z.moduleSettings.autoSummaryBuffer??2,autoCreateLorebook:Z.moduleSettings.autoCreateLorebook??!1,lorebookNameTemplate:Z.moduleSettings.lorebookNameTemplate||"LTM - {{char}} - {{chat}}",profiles:Z.profiles.map((B,T)=>({...B,name:B?.connection?.api==="current_st"?F("Current SillyTavern Settings","STMemoryBooks_Profile_CurrentST"):B.name,isDefault:T===Z.defaultProfile})),titleFormat:Z.titleFormat,useRegex:Z.moduleSettings.useRegex||!1,regexOptions:W,selectedRegexOutgoing:G,selectedRegexIncoming:J,titleFormats:q0().map((B)=>({value:B,isSelected:B===Z.titleFormat})),showCustomInput:!q0().includes(Z.titleFormat),selectedProfile:{...q,connection:q.useDynamicSTSettings||q?.connection?.api==="current_st"?(()=>{let B=o(),T=Q1();return{api:B.completionSource||"openai",model:T.model||"Not Set",temperature:T.temperature??0.7}})():{api:q.connection?.api||"openai",model:q.connection?.model||"Not Set",temperature:q.connection?.temperature!==void 0?q.connection.temperature:0.7},titleFormat:q.titleFormat||Z.titleFormat,effectivePrompt:q.prompt&&q.prompt.trim()?q.prompt:q.preset?await G0(q.preset):d1()}},j=m0.sanitize(jZ(K)),U=[];U.push({text:"\uD83E\uDDE0 "+F("Create Memory","STMemoryBooks_CreateMemoryButton"),result:null,classes:["menu_button"],action:async()=>{if(!Q){toastr.error(F("No scene selected. Make sure both start and end points are set.","STMemoryBooks_NoSceneSelectedMakeSure"),"STMemoryBooks");return}let B=Z.defaultProfile;if(d&&d.dlg){let T=d.dlg.querySelector("#stmb-profile-select");if(T)B=parseInt(T.value)||Z.defaultProfile,console.log(`STMemoryBooks: Using profile index ${B} (${Z.profiles[B]?.name}) from main popup selection`)}await v6(B)}}),U.push({text:"\uD83C\uDF08 "+F("Consolidate Memories into Arcs","STMemoryBooks_ConsolidateArcsButton"),result:null,classes:["menu_button"],action:async()=>{await C$()}}),U.push({text:"\uD83D\uDDD1️ "+F("Clear Scene","STMemoryBooks_ClearSceneButton"),result:null,classes:["menu_button"],action:()=>{n0(),Z0()}});let O={wide:!0,large:!0,allowVerticalScrolling:!0,customButtons:U,cancelButton:F("Close","STMemoryBooks_Close"),okButton:!1,onClose:v$};try{d=new G1(j,a.TEXT,"",O),M$(),M6(),await d.show()}catch(B){console.error("STMemoryBooks: Error showing settings popup:",B),d=null}}function M$(){if(!d)return;let Z=d.dlg;Z.addEventListener("click",async(Q)=>{let G=_1();if(Q.target&&Q.target.matches("#stmb-configure-regex")){Q.preventDefault();try{await g$()}catch(J){console.warn("STMemoryBooks: showRegexSelectionPopup failed",J)}return}}),Z.addEventListener("change",async(Q)=>{let G=_1();if(Q.target.matches("#stmb-use-regex")){G.moduleSettings.useRegex=Q.target.checked,s();let J=Z.querySelector("#stmb-configure-regex");if(J)J.style.display=Q.target.checked?"":"none";return}if(Q.target.matches("#stmb-regex-outgoing")){try{let J=Array.from(Q.target.selectedOptions||[]).map((W)=>W.value);G.moduleSettings.selectedRegexOutgoing=J,s()}catch(J){console.warn("STMemoryBooks: failed to save selectedRegexOutgoing",J)}return}if(Q.target.matches("#stmb-regex-incoming")){try{let J=Array.from(Q.target.selectedOptions||[]).map((W)=>W.value);G.moduleSettings.selectedRegexIncoming=J,s()}catch(J){console.warn("STMemoryBooks: failed to save selectedRegexIncoming",J)}return}if(Q.target.matches("#stmb-import-file")){try{K5(Q,G,Z0)}catch(J){console.error(`${j1}: Error in import profiles:`,J),toastr.error(F("Failed to import profiles","STMemoryBooks_FailedToImportProfiles"),"STMemoryBooks")}return}if(Q.target.matches("#stmb-allow-scene-overlap")){G.moduleSettings.allowSceneOverlap=Q.target.checked,s();return}if(Q.target.matches("#stmb-unhide-before-memory")){G.moduleSettings.unhideBeforeMemory=Q.target.checked,s();return}if(Q.target.matches("#stmb-manual-mode-enabled")){let J=Q.target.checked;if(J){G.moduleSettings.autoCreateLorebook=!1;let W=document.querySelector("#stmb-auto-create-lorebook");if(W)W.checked=!1}if(J){let W=g0?.[m8],q=g()||{};if(!q.manualLorebook){if(W){let z=`
                        ...
                        `;if(await new G1(z,a.TEXT,"",{okButton:F("Use Chat-bound","STMemoryBooks_UseChatBound"),cancelButton:F("Select Different","STMemoryBooks_SelectDifferent")}).show()===l.AFFIRMATIVE)q.manualLorebook=W,Z1(),toastr.success(x`Manual lorebook set to "${W}"`,"STMemoryBooks");else if(!await N0(W)){Q.target.checked=!1;return}}else if(toastr.info(F("Please select a lorebook for manual mode","STMemoryBooks_PleaseSelectLorebookForManualMode"),"STMemoryBooks"),!await N0()){Q.target.checked=!1;return}}}G.moduleSettings.manualModeEnabled=Q.target.checked,s(),z7(),M6();return}if(Q.target.matches("#stmb-auto-hide-mode")){G.moduleSettings.autoHideMode=Q.target.value,delete G.moduleSettings.autoHideAllMessages,delete G.moduleSettings.autoHideLastMemory,s();return}if(Q.target.matches("#stmb-profile-select")){let J=U1(W1(Q.target),0,profiles.length-1);if(J>=0&&J<G.profiles.length){let W=G.profiles[J],q=Z.querySelector("#stmb-summary-api"),z=Z.querySelector("#stmb-summary-model"),Y=Z.querySelector("#stmb-summary-temp"),V=Z.querySelector("#stmb-summary-title"),X=Z.querySelector("#stmb-summary-prompt");if(W.useDynamicSTSettings||W?.connection?.api==="current_st"){let K=o(),j=Q1();if(q)q.textContent=K.completionSource||"openai";if(z)z.textContent=j.model||F("Not Set","STMemoryBooks_NotSet");if(Y)Y.textContent=Number(j.temperature??0.7)}else{if(q)q.textContent=W.connection?.api||"openai";if(z)z.textContent=W.connection?.model||F("Not Set","STMemoryBooks_NotSet");if(Y)Y.textContent=W.connection?.temperature!==void 0?W.connection.temperature:"0.7"}if(V)V.textContent=W.titleFormat||G.titleFormat;if(X)X.textContent=await B7(W)}return}if(Q.target.matches("#stmb-title-format-select")){let J=Z.querySelector("#stmb-custom-title-format"),W=Z.querySelector("#stmb-summary-title");if(Q.target.value==="custom")J.classList.remove("displayNone"),J.focus();else if(J.classList.add("displayNone"),G.titleFormat=Q.target.value,s(),W)W.textContent=Q.target.value;return}if(Q.target.matches("#stmb-default-memory-count")){let J=U1(W1(Q.target,G.moduleSettings.defaultMemoryCount??0),0,7);G.moduleSettings.defaultMemoryCount=J;return}if(Q.target.matches("#stmb-auto-summary-enabled")){G.moduleSettings.autoSummaryEnabled=Q.target.checked,s();return}if(Q.target.matches("#stmb-auto-create-lorebook")){if(Q.target.checked){G.moduleSettings.manualModeEnabled=!1;let W=document.querySelector("#stmb-manual-mode-enabled");if(W)W.checked=!1}G.moduleSettings.autoCreateLorebook=Q.target.checked,s(),z7(),M6();return}if(Q.target.matches("#stmb-auto-summary-interval")){let J=parseInt(Q.target.value);if(!isNaN(J)&&J>=10&&J<=200)G.moduleSettings.autoSummaryInterval=J,s();return}if(Q.target.matches("#stmb-auto-summary-buffer")){let J=W1(Q.target);G.moduleSettings.autoSummaryBuffer=U1(J??0,0,50),s();return}}),Z.addEventListener("input",aG.debounce((Q)=>{let G=_1();if(Q.target.matches("#stmb-custom-title-format")){let J=Q.target.value.trim();if(J&&J.includes("000")){G.titleFormat=J,s();let W=Z.querySelector("#stmb-summary-title");if(W)W.textContent=J}return}if(Q.target.matches("#stmb-lorebook-name-template")){let J=Q.target.value.trim();if(J)G.moduleSettings.lorebookNameTemplate=J,s();return}if(Q.target.matches("#stmb-token-warning-threshold")){let J=parseInt(Q.target.value);if(!isNaN(J)&&J>=1000&&J<=1e5)G.moduleSettings.tokenWarningThreshold=J,s();return}if(Q.target.matches("#stmb-unhidden-entries-count")){let J=parseInt(Q.target.value);if(!isNaN(J)&&J>=0&&J<=50)G.moduleSettings.unhiddenEntriesCount=J,s();return}},1000))}function v$(Z){try{let Q=Z.dlg,G=_1(),J=Q.querySelector("#stmb-always-use-default")?.checked??G.moduleSettings.alwaysUseDefault,W=Q.querySelector("#stmb-show-memory-previews")?.checked??G.moduleSettings.showMemoryPreviews,q=Q.querySelector("#stmb-show-notifications")?.checked??G.moduleSettings.showNotifications,z=Q.querySelector("#stmb-unhide-before-memory")?.checked??G.moduleSettings.unhideBeforeMemory,Y=Q.querySelector("#stmb-refresh-editor")?.checked??G.moduleSettings.refreshEditor,V=Q.querySelector("#stmb-allow-scene-overlap")?.checked??G.moduleSettings.allowSceneOverlap,X=Q.querySelector("#stmb-auto-hide-mode")?.value??h6(G.moduleSettings),K=W1(Q.querySelector("#stmb-token-warning-threshold"),G.moduleSettings.tokenWarningThreshold??50000),j=Number(Q.querySelector("#stmb-default-memory-count").value),U=W1(Q.querySelector("#stmb-unhidden-entries-count"),G.moduleSettings.unhiddenEntriesCount??0),O=Q.querySelector("#stmb-manual-mode-enabled")?.checked??G.moduleSettings.manualModeEnabled,B=Q.querySelector("#stmb-auto-summary-enabled")?.checked??G.moduleSettings.autoSummaryEnabled,T=W1(Q.querySelector("#stmb-auto-summary-interval"),G.moduleSettings.autoSummaryInterval??50),H=U1(W1(Q.querySelector("#stmb-auto-summary-buffer"),G.moduleSettings.autoSummaryBuffer??0),0,50),N=Q.querySelector("#stmb-auto-create-lorebook")?.checked??G.moduleSettings.autoCreateLorebook;if(J!==G.moduleSettings.alwaysUseDefault||W!==G.moduleSettings.showMemoryPreviews||q!==G.moduleSettings.showNotifications||z!==G.moduleSettings.unhideBeforeMemory||Y!==G.moduleSettings.refreshEditor||K!==G.moduleSettings.tokenWarningThreshold||j!==G.moduleSettings.defaultMemoryCount||O!==G.moduleSettings.manualModeEnabled||V!==G.moduleSettings.allowSceneOverlap||X!==h6(G.moduleSettings)||U!==G.moduleSettings.unhiddenEntriesCount||B!==G.moduleSettings.autoSummaryEnabled||T!==G.moduleSettings.autoSummaryInterval||H!==G.moduleSettings.autoSummaryBuffer||N!==G.moduleSettings.autoCreateLorebook)G.moduleSettings.alwaysUseDefault=J,G.moduleSettings.showMemoryPreviews=W,G.moduleSettings.showNotifications=q,G.moduleSettings.unhideBeforeMemory=z,G.moduleSettings.refreshEditor=Y,G.moduleSettings.tokenWarningThreshold=K,G.moduleSettings.defaultMemoryCount=j,G.moduleSettings.manualModeEnabled=O,G.moduleSettings.allowSceneOverlap=V,G.moduleSettings.autoHideMode=X,delete G.moduleSettings.autoHideAllMessages,delete G.moduleSettings.autoHideLastMemory,G.moduleSettings.unhiddenEntriesCount=U,G.moduleSettings.autoSummaryEnabled=B,G.moduleSettings.autoSummaryInterval=T,G.moduleSettings.autoSummaryBuffer=H,G.moduleSettings.autoCreateLorebook=N,s()}catch(Q){console.error("STMemoryBooks: Failed to save settings:",Q),toastr.warning(F("Failed to save settings. Please try again.","STMemoryBooks_FailedToSaveSettings"),"STMemoryBooks")}d=null}async function Z0(){if(!d||!d.dlg.hasAttribute("open"))return;try{let Z=_1(),Q=await D8(),G=Z.profiles[Z.defaultProfile],J=g(),W=Z.moduleSettings.manualModeEnabled,q=g0?.[m8]||null,z=J?.manualLorebook||null,Y={hasScene:!!Q,sceneData:Q,highestMemoryProcessed:J?.highestMemoryProcessed,alwaysUseDefault:Z.moduleSettings.alwaysUseDefault,showMemoryPreviews:Z.moduleSettings.showMemoryPreviews,showNotifications:Z.moduleSettings.showNotifications,unhideBeforeMemory:Z.moduleSettings.unhideBeforeMemory||!1,refreshEditor:Z.moduleSettings.refreshEditor,allowSceneOverlap:Z.moduleSettings.allowSceneOverlap,manualModeEnabled:Z.moduleSettings.manualModeEnabled,lorebookMode:W?"Manual":"Automatic (Chat-bound)",currentLorebookName:W?z:q,manualLorebookName:z,chatBoundLorebookName:q,availableLorebooks:C6??[],autoHideMode:h6(Z.moduleSettings),unhiddenEntriesCount:Z.moduleSettings.unhiddenEntriesCount??0,tokenWarningThreshold:Z.moduleSettings.tokenWarningThreshold??50000,defaultMemoryCount:Z.moduleSettings.defaultMemoryCount??0,autoSummaryEnabled:Z.moduleSettings.autoSummaryEnabled??!1,autoSummaryInterval:Z.moduleSettings.autoSummaryInterval??50,autoSummaryBuffer:Z.moduleSettings.autoSummaryBuffer??0,autoCreateLorebook:Z.moduleSettings.autoCreateLorebook??!1,lorebookNameTemplate:Z.moduleSettings.lorebookNameTemplate||"LTM - {{char}} - {{chat}}",profiles:Z.profiles.map((j,U)=>({...j,name:j?.connection?.api==="current_st"?F("Current SillyTavern Settings","STMemoryBooks_Profile_CurrentST"):j.name,isDefault:U===Z.defaultProfile})),titleFormat:Z.titleFormat,titleFormats:q0().map((j)=>({value:j,isSelected:j===Z.titleFormat})),showCustomInput:!q0().includes(Z.titleFormat),selectedProfile:{...G,connection:G.useDynamicSTSettings||G?.connection?.api==="current_st"?(()=>{let j=o(),U=Q1();return{api:j.completionSource||"openai",model:U.model||"Not Set",temperature:U.temperature??0.7}})():{api:G.connection?.api||"openai",model:G.connection?.model||"gpt-4.1",temperature:G.connection?.temperature??0.7},titleFormat:G.titleFormat||Z.titleFormat,effectivePrompt:G.prompt&&G.prompt.trim()?G.prompt:G.preset?await G0(G.preset):d1()}},V=m0.sanitize(jZ(Y));d.content.innerHTML=V;let X=d.content.querySelector("#stmb-profile-select");if(X)X.value=Z.defaultProfile,X.dispatchEvent(new Event("change"));let K=["wide_dialogue_popup","large_dialogue_popup","vertical_scrolling_dialogue_popup"];d.dlg.classList.add(...K),d.content.style.overflowY="auto",M6()}catch(Z){console.error("STMemoryBooks: Error refreshing popup content:",Z)}}function N7(){let Z=document.querySelectorAll("#chat .mes[mesid]");if(Z.length>0){let Q=0;Z.forEach((G)=>{if(!G.querySelector(".mes_stmb_start"))o8(G),Q++}),l8()}}function P$(){let Z=f0.fromProps({name:"creatememory",callback:Y$,helpString:F("Create memory from marked scene","STMemoryBooks_Slash_CreateMemory_Help")}),Q=f0.fromProps({name:"scenememory",callback:z$,helpString:F("Set scene range and create memory (e.g., /scenememory 10-15)","STMemoryBooks_Slash_SceneMemory_Help"),unnamedArgumentList:[I6.fromProps({description:F("Message range (X-Y format)","STMemoryBooks_Slash_SceneMemory_ArgRangeDesc"),typeList:[_6.STRING],isRequired:!0})]}),G=f0.fromProps({name:"nextmemory",callback:X$,helpString:F("Create memory from end of last memory to current message","STMemoryBooks_Slash_NextMemory_Help")}),J=f0.fromProps({name:"sideprompt",callback:V$,helpString:F('Run side prompt. Usage: /sideprompt "Name" [X-Y]',"STMemoryBooks_Slash_SidePrompt_Help"),unnamedArgumentList:[I6.fromProps({description:F("Template name (quote if contains spaces), optionally followed by X-Y range","STMemoryBooks_Slash_SidePrompt_ArgDesc"),typeList:[_6.STRING],isRequired:!0,enumProvider:oZ})]}),W=f0.fromProps({name:"sideprompt-on",callback:K$,helpString:F('Enable a Side Prompt by name or all. Usage: /sideprompt-on "Name" | all',"STMemoryBooks_Slash_SidePromptOn_Help"),unnamedArgumentList:[I6.fromProps({description:F('Template name (quote if contains spaces) or "all"',"STMemoryBooks_Slash_SidePromptOn_ArgDesc"),typeList:[_6.STRING],isRequired:!0,enumProvider:()=>[new nZ("all"),...oZ()]})]}),q=f0.fromProps({name:"sideprompt-off",callback:U$,helpString:F('Disable a Side Prompt by name or all. Usage: /sideprompt-off "Name" | all',"STMemoryBooks_Slash_SidePromptOff_Help"),unnamedArgumentList:[I6.fromProps({description:F('Template name (quote if contains spaces) or "all"',"STMemoryBooks_Slash_SidePromptOff_ArgDesc"),typeList:[_6.STRING],isRequired:!0,enumProvider:()=>[new nZ("all"),...oZ()]})]}),z=f0.fromProps({name:"stmb-highest",callback:Z$,helpString:F("Return the highest message index for processed memories in this chat. Usage: /stmb-highest","STMemoryBooks_Slash_Highest_Help"),returns:"Highest memory processed message index as a string."});y0.addCommandObject(Z),y0.addCommandObject(Q),y0.addCommandObject(G),y0.addCommandObject(J),y0.addCommandObject(W),y0.addCommandObject(q),y0.addCommandObject(z)}function x$(){let Z=$(`
