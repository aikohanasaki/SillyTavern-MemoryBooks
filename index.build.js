...
`).filter((G)=>G.trim());if(Q.length>0){let J=Q[0].trim().replace(/^(You are|Analyze|Create|Generate|Write)\s+/i,"").replace(/[:.]/g,"").trim();return L8(J.substring(0,50))}return"Custom Prompt"}function u6(Z,Q){let G=y7(Z),J=G,W=2,q=R1();while(J in Q||J in q)J=`${G}-${W}`,W++;return J}async function r0(Z=null){if(G8)return G8;let Q=!1,G=null;try{let J=await fetch(`/user/files/${j4}`,{method:"GET",credentials:"include",headers:K4()});if(!J.ok)Q=!0;else{let W=await J.text();if(G=JSON.parse(W),!F4(G))Q=!0}}catch(J){Q=!0}if(Q){let J={},W=new Date().toISOString(),q=R1();for(let[z,Y]of Object.entries(q))J[z]={displayName:g6[z]||L8(z),prompt:Y,createdAt:W};if(Z&&Z.profiles&&Array.isArray(Z.profiles)){for(let z of Z.profiles)if(z.prompt&&z.prompt.trim()){let Y=`Custom: ${z.name||"Unnamed Profile"}`,K=u6(Y,J);J[K]={displayName:Y,prompt:z.prompt,createdAt:W},console.log(`${I0}: Migrated custom prompt from profile "${z.name}" as "${K}"`)}}G={version:s0.CURRENT_VERSION,overrides:J},await $8(G)}return G8=G,G8}async function $8(Z){try{let Q=JSON.stringify(Z,null,2),G=btoa(unescape(encodeURIComponent(Q))),J=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:K4(),body:JSON.stringify({name:j4,data:G})});if(!J.ok)throw Error(`Failed to save prompts: ${J.statusText}`);G8=Z,console.log(`${I0}: Prompts saved successfully`)}catch(Q){throw console.error(`${I0}: Error saving overrides:`,Q),Q}}function F4(Z){if(!Z||typeof Z!=="object")return console.error(`${I0}: Invalid data type`),!1;if(typeof Z.version!=="number")return console.error(`${I0}: Invalid schema version type: ${Z.version}`),!1;if(Z.version!==s0.CURRENT_VERSION)console.warn(`${I0}: Unexpected schema version: ${Z.version} (expected ${s0.CURRENT_VERSION})`);if(!Z.overrides||typeof Z.overrides!=="object")return console.error(`${I0}: Missing or invalid overrides object`),!1;for(let[Q,G]of Object.entries(Z.overrides)){if(!G||typeof G!=="object")return console.error(`${I0}: Invalid override entry for key: ${Q}`),!1;if(typeof G.prompt!=="string"||!G.prompt.trim())return console.error(`${I0}: Invalid or empty prompt for key: ${Q}`),!1;if(G.displayName!==void 0&&typeof G.displayName!=="string")return console.error(`${I0}: Invalid displayName for key: ${Q}`),!1}return!0}async function J8(Z){return await r0(Z),E7=!0,b7=null,!0}async function T1(Z=null){let Q=await r0(Z),G=[];for(let[W,q]of Object.entries(Q.overrides))G.push({key:W,displayName:q.displayName||L8(W),createdAt:q.createdAt||null});let J=R1()||{};for(let W of Object.keys(J))if(!(W in Q.overrides))G.push({key:W,displayName:g6[W]||L8(W),createdAt:null});return G.sort((W,q)=>{if(!W.createdAt)return 1;if(!q.createdAt)return-1;return new Date(q.createdAt)-new Date(W.createdAt)}),G}async function G1(Z,Q=null){let G=await r0(Q);if(G.overrides[Z]){let W=G.overrides[Z].prompt;if(typeof W==="string"&&W.trim())return W}return R1()[Z]||d0()}async function m6(Z,Q=null){let G=await r0(Q);if(G.overrides[Z]&&G.overrides[Z].displayName)return G.overrides[Z].displayName;return g6[Z]||L8(Z)}async function w8(Z,Q,G){let J=await r0(),W=new Date().toISOString();if(!Z)Z=u6(G||V4(Q),J.overrides);if(J.overrides[Z])J.overrides[Z].prompt=Q,J.overrides[Z].displayName=G||J.overrides[Z].displayName,J.overrides[Z].updatedAt=W;else J.overrides[Z]={displayName:G||V4(Q),prompt:Q,createdAt:W};return await $8(J),Z}async function U4(Z){let Q=await r0(),G=Q.overrides[Z];if(!G)throw Error(`Preset "${Z}" not found`);let J=`${G.displayName} (Copy)`,W=u6(J,Q.overrides),q=new Date().toISOString();return Q.overrides[W]={displayName:J,prompt:G.prompt,createdAt:q},await $8(Q),W}async function H4(Z){let Q=await r0();if(!Q.overrides[Z])throw Error(`Preset "${Z}" not found`);delete Q.overrides[Z],await $8(Q)}async function B4(){let Z=await r0();return JSON.stringify(Z,null,2)}async function O4(Z){try{let Q=JSON.parse(Z);if(!F4(Q))throw Error("Invalid prompts file structure - see console for details");await $8(Q)}catch(Q){throw console.error(`${I0}: Error importing prompts:`,Q),Q}}async function A4(Z="overwrite"){if(Z!=="overwrite")console.warn(`${I0}: Unsupported mode for recreateBuiltInPrompts: ${Z}; defaulting to 'overwrite'`);let Q=await r0(),G=R1(),J=Object.keys(G||{}),W=0;if(Q&&Q.overrides&&typeof Q.overrides==="object"){for(let q of J)if(q in Q.overrides)delete Q.overrides[q],W++}return await $8(Q),G8=Q,console.log(`${I0}: Recreated built-in prompts (removed ${W} overrides)`),{removed:W}}var I0="STMemoryBooks-SummaryPromptManager",j4,G8=null,E7=!1,b7=null,g6;var t8=N1(()=>{b0();D1();j4=s1.PROMPTS_FILE,g6=Object.fromEntries(Object.keys(_8).map((Z)=>[Z,S7(_8[Z],l8[Z])]))});var I4={};$4(I4,{validateProfile:()=>X8,showLorebookSelectionPopup:()=>_1,resolveEffectiveConnectionFromProfile:()=>o6,readIntInput:()=>J0,parseTemperature:()=>n6,normalizeCompletionSource:()=>q0,isValidPreset:()=>i7,getUIModelSettings:()=>Q0,getPresetPrompt:()=>c7,getPresetNames:()=>p7,getEffectivePrompt:()=>I1,getEffectiveLorebookName:()=>z8,getDefaultPrompt:()=>d0,getCurrentModelSettings:()=>d7,getCurrentMemoryBooksContext:()=>Y8,getCurrentApiInfo:()=>o,getBuiltInPresetPrompts:()=>R1,getApiSelectors:()=>l6,generateSafeProfileName:()=>L1,formatPresetDisplayName:()=>l7,estimateTokens:()=>$1,deepClone:()=>q8,createProfileObject:()=>J1,clampInt:()=>K0,SELECTORS:()=>a0});import{chat_metadata as W8,characters as d6,name2 as c6,this_chid as p6}from"../../../../script.js";import{getContext as f7,extension_settings as D4}from"../../../extensions.js";import{selected_group as T4,groups as k7}from"../../../group-chats.js";import{METADATA_KEY as i6,world_names as e8}from"../../../world-info.js";import{Popup as R4,POPUP_TYPE as _4,POPUP_RESULT as Z6}from"../../../popup.js";import{translate as c0}from"../../../i18n.js";function g7(...Z){for(let Q of Z){let G=v0(Q);if(G.length)return G}return v0()}function u7(){return document.querySelector("#group_chat_completion_source")?"#group_":"#"}function J0(Z,Q){if(!Z)return Q;let G=parseInt(Z.value,10);return Number.isFinite(G)?G:Q}function K0(Z,Q,G){return Math.min(Math.max(Z,Q),G)}function q0(Z){let Q=String(Z||"").trim().toLowerCase();if(Q==="google")return"makersuite";return Q===""?"openai":Q}function o(){try{let Z="unknown",Q="unknown",G="unknown";if(typeof window.getGeneratingApi==="function")Z=window.getGeneratingApi();else Z=v0(a0.mainApi).val()||"unknown";if(typeof window.getGeneratingModel==="function")Q=window.getGeneratingModel();if(G=v0(a0.completionSource).val()||Z,!m7.includes(G))console.warn(`${p0}: Unsupported completion source: ${G}, falling back to openai`),G="openai";return{api:Z,model:Q,completionSource:G}}catch(Z){return console.warn(`${p0}: Error getting API info:`,Z),{api:v0(a0.mainApi).val()||"unknown",model:"unknown",completionSource:v0(a0.completionSource).val()||"openai"}}}function l6(){let Z=u7(),G=g7(`${Z}chat_completion_source`,"#chat_completion_source").val?.()||"openai",J={openai:`${Z}model_openai_select`,claude:`${Z}model_claude_select`,openrouter:`${Z}model_openrouter_select`,ai21:`${Z}model_ai21_select`,makersuite:`${Z}model_google_select`,mistralai:`${Z}model_mistralai_select`,custom:`${Z}model_custom_select`,cohere:`${Z}model_cohere_select`,perplexity:`${Z}model_perplexity_select`,groq:`${Z}model_groq_select`,nanogpt:`${Z}model_nanogpt_select`,deepseek:`${Z}model_deepseek_select`,electronhub:`${Z}model_electronhub_select`,vertexai:`${Z}model_vertexai_select`,aimlapi:`${Z}model_aimlapi_select`,xai:`${Z}model_xai_select`,pollinations:`${Z}model_pollinations_select`,moonshot:`${Z}model_moonshot_select`,fireworks:`${Z}model_fireworks_select`,cometapi:`${Z}model_cometapi_select`,azure_openai:`${Z}model_azure_openai_select`},W=J[G]||J.openai,q=`${Z}temp_openai`.replace("##","#"),z=`${Z}temp_counter_openai`.replace("##","#");return{model:W,temp:q,tempCounter:z}}function Y8(){try{let Z=null,Q=null,G=null,J=!!T4,W=T4||null,q=null;if(J){let X=k7?.find((V)=>V.id===W);if(X)q=X.name,Q=X.chat_id,G=Q,Z=q}else{if(c6&&c6.trim())Z=String(c6).trim();else if(p6!==void 0&&d6&&d6[p6])Z=d6[p6].name;else if(W8?.character_name)Z=String(W8.character_name).trim();if(Z&&Z.normalize)Z=Z.normalize("NFC");try{let X=f7();if(X?.chatId)Q=X.chatId,G=Q;else if(typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}catch(X){if(console.warn(`${p0}: Could not get context, trying fallback methods`),typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}}let z=null;if(W8&&i6 in W8)z=W8[i6];let Y=null;try{let X=o(),V=l6(),F=v0(V.temp).val()??v0(V.tempCounter).val(),j=Number.isFinite(parseFloat(F))?parseFloat(F):0.7,O=v0(V.model).val()||"";Y={api:X.api,model:O,temperature:j,completionSource:X.completionSource,source:"current_ui"}}catch(X){console.warn(`${p0}: Could not get current model/temperature settings:`,X),Y=null}let K={characterName:Z,chatId:Q,chatName:G,groupId:W,isGroupChat:J,lorebookName:z,modelSettings:Y};if(J)K.groupName=q;return K}catch(Z){return console.warn(`${p0}: Error getting context:`,Z),{characterName:null,chatId:null,chatName:null,groupId:null,groupName:null,isGroupChat:!1}}}async function z8(){if(!D4.STMemoryBooks.moduleSettings.manualModeEnabled)return W8?.[i6]||null;let Q=f();if(Q.manualLorebook??null)if(e8.includes(Q.manualLorebook))return Q.manualLorebook;else toastr.error(`The designated manual lorebook "${Q.manualLorebook}" no longer exists. Please select a new one.`),delete Q.manualLorebook;let G=e8.map((z)=>`<option value="${z}">${z}</option>`).join("");if(G.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let J=`
    ...
    `,W=new R4(J,_4.TEXT,"",{okButton:"Select",cancelButton:"Cancel"});if(await W.show()===Z6.AFFIRMATIVE){let z=W.dlg.querySelector("#stmb-manual-lorebook-select").value;return Q.manualLorebook=z,Z0(),toastr.success(`"${z}" is now the Memory Book for this chat.`,"STMemoryBooks"),z}return null}async function _1(Z=null){if(e8.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let Q=e8.map((q)=>{return`<option value="${q}"${q===Z?" selected":""}>${q}</option>`}).join(""),G=`
        <h4>Select a Memory Book</h4>
        <div class="world_entry_form_control">
...
===`,"STMemoryBooks_AssessResponseFormat"),settings:{overrideProfileEnabled:!1,lorebook:{constVectMode:"blue",position:2,orderMode:"manual",orderValue:30,preventRecursion:!0,delayUntilRecursion:!1}},triggers:{onAfterMemory:{enabled:!0},commands:["sideprompt"]},createdAt:Z,updatedAt:Z}}return Q}function NZ(){return{version:Math.max(2,s0.CURRENT_VERSION??2),prompts:C5()}}async function i0(Z){let Q=JSON.stringify(Z,null,2),G=btoa(unescape(encodeURIComponent(Q))),J=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:R5(),body:JSON.stringify({name:_5,data:G})});if(!J.ok)throw Error(B6`Failed to save side prompts: ${J.status} ${J.statusText}`);S1=Z,console.log(`${A8}: ${a("Side prompts saved successfully","STMemoryBooks_SidePromptsSaved")}`)}async function g0(){if(S1)return S1;let Z=null;try{let Q=await fetch(`/user/files/${_5}`,{method:"GET",credentials:"include",headers:R5()});if(!Q.ok)Z=NZ(),await i0(Z);else{let G=await Q.text(),J=JSON.parse(G);if(L5(J))console.log(`${A8}: ${a("Migrating side prompts file from V1(type) to V2(triggers)","STMemoryBooks_MigratingSidePrompts")}`),Z=w5(J),await i0(Z);else if(!I5(J))console.warn(`${A8}: ${a("Invalid side prompts file structure; recreating with built-ins","STMemoryBooks_InvalidSidePromptsFile")}`),Z=NZ(),await i0(Z);else if(Z=J,Number(Z.version||1)<2)Z.version=2,await i0(Z)}}catch(Q){console.warn(`${A8}: ${a("Error loading side prompts; creating base doc","STMemoryBooks_ErrorLoadingSidePrompts")}`,Q),Z=NZ(),await i0(Z)}return S1=Z,S1}async function wG(){return await g0(),!0}async function X1(){let Z=await g0(),Q=Object.values(Z.prompts);return Q.sort((G,J)=>{let W=G.updatedAt||G.createdAt||"";return(J.updatedAt||J.createdAt||"").localeCompare(W)}),Q}async function DZ(Z){return(await g0()).prompts[Z]||null}async function TZ(Z){let Q=await g0(),G=String(Z||"").trim();if(!G)return null;let J=G.toLowerCase(),W=O0(G),q=J.replace(/[^a-z0-9]+/g," ").trim(),z=Object.values(Q.prompts);for(let Y of z){let K=String(Y.name||"").toLowerCase(),X=String(Y.key||"").toLowerCase(),V=O0(Y.name||"");if(K===J||X===J||V===W)return Y}for(let Y of z){let K=String(Y.name||"").toLowerCase(),X=String(Y.key||"").toLowerCase(),V=O0(Y.name||"");if(K.startsWith(J)||V.startsWith(W)||X.startsWith(J))return Y}for(let Y of z){let K=String(Y.name||"").toLowerCase(),X=O0(Y.name||""),V=K.replace(/[^a-z0-9]+/g," ").trim();if(K.includes(J)||X.includes(W)||q&&V.includes(q))return Y}return null}async function O6(Z){let Q=await g0(),G=!Z.key,J=x8(),W=String(Z.name??"").trim(),q=G?null:Q.prompts[Z.key],z=W||(G?a("Untitled Side Prompt","STMemoryBooks_UntitledSidePrompt"):q?.name||a("Untitled Side Prompt","STMemoryBooks_UntitledSidePrompt")),Y;if(Z.key)Y=Z.key;else{let F=O0(z||a("Untitled Side Prompt","STMemoryBooks_UntitledSidePrompt")),j=2;while(Q.prompts[F])F=O0(`${z} ${j}`),j++;Y=F}let K=Q.prompts[Y],X={key:Y,name:z,enabled:typeof Z.enabled==="boolean"?Z.enabled:K?.enabled??!1,prompt:String(Z.prompt!=null?Z.prompt:K?.prompt||"this is a placeholder prompt"),responseFormat:String(Z.responseFormat!=null?Z.responseFormat:K?.responseFormat||""),settings:{...K?.settings||{},...Z.settings||{}},triggers:Z.triggers?Z.triggers:K?.triggers||{commands:["sideprompt"]},createdAt:K?.createdAt||J,updatedAt:J};if(X.triggers.onInterval){let V=Math.max(1,Number(X.triggers.onInterval.visibleMessages??50));X.triggers.onInterval={visibleMessages:V}}if(X.triggers.onAfterMemory)X.triggers.onAfterMemory={enabled:!!X.triggers.onAfterMemory.enabled};if("commands"in X.triggers)if(Array.isArray(X.triggers.commands))X.triggers.commands=X.triggers.commands.filter((V)=>typeof V==="string"&&V.trim());else X.triggers.commands=[];else X.triggers.commands=["sideprompt"];return Q.prompts[Y]=X,await i0(Q),Y}async function RZ(Z){let Q=await g0(),G=Q.prompts[Z];if(!G)throw Error(B6`Template "${Z}" not found`);let J=B6`${G.name} (Copy)`,W=O0(J),q=2;while(Q.prompts[W])W=O0(`${J} ${q}`),q++;let z=x8();return Q.prompts[W]={...G,key:W,name:J,createdAt:z,updatedAt:z},await i0(Q),W}async function _Z(Z){let Q=await g0();if(!Q.prompts[Z])throw Error(B6`Template "${Z}" not found`);delete Q.prompts[Z],await i0(Q)}async function IZ(){let Z=await g0();return JSON.stringify(Z,null,2)}async function LZ(Z){let Q=JSON.parse(Z),G=null;if(I5(Q))G=Q;else if(L5(Q))G=w5(Q);else throw Error(a("Invalid side prompts file structure","STMemoryBooks_InvalidSidePromptsJSON"));let J=await g0(),W={version:Math.max(2,Number(J.version??2),Number(G.version??2)),prompts:{...J.prompts}},q=(K,X)=>{let V=String(X||"").trim()||K||"sideprompt",F=O0(V),j=K&&!W.prompts[K]?K:F;if(!j)j="sideprompt";let O=2;while(W.prompts[j])j=O0(`${V} ${O}`),O++;return j},z=0,Y=0;for(let[K,X]of Object.entries(G.prompts||{})){let V=W.prompts[K]?q(null,X?.name||K):K;if(V!==K)Y++;let F=x8(),j={key:V,name:String(X.name||"Side Prompt"),enabled:!!X.enabled,prompt:String(X.prompt!=null?X.prompt:"this is a placeholder prompt"),responseFormat:String(X.responseFormat||""),settings:{...X.settings||{}},triggers:X.triggers?{...X.triggers}:{commands:["sideprompt"]},createdAt:X.createdAt||F,updatedAt:F};if(j.triggers.onInterval){let O=Math.max(1,Number(j.triggers.onInterval.visibleMessages??50));j.triggers.onInterval={visibleMessages:O}}if(j.triggers.onAfterMemory)j.triggers.onAfterMemory={enabled:!!j.triggers.onAfterMemory.enabled};if("commands"in j.triggers)if(Array.isArray(j.triggers.commands))j.triggers.commands=j.triggers.commands.filter((O)=>typeof O==="string"&&O.trim());else j.triggers.commands=[];else j.triggers.commands=["sideprompt"];W.prompts[V]=j,z++}return await i0(W),{added:z,renamed:Y}}async function wZ(Z="overwrite"){if(Z!=="overwrite")console.warn(`${A8}: Unsupported mode for recreateBuiltInSidePrompts: ${Z}; defaulting to 'overwrite'`);let Q=await g0(),G=C5(),J=Object.keys(G||{}),W=0;if(!Q||!Q.prompts||typeof Q.prompts!=="object")throw Error(a("Invalid side prompts document","STMemoryBooks_InvalidSidePromptsJSON"));for(let q of J)Q.prompts[q]=G[q],W++;return await i0(Q),S1=Q,console.log(`${A8}: Recreated built-in side prompts (overwrote ${W} entries)`),{replaced:W}}async function CG(Z){let Q=String(Z||"").toLowerCase(),G=await X1();if(Q==="tracker")return G.filter((J)=>J.enabled&&J.triggers?.onInterval&&Number(J.triggers.onInterval.visibleMessages)>=1);if(Q==="plotpoints")return G.filter((J)=>J.enabled&&J.triggers?.onAfterMemory?.enabled);if(Q==="scoreboard")return G.filter((J)=>J.enabled&&(Array.isArray(J.triggers?.commands)||J.triggers?.onAfterMemory?.enabled));return[]}async function A6(Z){let Q=await X1();if(Z==="onInterval")return Q.filter((G)=>G.enabled&&G.triggers?.onInterval&&Number(G.triggers.onInterval.visibleMessages)>=1);if(Z==="onAfterMemory")return Q.filter((G)=>G.enabled&&G.triggers?.onAfterMemory?.enabled);if(Z&&Z.startsWith("command:")){let G=Z.slice(8).trim();return Q.filter((J)=>Array.isArray(J.triggers?.commands)&&J.triggers.commands.some((W)=>W.toLowerCase()===G.toLowerCase()))}return[]}function hG(){S1=null}var A8="STMemoryBooks-SidePromptsManager",_5,S1=null;var S8=N1(()=>{D1();_5=s1.SIDE_PROMPTS_FILE});a8();import{eventSource as Z1,event_types as H1,chat as B7,chat_metadata as c1,saveSettingsDebounced as s,characters as iZ,this_chid as rG,settings as K3}from"../../../../script.js";import{Popup as $0,POPUP_TYPE as r,POPUP_RESULT as i}from"../../../popup.js";import{extension_settings as p}from"../../../extensions.js";import{SlashCommandParser as k1}from"../../../slash-commands/SlashCommandParser.js";import{SlashCommand as g1}from"../../../slash-commands/SlashCommand.js";import{SlashCommandEnumValue as rZ}from"../../../slash-commands/SlashCommandEnumValue.js";import{ARGUMENT_TYPE as L6,SlashCommandArgument as w6}from"../../../slash-commands/SlashCommandArgument.js";import{executeSlashCommands as aG}from"../../../slash-commands.js";import{METADATA_KEY as p8,world_names as h6,loadWorldInfo as tG,saveWorldInfo as eG,reloadEditor as Z$}from"../../../world-info.js";import{lodash as Q$,Handlebars as G$,DOMPurify as i1}from"../../../../lib.js";import{escapeHtml as b}from"../../../utils.js";b0();var i4=E6(d4(),1);import{characters as GZ,this_chid as c4,substituteParams as TQ,getRequestHeaders as RQ}from"../../../../script.js";import{oai_settings as z6}from"../../../openai.js";import{runRegexScript as _Q,getRegexScripts as IQ}from"../../../extensions/regex/engine.js";import{groups as p4}from"../../../group-chats.js";import{extension_settings as C8}from"../../../extensions.js";var hJ=window.jQuery;function LQ(Z){try{let Q={...Z};return Q.disabled=!1,Q}catch{return Z}}function l4(Z,Q){if(typeof Z!=="string")return"";if(!Array.isArray(Q)||Q.length===0)return Z;try{let G=IQ({allowedOnly:!1})||[],J=Q.map((q)=>Number(String(q).replace(/^idx:/,""))).filter((q)=>Number.isInteger(q)&&q>=0&&q<G.length),W=Z;for(let q of J){let z=LQ(G[q]);try{W=_Q(z,W)}catch(Y){console.warn("applySelectedRegex: script failed",q,Y)}}return W}catch(G){return console.warn("applySelectedRegex failed",G),Z}}class $Z extends Error{constructor(Z,Q){super(Z);this.name="TokenWarningError",this.tokenCount=Q}}class F8 extends Error{constructor(Z){super(Z);this.name="AIResponseError"}}class X6 extends Error{constructor(Z){super(Z);this.name="InvalidProfileError"}}function wQ(){return"/api/backends/chat-completions/generate"}async function h1({model:Z,prompt:Q,temperature:G=0.7,api:J="openai",endpoint:W=null,apiKey:q=null,extra:z={}}){let Y=wQ(),K=RQ(),X=Math.max(Number(z.max_tokens)||0,Number(z6.max_response)||0),V=Math.floor(X)||0;if(Number.isFinite(V)&&V>0)if((typeof Z==="string"?Z.toLowerCase():"").includes("gpt-5"))z.max_completion_tokens=V,delete z.max_tokens;else z.max_tokens=V;if(z.max_output_tokens!=null){let A=Number.parseFloat(z.max_output_tokens),B=Number.isFinite(A)?Math.floor(A):0;if(Number.isFinite(z.max_tokens)&&z.max_tokens>0)z.max_output_tokens=Math.min(B,z.max_tokens);else z.max_output_tokens=B}let F={messages:[{role:"user",content:Q}],model:Z,temperature:G,chat_completion_source:J,...z};if(J==="full-manual"){let A=String(W||"").trim();if(!A)throw new X6("Full Manual Configuration requires an API Endpoint URL.");Y=A,K={"Content-Type":"application/json"};let B=q!=null?String(q).trim():"";if(B)K.Authorization=`Bearer ${B}`;F={model:Z,messages:[{role:"user",content:Q}],temperature:G,...z}}else if(J==="custom"&&Z)F.custom_model_id=Z,F.custom_url=z6.custom_url||"";else if(J==="deepseek")F.custom_url="https://api.deepseek.com/chat/completions";let j=await fetch(Y,{method:"POST",headers:K,body:JSON.stringify(F)});if(!j.ok){let A="";try{A=await j.text()}catch(D){A=""}let B=Error(`LLM request failed: ${j.status} ${j.statusText}`);if(A)B.providerBody=A;throw B}let O=await j.json(),H="";if(O.choices?.[0]?.message?.content)H=O.choices[0].message.content;else if(O.completion)H=O.completion;else if(O.choices?.[0]?.text)H=O.choices[0].text;else if(O.content&&Array.isArray(O.content))H=O.content.find((B)=>B&&typeof B==="object"&&B.type==="text"&&B.text)?.text||"";else if(typeof O.content==="string")H=O.content;return{text:H,full:O}}async function o4({api:Z,model:Q,prompt:G,temperature:J=0.7,endpoint:W=null,apiKey:q=null,extra:z={}}){return await h1({model:Q,prompt:G,temperature:J,api:Z,endpoint:W,apiKey:q,extra:z})}async function CQ(Z={},Q=null){let G;if(typeof Z==="number")G={maxWaitMs:Z,initialIntervalMs:Q||250,maxIntervalMs:1000,backoffMultiplier:1.2,useExponentialBackoff:!1};else G={maxWaitMs:5000,initialIntervalMs:100,maxIntervalMs:1000,backoffMultiplier:1.5,useExponentialBackoff:!0,...Z};let{maxWaitMs:J,initialIntervalMs:W,maxIntervalMs:q,backoffMultiplier:z,useExponentialBackoff:Y,signal:K}=G,X=Date.now(),V=W,F=0,{getCurrentMemoryBooksContext:j}=await Promise.resolve().then(() => (b0(),I4)),O=j();while(Date.now()-X<J){if(K?.aborted)return!1;let H=W;if(O.isGroupChat){if(p4&&O.groupId){if(p4.find((B)=>B.id===O.groupId))return!0}}else if(GZ&&GZ.length>c4&&GZ[c4])return!0;if(await new Promise((A,B)=>{let D=setTimeout(A,H);if(K){let T=()=>{clearTimeout(D),B(Error("Cancelled"))};K.addEventListener("abort",T,{once:!0})}}).catch(()=>{return!1}),Y&&H<q)H=Math.min(H*z,q)}return!1}function hQ(Z){try{if(typeof Z==="object"&&Z!==null&&Array.isArray(Z.content)){let Q=Z.content.find((G)=>G&&typeof G==="object"&&G.type==="text"&&G.text);if(Q&&typeof Q.text==="string")return Q.text}return null}catch(Q){return null}}function MQ(Z){try{let Q=0,G=0,J=!1,W=!1;for(let q=0;q<Z.length;q++){let z=Z[q];if(J){if(W)W=!1;else if(z==="\\")W=!0;else if(z==='"')J=!1}else if(z==='"')J=!0;else if(z==="{")Q++;else if(z==="}")Q--;else if(z==="[")G++;else if(z==="]")G--;if(Q<0||G<0)return!0}return J||Q!==0||G!==0}catch{return!1}}function vQ(Z){let Q=(Z||"").trim();if(!Q)return!0;if(/[.!?]["'’\)\]]?$/.test(Q))return!0;if(Q.length>=80&&!/[.!?]$/.test(Q))return!1;return!0}function PQ(Z){return String(Z).replace(/\r\n/g,`
`).replace(/^\uFEFF/,"").replace(/[\u0000-\u001F\u200B-\u200D\u2060]/g,"")}function xQ(Z){let Q=/```([\w-]*)\s*([\s\S]*?)```/g,G=[],J;while((J=Q.exec(Z))!==null)G.push((J[2]||"").trim());return G}function SQ(Z){let Q=Z.search(/[\{\[]/);if(Q===-1)return null;let G=Z[Q],J=G==="{"?"}":"]",W=0,q=!1,z=!1;for(let Y=Q;Y<Z.length;Y++){let K=Z[Y];if(q){if(z)z=!1;else if(K==="\\")z=!0;else if(K==='"')q=!1;continue}if(K==='"'){q=!0;continue}if(K===G)W++;else if(K===J){if(W--,W===0)return Z.slice(Q,Y+1).trim()}}return null}function EQ(Z){return/[\{\[]/.test(Z)}function bQ(Z){let Q=new Set,G=[];for(let J of Z)if(!Q.has(J))Q.add(J),G.push(J);return G}function P0(Z,Q,G=!0){let J=new F8(Q);J.code=Z,J.recoverable=G;try{console.debug(`STMemoryBooks: AIResponseError code=${Z} recoverable=${G}: ${Q}`)}catch{}return J}function JZ(Z){let Q=Z;try{let V=!!C8?.STMemoryBooks?.moduleSettings?.useRegex,F=C8?.STMemoryBooks?.moduleSettings?.selectedRegexIncoming;if(V&&typeof Q==="string"&&Array.isArray(F)&&F.length>0)Q=l4(Q,F)}catch(V){console.warn("STMemoryBooks: incoming regex application failed",V)}if(typeof Q==="object"&&Q!==null&&Array.isArray(Q.content)){let V=hQ(Q);if(V)Q=V;else{let F=P0("EMPTY_OR_INVALID","AI response is empty or invalid",!1);try{F.rawResponse=JSON.stringify(Q)}catch{}throw F}}else if(typeof Q==="object"&&Q!==null&&Q.content)Q=Q.content;if(typeof Q==="object"&&Q!==null)try{let F=Q?.candidates?.[0]?.content?.parts;if(Array.isArray(F)&&F.length>0){let j=F.map((O)=>O&&typeof O.text==="string"?O.text:"").join("");if(j&&j.trim())Q=j}}catch(V){}if(!Q||typeof Q!=="string"){let V=P0("EMPTY_OR_INVALID","AI response is empty or invalid",!1);try{V.rawResponse=typeof Q==="string"?Q:JSON.stringify(Q)}catch{}throw V}Q=Q.trim(),Q=Q.replace(/<think>[\s\S]*?<\/think>/gi,"");let G=PQ(Q),J=[],W=xQ(G);if(W.length)J.push(...W);J.push(G);let q=SQ(G);if(q)J.push(q);let z=bQ(J),Y=(V)=>{if(!V||typeof V!=="object")return P0("EMPTY_OR_INVALID","AI response is empty or invalid",!1);if(!V.content&&!V.summary&&!V.memory_content)return P0("MISSING_FIELDS_CONTENT","AI response missing content field",!1);if(!V.title)return P0("MISSING_FIELDS_TITLE","AI response missing title field",!1);if(!Array.isArray(V.keywords))return P0("INVALID_KEYWORDS","AI response missing or invalid keywords array.",!1);return null},K=null;for(let V of z){try{let F=JSON.parse(V),j=Y(F);if(j)K=j;else return F}catch{}try{let F=i4.default.parse(V),j=Y(F);if(j)K=j;else return F}catch{}}if(!EQ(G)){let V=P0("NO_JSON_BLOCK","AI response did not contain a JSON block. The model may have returned prose or declined the request.",!0);throw V.rawResponse=G,V}if(MQ(G)){let V=P0("UNBALANCED","AI response appears truncated or invalid JSON (unbalanced structures). Try increasing Max Response Length.",!1);throw V.rawResponse=G,V}let X=G.trim();if(X&&X.length>=80&&!vQ(X)){let V=P0("INCOMPLETE_SENTENCE","AI response JSON appears incomplete (text ends mid-sentence). Try increasing Max Response Length.",!1);throw V.rawResponse=G,V}if(K)throw K.rawResponse=G,K;{let V=P0("MALFORMED","AI did not return valid JSON. This may indicate the model does not support structured output well or the response contained unsupported formatting.",!1);throw V.rawResponse=G,V}}async function yQ(Z,Q){if(!await CQ())throw new F8("Character data is not available. This may indicate that SillyTavern is still loading. Please wait a moment and try again.");let J=Q?.effectiveConnection||Q?.connection||{};try{let W=q0(J.api||o().api),q={};if(z6.openai_max_tokens)q.max_tokens=z6.openai_max_tokens;let{text:z,full:Y}=await h1({model:J.model,prompt:Z,temperature:J.temperature,api:W,endpoint:J.endpoint,apiKey:J.apiKey,extra:q}),K=Y?.choices?.[0]?.finish_reason||Y?.finish_reason||Y?.stop_reason,X=typeof K==="string"?K.toLowerCase():"";if(X.includes("length")||X.includes("max")){let F=P0("PROVIDER_TRUNCATION","Model response appears truncated (provider finish_reason). Please increase Max Response Length.",!1);try{F.rawResponse=z||""}catch{}try{F.providerResponse=Y||null}catch{}throw F}if(Y?.truncated===!0){let F=P0("PROVIDER_TRUNCATION_FLAG","Model response appears truncated (provider flag). Please increase Max Response Length.",!1);try{F.rawResponse=z||""}catch{}try{F.providerResponse=Y||null}catch{}throw F}let V=JZ(z);return{content:V.content||V.summary||V.memory_content||"",title:V.title||"Memory",keywords:V.keywords||[],profile:Q}}catch(W){if(W instanceof F8)throw W;let q=new F8(`Memory generation failed: ${W.message||W}`);try{if(typeof W?.providerBody==="string")q.providerBody=W.providerBody;if(typeof W?.rawResponse==="string")q.rawResponse=W.rawResponse}catch{}throw q}}async function n4(Z,Q,G={}){try{fQ(Z,Q);let J=await uQ(Z,Q),W=await gQ(J),q=G.tokenWarningThreshold??30000;if(W.total>q)throw new $Z("Token warning threshold exceeded.",W.total);let z=await yQ(J,Q),Y=mQ(z,Z);return{content:Y.content,extractedTitle:Y.extractedTitle,metadata:{sceneRange:`${Z.metadata.sceneStart}-${Z.metadata.sceneEnd}`,messageCount:Z.metadata.messageCount,characterName:Z.metadata.characterName,userName:Z.metadata.userName,chatId:Z.metadata.chatId,createdAt:new Date().toISOString(),profileUsed:Q.name,presetUsed:Q.preset||"custom",tokenUsage:W,generationMethod:"json-structured-output",version:"2.0"},suggestedKeys:Y.suggestedKeys,titleFormat:Q.useDynamicSTSettings||Q?.connection?.api==="current_st"?C8.STMemoryBooks?.titleFormat||"[000] - {{title}}":Q.titleFormat||"[000] - {{title}}",lorebookSettings:{constVectMode:Q.constVectMode,position:Q.position,orderMode:Q.orderMode,orderValue:Q.orderValue,preventRecursion:Q.preventRecursion,delayUntilRecursion:Q.delayUntilRecursion,outletName:Number(Q.position)===7?Q.outletName||"":void 0},lorebook:{content:Y.content,comment:`Auto-generated memory from messages ${Z.metadata.sceneStart}-${Z.metadata.sceneEnd}. Profile: ${Q.name}.`,key:Y.suggestedKeys||[],keysecondary:[],selective:!0,constant:!1,order:100,position:"before_char",disable:!1,addMemo:!0,excludeRecursion:!1,delayUntilRecursion:!0,probability:100,useProbability:!1}}}catch(J){if(J instanceof $Z||J instanceof F8||J instanceof X6)throw J;throw Error(`Memory creation failed: ${J.message}`)}}function fQ(Z,Q){if(!Z||!Array.isArray(Z.messages)||Z.messages.length===0)throw Error("Invalid or empty compiled scene data provided.");let G=typeof Q?.prompt==="string"&&Q.prompt.trim().length>0,J=typeof Q?.preset==="string"&&Q.preset.trim().length>0;if(!G&&!J)throw new X6("Invalid profile configuration. You must set either a custom prompt or a valid preset.")}function kQ(Z,Q,G=[]){let J=Z.map((q)=>{let z=q.name||"Unknown",Y=(q.mes||"").trim();return Y?`${z}: ${Y}`:null}).filter(Boolean),W=[""];if(G&&G.length>0)W.push("=== PREVIOUS SCENE CONTEXT (DO NOT SUMMARIZE) ==="),W.push("These are previous memories for context only. Do NOT include them in your new memory:"),W.push(""),G.forEach((q,z)=>{if(W.push(`Context ${z+1} - ${q.title}:`),W.push(q.content),q.keywords&&q.keywords.length>0)W.push(`Keywords: ${q.keywords.join(", ")}`);W.push("")}),W.push("=== END PREVIOUS SCENE CONTEXT - SUMMARIZE ONLY THE SCENE BELOW ==="),W.push("");return W.push("=== SCENE TRANSCRIPT ==="),W.push(...J),W.push(""),W.push("=== END SCENE ==="),W.join(`
`)}async function gQ(Z){return await $1(Z,{estimatedOutput:300})}async function uQ(Z,Q){let{metadata:G,messages:J,previousSummariesContext:W}=Z,q=await I1(Q),z=TQ(q,G.userName,G.characterName),Y=kQ(J,G,W),K=`${z}

${Y}`;try{let X=!!C8?.STMemoryBooks?.moduleSettings?.useRegex,V=C8?.STMemoryBooks?.moduleSettings?.selectedRegexOutgoing;if(X&&Array.isArray(V)&&V.length>0)return l4(K,V)}catch(X){console.warn("STMemoryBooks: outgoing regex application failed",X)}return K}function mQ(Z,Q){let{content:G,title:J,keywords:W}=Z,q=(G||Z.summary||Z.memory_content||"").trim(),z=(J||"Memory").trim(),Y=Array.isArray(W)?W.filter((K)=>K&&typeof K==="string"&&K.trim()!=="").map((K)=>K.trim()):[];return{content:q,extractedTitle:z,suggestedKeys:Y}}e1();import{getContext as PJ}from"../../../extensions.js";import{METADATA_KEY as SJ,loadWorldInfo as EJ,createWorldInfoEntry as WZ,saveWorldInfo as qZ,reloadEditor as YZ}from"../../../world-info.js";import{extension_settings as s4}from"../../../extensions.js";import{moment as r4}from"../../../../lib.js";import{executeSlashCommands as dQ}from"../../../slash-commands.js";import{translate as cQ}from"../../../i18n.js";var H0="STMemoryBooks-AddLore";function E(Z,Q,G){let J=cQ(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function a4(Z){if(!Z)return null;let Q=Z.split("-");if(Q.length!==2)return null;let G=parseInt(Q[0],10),J=parseInt(Q[1],10);if(isNaN(G)||isNaN(J)||G<0||J<0)return null;return{start:G,end:J}}async function pQ(Z,Q=""){let G=Q?` (${Q})`:"";console.log(E("addlore.log.executingHideCommand",`${H0}: Executing hide command${G}: {{hideCommand}}`,{hideCommand:Z})),await dQ(Z)}async function V6(Z,Q=""){try{await pQ(Z,Q)}catch(G){console.warn(E("addlore.warn.autohideFailed",`${H0}: Auto-hide failed:`),G)}}function iQ(Z={}){if(Z.autoHideMode)return Z.autoHideMode;if(Z.autoHideAllMessages)return"all";else if(Z.autoHideLastMemory)return"last";else return"none"}var lQ=["[000] - {{title}} ({{profile}})","{{date}} [000] \uD83C\uDFAC{{title}}, {{messages}} msgs","[000] {{date}} - {{char}} Memory","[00] - {{user}} & {{char}} {{scene}}","\uD83E\uDDE0 [000] ({{messages}} msgs)","\uD83D\uDCDA Memory #[000] - {{profile}} {{date}} {{time}}","[000] - {{scene}}: {{title}}","[000] - {{title}} ({{scene}})","[000] - {{title}}"];async function zZ(Z,Q){try{if(!Z?.content)throw Error(E("addlore.errors.invalidContent","Invalid memory result: missing content"));if(!Q?.valid||!Q.data)throw Error(E("addlore.errors.invalidLorebookValidation","Invalid lorebook validation data"));let G=s4.STMemoryBooks||{},J=Z.titleFormat;if(!J)J=G.titleFormat||E("addlore.titleFormats.8","[000] - {{title}}");let W=G.moduleSettings?.refreshEditor!==!1,q=Z.lorebookSettings||{constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0},z=WZ(Q.name,Q.data);if(!z)throw Error(E("addlore.errors.createEntryFailed","Failed to create new lorebook entry"));let Y=nQ(J,Z,Q.data);if(oQ(z,Z,Y,q),await qZ(Q.name,Q.data,!0),G.moduleSettings?.showNotifications!==!1)toastr.success(E("addlore.toast.added",'Memory "{{entryTitle}}" added to "{{lorebookName}}"',{entryTitle:Y,lorebookName:Q.name}),E("addlore.toast.title","STMemoryBooks"));if(W)try{await Promise.resolve(YZ(Q.name))}catch(X){console.warn(E("addlore.warn.refreshEditorFailed",`${H0}: reloadEditor failed:`),X)}let K=iQ(G.moduleSettings);if(K!=="none"){let X=G.moduleSettings.unhiddenEntriesCount??2;if(K==="all"){let V=a4(Z.metadata?.sceneRange);if(!V)console.warn(E("addlore.warn.autohideSkippedInvalidRange",`${H0}: Auto-hide skipped - invalid scene range: "{{range}}"`,{range:Z.metadata?.sceneRange})),toastr.warning(E("addlore.toast.autohideInvalidRange","Auto-hide skipped: invalid scene range metadata"),E("addlore.toast.title","STMemoryBooks"));else{let{start:F,end:j}=V;if(X===0)await V6(`/hide 0-${j}`,E("addlore.hideCommand.allComplete","all mode - complete"));else{let O=j-X;if(O>=0)await V6(`/hide 0-${O}`,E("addlore.hideCommand.allPartial","all mode - partial"))}}}else if(K==="last"){let V=a4(Z.metadata?.sceneRange);if(!V)console.warn(E("addlore.warn.autohideSkippedInvalidRange",`${H0}: Auto-hide skipped - invalid scene range: "{{range}}"`,{range:Z.metadata?.sceneRange})),toastr.warning(E("addlore.toast.autohideInvalidRange","Auto-hide skipped: invalid scene range metadata"),E("addlore.toast.title","STMemoryBooks"));else{let{start:F,end:j}=V,O=j-F+1;if(X>=O);else if(X===0)await V6(`/hide ${F}-${j}`,E("addlore.hideCommand.lastHideAll","last mode - hide all"));else{let H=j-X;if(H>=F)await V6(`/hide ${F}-${H}`,E("addlore.hideCommand.lastPartial","last mode - partial"))}}}}return eQ(Z),{success:!0,entryId:z.uid,entryTitle:Y,lorebookName:Q.name,keywordCount:Z.suggestedKeys?.length||0,message:E("addlore.result.added",'Memory successfully added to "{{lorebookName}}"',{lorebookName:Q.name})}}catch(G){if(console.error(E("addlore.log.addFailed",`${H0}: Failed to add memory to lorebook:`),G),s4.STMemoryBooks?.moduleSettings?.showNotifications!==!1)toastr.error(E("addlore.toast.addFailed","Failed to add memory: {{message}}",{message:G.message}),E("addlore.toast.title","STMemoryBooks"));return{success:!1,error:G.message,message:E("addlore.result.addFailed","Failed to add memory to lorebook: {{message}}",{message:G.message})}}}function oQ(Z,Q,G,J){Z.content=Q.content,Z.key=Q.suggestedKeys||[],Z.comment=G;let W=h8(G)||1;switch(J.constVectMode){case"blue":Z.constant=!0,Z.vectorized=!1;break;case"green":Z.constant=!1,Z.vectorized=!1;break;case"link":default:Z.constant=!1,Z.vectorized=!0;break}if(Z.position=J.position,Number(J.position)===7){let q=String(J.outletName||"").trim();if(q)Z.outletName=q}if(J.orderMode==="manual")Z.order=J.orderValue;else Z.order=W;if(Z.preventRecursion=J.preventRecursion,Z.delayUntilRecursion=J.delayUntilRecursion,Z.keysecondary=[],Z.selective=!0,Z.selectiveLogic=0,Z.addMemo=!0,Z.disable=!1,Z.excludeRecursion=!1,Z.probability=100,Z.useProbability=!0,Z.depth=4,Z.group="",Z.groupOverride=!1,Z.groupWeight=100,Z.scanDepth=null,Z.caseSensitive=null,Z.matchWholeWords=null,Z.useGroupScoring=null,Z.automationId="",Z.role=null,Z.sticky=0,Z.cooldown=0,Z.delay=0,Z.displayIndex=W,Z.stmemorybooks=!0,Q.metadata?.sceneRange){let q=Q.metadata.sceneRange.split("-");if(q.length===2)Z.STMB_start=parseInt(q[0],10),Z.STMB_end=parseInt(q[1],10)}}function t4(Z){return Z.stmemorybooks===!0}function nQ(Z,Q,G){let J=Z,W=[{pattern:/\[\[0+\]\]/g,prefix:"[",suffix:"]"},{pattern:/\[0+\]/g,prefix:"",suffix:""},{pattern:/\(\[0+\]\)/g,prefix:"(",suffix:")"},{pattern:/\{\[0+\]\}/g,prefix:"{",suffix:"}"},{pattern:/#\[0+\]/g,prefix:"#",suffix:""}];for(let{pattern:Y,prefix:K,suffix:X}of W){let V=J.match(Y);if(V){let F=sQ(G,Z);V.forEach((j)=>{let O;if(Y.source.includes("\\[\\["))O=j.length-4;else if(Y.source.includes("\\(\\[")||Y.source.includes("\\{\\["))O=j.length-4;else if(Y.source.includes("#\\["))O=j.length-3;else if(Y.source.includes("\\["))O=j.length-2;else O=j.length-2;let H=F.toString().padStart(O,"0"),A=K+H+X;J=J.replace(j,A)});break}}let q=Q.metadata||{},z={"{{title}}":Q.extractedTitle||E("addlore.defaults.title","Memory"),"{{scene}}":E("addlore.defaults.scene","Scene {{range}}",{range:q.sceneRange||E("common.unknown","Unknown")}),"{{char}}":q.characterName||E("common.unknown","Unknown"),"{{user}}":q.userName||E("addlore.defaults.user","User"),"{{messages}}":q.messageCount||0,"{{profile}}":q.profileUsed||E("common.unknown","Unknown"),"{{date}}":r4().format("YYYY-MM-DD"),"{{time}}":r4().format("HH:mm:ss")};return Object.entries(z).forEach(([Y,K])=>{J=J.replace(new RegExp(Y.replace(/[{}]/g,"\\$&"),"g"),K)}),J=tQ(J),J}function sQ(Z,Q=null){if(!Z.entries)return 1;let G=Object.values(Z.entries),J=[];if(G.forEach((q)=>{if(t4(q)&&q.comment){let z=Q?rQ(q.comment,Q):h8(q.comment);if(z!==null)J.push(z)}}),J.length===0)return 1;return Math.max(...J)+1}function rQ(Z,Q){if(!Z||typeof Z!=="string"||!Q||typeof Q!=="string")return null;let G=[/\[0+\]/g,/\(0+\)/g,/\{0+\}/g,/#0+/g],J=[],W=null;for(let z of G){let Y=[...Q.matchAll(z)];if(Y.length>0){J=Y,W=z;break}}if(J.length===0)return h8(Z);let q=aQ(Q);if(q=q.replace(/\\\{\\\{[^}]+\\\}\\\}/g,".*?"),W.source.includes("\\["))q=q.replace(/\\\[0+\\\]/g,"(\\d+)");else if(W.source.includes("\\("))q=q.replace(/\\\(0+\\\)/g,"(\\d+)");else if(W.source.includes("\\{"))q=q.replace(/\\\{0+\\\}/g,"(\\d+)");else if(W.source.includes("#"))q=q.replace(/#0+/g,"(\\d+)");try{let z=Z.match(new RegExp(q));if(z&&z[1]){let Y=parseInt(z[1],10);return isNaN(Y)?null:Y}}catch(z){}return h8(Z)}function aQ(Z){return Z.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function h8(Z){if(!Z||typeof Z!=="string")return null;let Q=Z.match(/\[(\d+)\]/);if(Q){let Y=parseInt(Q[1],10);return isNaN(Y)?null:Y}let G=Z.match(/\((\d+)\)/);if(G){let Y=parseInt(G[1],10);return isNaN(Y)?null:Y}let J=Z.match(/\{(\d+)\}/);if(J){let Y=parseInt(J[1],10);return isNaN(Y)?null:Y}let W=Z.match(/#(\d+)(?:-(\d+))?/);if(W){let Y=parseInt(W[1],10),K=W[2]?parseInt(W[2],10):null,X=K!==null?K:Y;return isNaN(X)?null:X}let q=Z.match(/^(\d+)(?:\s*[-\s])/);if(q){let Y=parseInt(q[1],10);return isNaN(Y)?null:Y}let z=[...Z.matchAll(/(\d+)/g)];for(let Y of z){let K=parseInt(Y[1],10);if(isNaN(K))continue;let X=Y[0],V=Y.index,F=Z.substring(Math.max(0,V-10),V),j=Z.substring(V+X.length,V+X.length+10);if(!(/\d{4}-\d{2}-\d{2}/.test(F+X+j)||/\d{4}-\d{1,2}/.test(F+X)||/-\d{1,2}-\d{1,2}/.test(X+j)))return K}return null}function U8(Z){if(!Z.entries)return[];let Q=Object.values(Z.entries),G=[];return Q.forEach((J)=>{if(t4(J)){let W=h8(J.comment)||0;G.push({number:W,title:J.comment,content:J.content,keywords:J.key||[],entry:J})}}),G.sort((J,W)=>J.number-W.number),G}function tQ(Z){return String(Z??"").replace(/[\u0000-\u001F\u007F-\u009F]/g,"").trim()||E("addlore.sanitize.fallback","Auto Memory")}function Y1(){return lQ.map((Z,Q)=>E(`addlore.titleFormats.${Q}`,Z))}function e4(Z){if(typeof Z.STMB_start==="number"&&typeof Z.STMB_end==="number")return{start:Z.STMB_start,end:Z.STMB_end};return null}function eQ(Z){try{console.log(E("addlore.log.updateHighestCalled",`${H0}: updateHighestMemoryProcessed called with:`),Z);let Q=Z.metadata?.sceneRange;if(console.log(E("addlore.log.sceneRangeExtracted",`${H0}: sceneRange extracted:`),Q),!Q){console.warn(E("addlore.warn.noSceneRange",`${H0}: No scene range found in memory result, cannot update highest processed`));return}let G=Q.split("-");if(G.length!==2){console.warn(E("addlore.warn.invalidSceneRangeFormat",`${H0}: Invalid scene range format: {{range}}`,{range:Q}));return}let J=parseInt(G[1],10);if(isNaN(J)){console.warn(E("addlore.warn.invalidEndMessage",`${H0}: Invalid end message number: {{end}}`,{end:G[1]}));return}let W=f();if(!W){console.warn(E("addlore.warn.noSceneMarkers",`${H0}: Could not get scene markers to update highest processed`));return}W.highestMemoryProcessed=J,Z0(),console.log(E("addlore.log.setHighest",`${H0}: Set highest memory processed to message {{endMessage}}`,{endMessage:J}))}catch(Q){console.error(E("addlore.log.updateHighestError",`${H0}: Error updating highest memory processed:`),Q)}}function z0(Z,Q){if(!Z||!Z.entries||!Q)return null;let G=Object.values(Z.entries);for(let J of G)if((J.comment||"")===Q)return J;return null}async function M8(Z,Q,G,J={}){let{refreshEditor:W=!0}=J;if(!Z||!Q||!Array.isArray(G))throw Error(E("addlore.upsert.errors.invalidArgs","Invalid arguments to upsertLorebookEntriesBatch"));let q=[];for(let z of G){if(!z||!z.title)continue;let Y=String(z.title),K=z.content!=null?String(z.content):"",X=z.defaults||{},V=z.metadataUpdates||{},F=z.entryOverrides||{},j=z0(Q,Y),O=!1;if(!j){if(j=WZ(Z,Q),!j)throw Error(E("addlore.upsert.errors.createFailed","Failed to create lorebook entry"));if(j.vectorized=!!X.vectorized,j.selective=!!X.selective,typeof X.order==="number")j.order=X.order;if(typeof X.position==="number")j.position=X.position;j.disable=!1,O=!0}if(j.key=Array.isArray(j.key)?j.key:[],j.keysecondary=Array.isArray(j.keysecondary)?j.keysecondary:[],typeof j.disable!=="boolean")j.disable=!1;j.comment=Y,j.content=K;for(let[H,A]of Object.entries(V))j[H]=A;for(let[H,A]of Object.entries(F))j[H]=A;q.push({title:Y,uid:j.uid,created:O})}if(await qZ(Z,Q,!0),W)YZ(Z);return q}async function XZ(Z,Q,G,J,W={}){let{defaults:q={vectorized:!0,selective:!0,order:100,position:0},metadataUpdates:z={},refreshEditor:Y=!0,entryOverrides:K={}}=W;if(!Z||!Q||!G)throw Error(E("addlore.upsert.errors.invalidArgs","Invalid arguments to upsertLorebookEntryByTitle"));let X=z0(Q,G),V=!1;if(!X){if(X=WZ(Z,Q),!X)throw Error(E("addlore.upsert.errors.createFailed","Failed to create lorebook entry"));if(X.vectorized=!!q.vectorized,X.selective=!!q.selective,typeof q.order==="number")X.order=q.order;if(typeof q.position==="number")X.position=q.position;X.key=X.key||[],X.keysecondary=X.keysecondary||[],X.disable=!1,V=!0}X.comment=G,X.content=J!=null?String(J):"";for(let[F,j]of Object.entries(z||{}))X[F]=j;for(let[F,j]of Object.entries(K||{}))X[F]=j;if(await qZ(Z,Q,!0),Y)YZ(Z);return{uid:X.uid,created:V}}import{getCurrentChatId as ZG,name1 as QG,name2 as GG,chat_metadata as $G,saveMetadata as JG}from"../../../../script.js";import{createNewWorldInfo as WG,METADATA_KEY as qG,world_names as VZ}from"../../../world-info.js";import{translate as YG}from"../../../i18n.js";var K6="STMemoryBooks-AutoCreate";function x0(Z,Q,G){let J=YG(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function zG(Z){if(!Z||Z.trim()==="")Z=x0("STMemoryBooks_LorebookNameTemplatePlaceholder","LTM - {{char}} - {{chat}}");let Q=ZG()||x0("common.unknown","Unknown"),G=GG||x0("common.unknown","Unknown"),J=QG||x0("addlore.defaults.user","User"),W=Z.replace(/\{\{chat\}\}/g,Q).replace(/\{\{char\}\}/g,G).replace(/\{\{user\}\}/g,J);if(W=W.replace(/[\/\\:*?"<>|]/g,"_").replace(/_{2,}/g,"_").substring(0,60),!VZ||!VZ.includes(W))return W;for(let q=2;q<=999;q++){let z=`${W} ${q}`;if(!VZ.includes(z))return z}return`${W} ${Date.now()}`}async function j6(Z,Q="chat"){try{let G=zG(Z);if(console.log(x0("autocreate.log.creating",`${K6}: Auto-creating lorebook "{{name}}" for {{context}}`,{name:G,context:Q})),await WG(G))return $G[qG]=G,await JG(),console.log(x0("autocreate.log.created",`${K6}: Successfully created and bound lorebook "{{name}}"`,{name:G})),toastr.success(x0("autocreate.toast.createdBound",'Created and bound lorebook "{{name}}"',{name:G}),x0("autocreate.toast.title","STMemoryBooks")),{success:!0,name:G};else return console.error(x0("autocreate.log.createFailed",`${K6}: Failed to create lorebook`)),{success:!1,error:x0("autocreate.errors.failedAutoCreate","Failed to auto-create lorebook.")}}catch(G){return console.error(x0("autocreate.log.createError",`${K6}: Error creating lorebook:`),G),{success:!1,error:x0("autocreate.errors.failedAutoCreateWithMessage","Failed to auto-create lorebook: {{message}}",{message:G.message})}}}e1();b0();import{extension_settings as v8}from"../../../extensions.js";import{chat as F6,chat_metadata as XG}from"../../../../script.js";import{METADATA_KEY as VG,world_names as Z5}from"../../../world-info.js";import{Popup as KG,POPUP_TYPE as jG,POPUP_RESULT as Q5}from"../../../popup.js";import{translate as FG}from"../../../i18n.js";function n(Z,Q,G){let J=FG(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}async function UG(){let Z=v8.STMemoryBooks,Q;if(!Z.moduleSettings.manualModeEnabled){if(Q=XG?.[VG]||null,!Q&&Z?.moduleSettings?.autoCreateLorebook){let G=Z.moduleSettings.lorebookNameTemplate||n("STMemoryBooks_LorebookNameTemplatePlaceholder","LTM - {{char}} - {{chat}}"),J=await j6(G,"auto-summary");if(J.success)Q=J.name;else return{valid:!1,error:J.error}}}else{let G=f()||{};if(Q=G.manualLorebook??null,!Q){let W=new KG(`
...
`);let z=G?s6(G):"";if(q.push(`
=== SCENE TEXT ===
`),q.push(z),J&&String(J).trim())q.push(`
=== RESPONSE FORMAT ===
`),q.push(String(J).trim());let Y=q.join("");return w0?.STMemoryBooks?.moduleSettings?.useRegex?x5(Y,N6.USER_INPUT,{isPrompt:!0}):Y}async function PZ(Z,Q=null){let G,J,W,q,z;if(Q&&(Q.api||Q.model))G=q0(Q.api||"openai"),J=Q.model||"",W=typeof Q.temperature==="number"?Q.temperature:0.7,q=Q.endpoint||null,z=Q.apiKey||null,console.debug(`${c}: runLLM using overrides api=${G} model=${J} temp=${W}`);else{let V=o(),F=Q0();G=q0(V.completionSource||V.api||"openai"),J=F.model||"",W=F.temperature??0.7,console.debug(`${c}: runLLM using UI settings api=${G} model=${J} temp=${W}`)}let Y=Q&&typeof Q.extra==="object"&&Q.extra?{...Q.extra}:{};if(v5?.openai_max_tokens&&Y.max_tokens==null&&Y.max_completion_tokens==null)Y.max_tokens=v5.openai_max_tokens;let{text:K}=await o4({api:G,model:J,prompt:Z,temperature:W,endpoint:q,apiKey:z,extra:Y});return w0?.STMemoryBooks?.moduleSettings?.useRegex?x5(K||"",N6.AI_OUTPUT):K||""}function N8(Z=null,Q={}){try{if(Z&&(Z.effectiveConnection||Z.connection)){let Y=Z.effectiveConnection||Z.connection||{},K=o6(Z),{api:X,model:V,temperature:F,endpoint:j,apiKey:O}=K,H=Y&&typeof Y.extra==="object"&&Y.extra?Y.extra:void 0;return console.debug(`${c}: resolveSidePromptConnection using provided profile api=${X} model=${V} temp=${F}`),{api:X,model:V,temperature:F,endpoint:j,apiKey:O,extra:H}}let G=w0?.STMemoryBooks,J=G?.profiles||[],W=Q&&Number.isFinite(Q.overrideProfileIndex)?Number(Q.overrideProfileIndex):null;if(W!==null&&J.length>0){if(W<0||W>=J.length)W=0;let Y=J[W];if(Y?.useDynamicSTSettings||Y?.connection?.api==="current_st"){let K=o(),X=Q0(),V=q0(K.completionSource||K.api||"openai"),F=X.model||"",j=X.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection using UI via template override profile index=${W} api=${V} model=${F} temp=${j}`),{api:V,model:F,temperature:j}}else{let K=Y?.connection||{},X=q0(K.api||"openai"),V=K.model||"",F=typeof K.temperature==="number"?K.temperature:0.7,j=K.endpoint||null,O=K.apiKey||null,H=K&&typeof K.extra==="object"&&K.extra?K.extra:void 0;return console.debug(`${c}: resolveSidePromptConnection using template override profile index=${W} api=${X} model=${V} temp=${F}`),{api:X,model:V,temperature:F,endpoint:j,apiKey:O,extra:H}}}let q=Number(G?.defaultProfile??0);if(!Array.isArray(J)||J.length===0){let Y=o(),K=Q0(),X=q0(Y.completionSource||Y.api||"openai"),V=K.model||"",F=K.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection fallback to UI (no profiles) api=${X} model=${V} temp=${F}`),{api:X,model:V,temperature:F}}if(!Number.isFinite(q)||q<0||q>=J.length)q=0;let z=J[q];if(z?.useDynamicSTSettings||z?.connection?.api==="current_st"){let Y=o(),K=Q0(),X=q0(Y.completionSource||Y.api||"openai"),V=K.model||"",F=K.temperature??0.7;return console.debug(`${c}: resolveSidePromptConnection using UI via dynamic default profile api=${X} model=${V} temp=${F}`),{api:X,model:V,temperature:F}}else{let Y=z?.connection||{},K=q0(Y.api||"openai"),X=Y.model||"",V=typeof Y.temperature==="number"?Y.temperature:0.7,F=Y.endpoint||null,j=Y.apiKey||null,O=Y&&typeof Y.extra==="object"&&Y.extra?Y.extra:void 0;return console.debug(`${c}: resolveSidePromptConnection using default profile api=${K} model=${X} temp=${V}`),{api:K,model:X,temperature:V,endpoint:F,apiKey:j,extra:O}}}catch(G){let J=o(),W=Q0(),q=q0(J.completionSource||J.api||"openai"),z=W.model||"",Y=W.temperature??0.7;return console.warn(`${c}: resolveSidePromptConnection error; falling back to UI`,G),{api:q,model:z,temperature:Y}}}function E8(Z,Q){let G=Number(Z);return Number.isFinite(G)?G:Q}function xZ(Z){let Q=Z&&Z.settings&&Z.settings.lorebook||{};return{constVectMode:Q.constVectMode||"link",position:E8(Q.position,0),orderMode:Q.orderMode==="manual"?"manual":"auto",orderValue:E8(Q.orderValue,100),preventRecursion:Q.preventRecursion!==!1,delayUntilRecursion:!!Q.delayUntilRecursion,outletName:String(Q.outletName||"")}}function SZ(Z){let Q={vectorized:Z.constVectMode==="link",selective:!0,order:Z.orderMode==="manual"?E8(Z.orderValue,100):100,position:E8(Z.position,0)},G={constant:Z.constVectMode==="blue",vectorized:Z.constVectMode==="link",preventRecursion:!!Z.preventRecursion,delayUntilRecursion:!!Z.delayUntilRecursion};if(Z.orderMode==="manual")G.order=E8(Z.orderValue,100);if(Number(Z.position)===7&&Z.outletName)G.outletName=String(Z.outletName);return{defaults:Q,entryOverrides:G}}async function EZ(){try{let Z=await A6("onInterval");if(!Z||Z.length===0)return;let Q=await MZ(),G=b8.length-1;if(G<0)return;for(let J of Z){let W=`${J.name} (STMB SidePrompt)`,q=`${J.name} (STMB Tracker)`,z=z0(Q.data,W)||z0(Q.data,q),Y=Number((z&&z[`STMB_sp_${J.key}_lastMsgId`])??(z&&z.STMB_tracker_lastMsgId)??-1),K=z?.[`STMB_sp_${J.key}_lastRunAt`]?Date.parse(z[`STMB_sp_${J.key}_lastRunAt`]):z?.STMB_tracker_lastRunAt?Date.parse(z.STMB_tracker_lastRunAt):null,X=Date.now(),V=1e4;if(K&&X-K<1e4)continue;let F=vG(Y,G),j=Math.max(1,Number(J?.triggers?.onInterval?.visibleMessages??50));if(F<j)continue;let O=Math.max(0,Y+1),A=Math.max(O,G-200+1),B=null;try{B=hZ(A,G)}catch(_){console.warn(`${c}: Interval compile failed:`,_);continue}let D=z?.content||"",T=[],L=Number(J?.settings?.previousMemoriesCount??0),P=Math.max(0,Math.min(7,L));if(P>0)try{T=(await x1(P,w0,D6))?.summaries||[]}catch{}let x=vZ(J.prompt,D,B,J.responseFormat,T),w="";try{let _=Number(J?.settings?.overrideProfileIndex),u=!!J?.settings?.overrideProfileEnabled&&Number.isFinite(_)?N8(null,{overrideProfileIndex:_}):N8(null);console.log(`${c}: SidePrompt attempt`,{trigger:"onInterval",name:J.name,key:J.key,range:`${A}-${G}`,visibleSince:F,threshold:j,api:u.api,model:u.model}),w=await PZ(x,u)}catch(_){console.error(`${c}: Interval sideprompt LLM failed:`,_),toastr.error(V1`SidePrompt "${J.name}" failed: ${_.message}`,"STMemoryBooks");continue}try{if(w0?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let h={extractedTitle:W,content:w,suggestedKeys:[]},u={sceneStart:B?.metadata?.sceneStart??A,sceneEnd:B?.metadata?.sceneEnd??G,messageCount:B?.metadata?.messageCount??(B?.messages?.length??0)},e={name:"SidePrompt"},y;if(await E5(async()=>{y=await O8(h,u,e,{lockTitle:!0})}),y?.action==="cancel"||y?.action==="retry"){console.log(`${c}: SidePrompt "${J.name}" canceled or retry requested in preview; skipping save`);continue}else if(y?.action==="edit"&&y.memoryData)w=y.memoryData.content??w}}catch(_){console.warn(`${c}: Preview step failed; proceeding without preview`,_)}try{let _=xZ(J),{defaults:h,entryOverrides:u}=SZ(_),e=B?.metadata?.sceneEnd??G;await XZ(Q.name,Q.data,W,w,{defaults:h,entryOverrides:u,metadataUpdates:{[`STMB_sp_${J.key}_lastMsgId`]:G,[`STMB_sp_${J.key}_lastRunAt`]:new Date().toISOString(),STMB_tracker_lastMsgId:G,STMB_tracker_lastRunAt:new Date().toISOString()},refreshEditor:w0?.STMemoryBooks?.moduleSettings?.refreshEditor!==!1}),console.log(`${c}: SidePrompt success`,{trigger:"onInterval",name:J.name,key:J.key,saved:!0,contentChars:w.length})}catch(_){console.error(`${c}: Interval sideprompt upsert failed:`,_),toastr.error(V1`Failed to update sideprompt entry "${J.name}"`,"STMemoryBooks");continue}}}catch(Z){}}async function bZ(Z,Q=null){try{let G=await MZ(),J=await A6("onAfterMemory");if(!J||J.length===0)return;let W=N8(Q);console.debug(`${c}: runAfterMemory default overrides api=${W.api} model=${W.model} temp=${W.temperature}`);let q=w0?.STMemoryBooks,z=q?.moduleSettings?.refreshEditor!==!1,Y=q?.moduleSettings?.showNotifications!==!1,K=[],X=K0(Number(q?.moduleSettings?.sidePromptsMaxConcurrent??2),1,5),V=[];for(let F=0;F<J.length;F+=X)V.push(J.slice(F,F+X));for(let F of V){let j=F.map(async(B)=>{try{let D=`${B.name} (STMB SidePrompt)`,L=(z0(G.data,D)||z0(G.data,`${B.name} (STMB Plotpoints)`)||z0(G.data,`${B.name} (STMB Scoreboard)`))?.content||"",P=[],x=Number(B?.settings?.previousMemoriesCount??0),w=Math.max(0,Math.min(7,x));if(w>0)try{P=(await x1(w,w0,D6))?.summaries||[]}catch{}let _=vZ(B.prompt,L,Z,B.responseFormat,P),h=Number(B?.settings?.overrideProfileIndex),e=!!B?.settings?.overrideProfileEnabled&&Number.isFinite(h)?N8(null,{overrideProfileIndex:h}):W;console.log(`${c}: SidePrompt attempt`,{trigger:"onAfterMemory",name:B.name,key:B.key,api:e.api,model:e.model});let y=await PZ(_,e);return{ok:!0,tpl:B,text:y}}catch(D){return console.error(`${c}: Wave LLM failed for "${B.name}":`,D),{ok:!1,tpl:B,error:D}}}),O=await Promise.all(j.map((B)=>B.then((D)=>({...D,_completedAt:performance.now()}))));O.sort((B,D)=>B._completedAt-D._completedAt);let H=[],A=[];for(let B of O){if(!B.ok){K.push({name:B.tpl?.name||"unknown",ok:!1,error:B.error});continue}let D=B.text,T=!0;try{if(w0?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let P={extractedTitle:`${B.tpl.name} (STMB SidePrompt)`,content:D,suggestedKeys:[]},x={sceneStart:Z?.metadata?.sceneStart??0,sceneEnd:Z?.metadata?.sceneEnd??0,messageCount:Z?.metadata?.messageCount??(Z?.messages?.length??0)},w={name:"SidePrompt"},_;if(await E5(async()=>{_=await O8(P,x,w,{lockTitle:!0})}),_?.action==="cancel"||_?.action==="retry")T=!1;else if(_?.action==="edit"&&_.memoryData)D=_.memoryData.content??D}}catch(L){console.warn(`${c}: Preview step failed; proceeding without preview`,L)}if(T){let L=B.tpl,P=`${L.name} (STMB SidePrompt)`,x=xZ(L),{defaults:w,entryOverrides:_}=SZ(x);H.push({title:P,content:D,defaults:w,entryOverrides:_,metadataUpdates:{[`STMB_sp_${L.key}_lastRunAt`]:new Date().toISOString()}}),A.push(L.name)}else K.push({name:B.tpl.name,ok:!1,error:Error("User canceled or retry in preview")})}if(H.length>0)try{let B=await S5(G.name);await M8(G.name,B,H,{refreshEditor:z}),G.data=B;for(let D of A){if(K.push({name:D,ok:!0}),Y)toastr.success(V1`SidePrompt "${D}" updated.`,"STMemoryBooks");console.log(`${c}: SidePrompt success`,{trigger:"onAfterMemory",name:D,saved:!0})}}catch(B){console.error(`${c}: Wave save failed:`,B),toastr.error(A0("Failed to save SidePrompt updates for this wave","STMemoryBooks_Toast_FailedToSaveWave"),"STMemoryBooks");for(let D of A)K.push({name:D,ok:!1,error:B})}}if(Y&&K.length>0){let F=K.filter((B)=>B.ok).map((B)=>B.name),j=K.filter((B)=>!B.ok).map((B)=>B.name),O=F.length,H=j.length,A=(B)=>{if(B.length===0)return"";let T=B.slice(0,5).join(", "),L=B.length>5?`, +${B.length-5} more`:"";return`${T}${L}`};if(H===0)toastr.info(V1`Side Prompts after memory: ${O} succeeded. ${A(F)}`,"STMemoryBooks");else toastr.warning(V1`Side Prompts after memory: ${O} succeeded, ${H} failed. ${H?"Failed: "+A(j):""}`,"STMemoryBooks")}}catch(G){}}async function yZ(Z){try{let Q=await MZ(),{name:G,range:J}=PG(Z);if(!G)return toastr.error(A0('SidePrompt name not provided. Usage: /sideprompt "Name" [X-Y]',"STMemoryBooks_Toast_SidePromptNameNotProvided"),"STMemoryBooks"),"";let W=await TZ(G);if(!W)return toastr.error(A0("SidePrompt template not found. Check name.","STMemoryBooks_Toast_SidePromptNotFound"),"STMemoryBooks"),"";if(!(Array.isArray(W?.triggers?.commands)&&W.triggers.commands.some((B)=>String(B).toLowerCase()==="sideprompt")))return toastr.error(A0('Manual run is disabled for this template. Enable "Allow manual run via /sideprompt" in the template settings.',"STMemoryBooks_Toast_ManualRunDisabled"),"STMemoryBooks"),"";let z=b8.length-1;if(z<0)return toastr.error(A0("No messages available.","STMemoryBooks_Toast_NoMessagesAvailable"),"STMemoryBooks"),"";let Y=null;if(J){let B=String(J).trim().match(/^(\d+)\s*[-–—]\s*(\d+)$/);if(!B)return toastr.error(A0("Invalid range format. Use X-Y","STMemoryBooks_Toast_InvalidRangeFormat"),"STMemoryBooks"),"";let D=parseInt(B[1],10),T=parseInt(B[2],10);if(!(D>=0&&T>=D&&T<b8.length))return toastr.error(A0("Invalid message range for /sideprompt","STMemoryBooks_Toast_InvalidMessageRange"),"STMemoryBooks"),"";try{Y=hZ(D,T)}catch(L){return toastr.error(A0("Failed to compile the specified range","STMemoryBooks_Toast_FailedToCompileRange"),"STMemoryBooks"),""}}else{if(!P5)toastr.info(A0('Tip: You can run a specific range with /sideprompt "Name" X-Y (e.g., /sideprompt "Scoreboard" 100-120). Running without a range uses messages since the last checkpoint.',"STMemoryBooks_Toast_SidePromptRangeTip"),"STMemoryBooks"),P5=!0;let B=`${W.name} (STMB SidePrompt)`,D=z0(Q.data,B)||z0(Q.data,`${W.name} (STMB Scoreboard)`)||z0(Q.data,`${W.name} (STMB Plotpoints)`)||z0(Q.data,`${W.name} (STMB Tracker)`),T=Number((D&&D[`STMB_sp_${W.key}_lastMsgId`])??(D&&D.STMB_score_lastMsgId)??(D&&D.STMB_tracker_lastMsgId)??-1),L=Math.max(0,T+1),x=Math.max(L,z-200+1);try{Y=hZ(x,z)}catch(w){return toastr.error(A0("Failed to compile messages for /sideprompt","STMemoryBooks_Toast_FailedToCompileMessages"),"STMemoryBooks"),""}}let K=`${W.name} (STMB SidePrompt)`,V=(z0(Q.data,K)||z0(Q.data,`${W.name} (STMB Scoreboard)`)||z0(Q.data,`${W.name} (STMB Plotpoints)`)||z0(Q.data,`${W.name} (STMB Tracker)`))?.content||"",F=[],j=Number(W?.settings?.previousMemoriesCount??0),O=Math.max(0,Math.min(7,j));if(O>0)try{F=(await x1(O,w0,D6))?.summaries||[]}catch{}let H=vZ(W.prompt,V,Y,W.responseFormat,F),A="";try{let B=Number(W?.settings?.overrideProfileIndex),T=!!W?.settings?.overrideProfileEnabled&&Number.isFinite(B)?N8(null,{overrideProfileIndex:B}):N8(null);console.log(`${c}: SidePrompt attempt`,{trigger:"manual",name:W.name,key:W.key,rangeProvided:!!J,api:T.api,model:T.model}),A=await PZ(H,T);try{if(w0?.STMemoryBooks?.moduleSettings?.showMemoryPreviews){let h={extractedTitle:K,content:A,suggestedKeys:[]},u={sceneStart:Y?.metadata?.sceneStart??0,sceneEnd:Y?.metadata?.sceneEnd??0,messageCount:Y?.metadata?.messageCount??(Y?.messages?.length??0)},y=await O8(h,u,{name:"SidePrompt"},{lockTitle:!0});if(y?.action==="cancel"||y?.action==="retry")return toastr.info(V1`SidePrompt "${W.name}" canceled.`,"STMemoryBooks"),"";else if(y?.action==="edit"&&y.memoryData)A=y.memoryData.content??A}}catch(_){console.warn(`${c}: Preview step failed; proceeding without preview`,_)}let L=xZ(W),{defaults:P,entryOverrides:x}=SZ(L),w=Y?.metadata?.sceneEnd??z;await XZ(Q.name,Q.data,K,A,{defaults:P,entryOverrides:x,metadataUpdates:{[`STMB_sp_${W.key}_lastMsgId`]:w,[`STMB_sp_${W.key}_lastRunAt`]:new Date().toISOString(),STMB_tracker_lastMsgId:w,STMB_tracker_lastRunAt:new Date().toISOString()},refreshEditor:w0?.STMemoryBooks?.moduleSettings?.refreshEditor!==!1}),console.log(`${c}: SidePrompt success`,{trigger:"manual",name:W.name,key:W.key,saved:!0,contentChars:A.length})}catch(B){return console.error(`${c}: /sideprompt failed:`,B),toastr.error(V1`SidePrompt "${W.name}" failed: ${B.message}`,"STMemoryBooks"),""}return toastr.success(V1`SidePrompt "${W.name}" updated.`,"STMemoryBooks"),""}catch(Q){return""}}function PG(Z){let Q=String(Z||"").trim();if(!Q)return{name:"",range:null};let G="",J="",W=Q.match(/^"([^"]+)"\s*(.*)$/),q=!W&&Q.match(/^'([^']+)'\s*(.*)$/);if(W)G=W[1],J=W[2]||"";else if(q)G=q[1],J=q[2]||"";else{let Y=Q.match(/(\d+)\s*[-–—]\s*(\d+)\s*$/);if(Y)G=Q.slice(0,Y.index).trim(),J=Q.slice(Y.index);else G=Q,J=""}let z=null;if(J){let Y=J.match(/(\d+)\s*[-–—]\s*(\d+)/);if(Y)z=`${Y[1]}-${Y[2]}`}return{name:G,range:z}}S8();import{Popup as y8,POPUP_TYPE as E1,POPUP_RESULT as j1}from"../../../popup.js";import{DOMPurify as T6}from"../../../../lib.js";import{escapeHtml as R}from"../../../utils.js";import{extension_settings as l0}from"../../../extensions.js";import{saveSettingsDebounced as SG}from"../../../../script.js";import{Handlebars as xG}from"../../../../lib.js";var b5=xG.compile(`
...
`);import{translate as N,applyLocale as y5}from"../../../i18n.js";function e0(Z,Q,G){let J=N(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let z=G[q];return z!==void 0&&z!==null?String(z):""})}function f5(Z){let Q=[],G=Z?.triggers||{};if(G.onInterval&&Number(G.onInterval.visibleMessages)>=1)Q.push(`${N("Interval","STMemoryBooks_Interval")}:${Number(G.onInterval.visibleMessages)}`);if(G.onAfterMemory&&!!G.onAfterMemory.enabled)Q.push(N("AfterMemory","STMemoryBooks_AfterMemory"));if(Array.isArray(G.commands)&&G.commands.some((J)=>String(J).toLowerCase()==="sideprompt"))Q.push(N("Manual","STMemoryBooks_Manual"));return Q}function EG(Z){let Q=(Z||[]).map((G)=>({key:String(G.key||""),name:String(G.name||""),badges:f5(G)}));return b5({items:Q})}async function K1(Z,Q=null){let G=Z?.dlg?.querySelector("#stmb-sp-list");if(!G)return;let J=(Z?.dlg?.querySelector("#stmb-sp-search")?.value||"").toLowerCase(),W=await X1(),q=J?W.filter((z)=>{let Y=z.name.toLowerCase().includes(J),K=f5(z).join(" ").toLowerCase();return Y||K.includes(J)}):W;G.innerHTML=T6.sanitize(EG(q));try{y5(G)}catch(z){}if(Q){let z=G.querySelector(`tr[data-tpl-key="${CSS.escape(Q)}"]`);if(z)z.style.backgroundColor="var(--cobalt30a)",z.style.border=""}}async function bG(Z,Q){try{let G=await DZ(Q);if(!G){toastr.error(e0("STMemoryBooks_TemplateNotFound",'Template "{{key}}" not found',{key:Q}),N("STMemoryBooks","index.toast.title"));return}let J=!!G.enabled,W=G.settings||{},q=G.triggers||{},z=!!(q.onInterval&&Number(q.onInterval.visibleMessages)>=1),Y=z?Math.max(1,Number(q.onInterval.visibleMessages)):50,K=!!(q.onAfterMemory&&q.onAfterMemory.enabled),X=Array.isArray(q.commands)?q.commands.some((C)=>String(C).toLowerCase()==="sideprompt"):!1,V=l0?.STMemoryBooks?.profiles||[],F=Number.isFinite(W.overrideProfileIndex)?Number(W.overrideProfileIndex):l0?.STMemoryBooks?.defaultProfile??0;if(!(F>=0&&F<V.length))F=0;let j=!!W.overrideProfileEnabled,O=V.map((C,d)=>`<option value="${d}" ${d===F?"selected":""}>${R(C?.name||"Profile "+(d+1))}</option>`).join(""),H=`
            <div class="world_entry_form_control">
                <label class="checkbox_label">
...
- No quotes, no OOC, no commentary outside JSON`,"STMemoryBooks_ArcPrompt_Tiny")}}function F1(){return g5()}function f8(){return g5().arc_default}D1();import{getRequestHeaders as kZ}from"../../../../script.js";import{translate as u5}from"../../../i18n.js";var k8="STMemoryBooks-ArcAnalysisPromptManager",gZ=s1.ARC_PROMPTS_FILE,g8={arc_default:"Multi-Arc Analysis",arc_alternate:"Single Arc"},b1=null;function gG(Z){return String(Z||"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").substring(0,50)}function U1(Z){return String(Z||"").replace(/\w\S*/g,(Q)=>{return Q.charAt(0).toUpperCase()+Q.slice(1).toLowerCase()})}function u8(Z){let Q=String(Z||"").split(`
`).filter((G)=>G.trim());if(Q.length>0){let J=Q[0].trim().replace(/^(You are|Analyze|Create|Generate|Write)\s+/i,"").replace(/[:.]/g,"").trim();return U1(J.substring(0,50))}return"Arc Prompt"}function m5(Z,Q){let G=F1()||{},J=Q||{},W=gG(Z||"arc-prompt"),q=W,z=2;while(q in J||q in G)q=`${W}-${z++}`;return q}function d5(Z){if(!Z||typeof Z!=="object")return!1;if(typeof Z.version!=="number")return!1;if(!Z.overrides||typeof Z.overrides!=="object")return!1;for(let[Q,G]of Object.entries(Z.overrides)){if(!G||typeof G!=="object")return!1;if(typeof G.prompt!=="string"||!G.prompt.trim())return!1;if(G.displayName!==void 0&&typeof G.displayName!=="string")return!1}return!0}async function u0(Z=null){if(b1)return b1;let Q=!1,G=null;try{let J=await fetch(`/user/files/${gZ}`,{method:"GET",credentials:"include",headers:kZ()});if(!J.ok)Q=!0;else{let W=await J.text();if(G=JSON.parse(W),!d5(G))Q=!0}}catch{Q=!0}if(Q){let J={},W=new Date().toISOString(),q=F1()||{};for(let[z,Y]of Object.entries(q)){let K;if(g8[z])K=u5(g8[z])||U1(z.replace(/^arc[_-]?/,"").replace(/[_-]/g," "))||u8(Y);else K=U1(z.replace(/^arc[_-]?/,"").replace(/[_-]/g," "))||u8(Y);J[z]={displayName:K,prompt:Y,createdAt:W}}G={version:s0.CURRENT_VERSION,overrides:J},await y1(G)}return b1=G,b1}async function y1(Z){let Q=JSON.stringify(Z,null,2),G=btoa(unescape(encodeURIComponent(Q))),J=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:kZ(),body:JSON.stringify({name:gZ,data:G})});if(!J.ok){let W=u5("Failed to save arc prompts","STMemoryBooks_ArcPromptManager_SaveFailed");throw Error(`${W}: ${J.statusText}`)}b1=Z,console.log(`${k8}: Arc prompts saved`)}async function uZ(Z){return await u0(Z),!0}async function R6(Z=null){let Q=await u0(Z),G=[];for(let[W,q]of Object.entries(Q.overrides))G.push({key:W,displayName:q.displayName||U1(W),createdAt:q.createdAt||null});let J=F1()||{};for(let W of Object.keys(J))if(!(W in Q.overrides))G.push({key:W,displayName:g8[W]||U1(W.replace(/^arc[_-]?/,"").replace(/[_-]/g," ")),createdAt:null});return G.sort((W,q)=>{if(!W.createdAt)return 1;if(!q.createdAt)return-1;return new Date(q.createdAt)-new Date(W.createdAt)}),G}async function _6(Z,Q=null){let G=await u0(Q);if(G.overrides[Z]&&typeof G.overrides[Z].prompt==="string"&&G.overrides[Z].prompt.trim())return G.overrides[Z].prompt;return F1()[Z]||f8()}async function mZ(Z,Q=null){let G=await u0(Q);if(G.overrides[Z]&&G.overrides[Z].displayName)return G.overrides[Z].displayName;return g8[Z]||U1(String(Z||"").replace(/^arc[_-]?/,"").replace(/[_-]/g," "))||"Arc Prompt"}async function c5(Z,Q=null){let G=await u0(Q),J=F1()||{};return!!(G.overrides[Z]||J[Z])}async function dZ(Z,Q,G){let J=await u0(),W=new Date().toISOString(),q=Z;if(!q)q=m5(G||u8(Q),J.overrides);if(J.overrides[q])J.overrides[q].prompt=Q,J.overrides[q].displayName=G||J.overrides[q].displayName,J.overrides[q].updatedAt=W;else J.overrides[q]={displayName:G||u8(Q),prompt:Q,createdAt:W};return await y1(J),q}async function p5(Z){let Q=await u0(),G=Q.overrides[Z];if(!G)throw Error(`Arc preset "${Z}" not found`);let J=`${G.displayName||U1(Z)} (Copy)`,W=m5(J,Q.overrides),q=new Date().toISOString();return Q.overrides[W]={displayName:J,prompt:G.prompt,createdAt:q},await y1(Q),W}async function i5(Z){let Q=await u0();if(!Q.overrides[Z])throw Error(`Arc preset "${Z}" not found`);delete Q.overrides[Z],await y1(Q)}async function l5(){let Z=await u0();return JSON.stringify(Z,null,2)}async function o5(Z){let Q=JSON.parse(Z);if(!d5(Q))throw Error("Invalid arc prompts file structure.");await y1(Q)}async function n5(Z="overwrite"){if(Z!=="overwrite")console.warn(`${k8}: Unsupported mode "${Z}", defaulting to overwrite`);let Q=await u0(),G=F1()||{},J=Object.keys(G),W=0;if(Q&&Q.overrides&&typeof Q.overrides==="object"){for(let q of J)if(q in Q.overrides)delete Q.overrides[q],W++}return await y1(Q),b1=Q,console.log(`${k8}: Recreated arc built-ins (removed ${W} overrides)`),{removed:W}}async function s5(Z={}){let Q=Z.backup!==!1,G=F1()||{},J=new Date().toISOString(),W={};for(let[Y,K]of Object.entries(G))W[Y]={displayName:g8[Y]||U1(Y.replace(/^arc[_-]?/,"").replace(/[_-]/g," "))||u8(K),prompt:K,createdAt:J};let q;try{let Y=await u0();if(Q&&Y){let K=String(gZ||"stmb-arc-prompts.json").replace(/\.json$/i,""),X=J.replace(/[:.]/g,"-");q=`${K}.backup-${X}.json`;let V=JSON.stringify(Y,null,2),F=btoa(unescape(encodeURIComponent(V))),j=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:kZ(),body:JSON.stringify({name:q,data:F})});if(!j.ok)console.warn(`${k8}: Failed to write backup "${q}": ${j.statusText}`)}}catch(Y){console.warn(`${k8}: Backup step failed:`,Y)}let z={version:s0.CURRENT_VERSION,overrides:W};await y1(z),b1=z;try{window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated"))}catch{}return{count:Object.keys(W).length,backupName:q}}import{extension_settings as Z7}from"../../../extensions.js";import{translate as I6}from"../../../i18n.js";var uG=`Based on this narrative arc summary, generate 15–30 standalone topical keywords that function as retrieval tags, not micro-summaries.
Keywords must be:
- Concrete and scene-specific (locations, objects, proper nouns, unique actions, repeated motifs).
- One concept per keyword — do NOT combine multiple ideas into one keyword.
- Useful for retrieval if the user later mentions that noun or action alone, not only in a specific context.
...
`).replace(/\\n/g,`
`).replace(/\\t/g,"\t").replace(/\\"/g,'"').replace(/\\\\/g,"\\"),q.trim()||null}function $7(Z){let Q=Z.search(/[\{\[]/);if(Q===-1)return null;let G=Z[Q],J=G==="{"?"}":"]",W=0,q=!1,z=!1;for(let Y=Q;Y<Z.length;Y++){let K=Z[Y];if(q){if(z)z=!1;else if(K==="\\")z=!0;else if(K==='"')q=!1;continue}if(K==='"'){q=!0;continue}if(K===G)W++;else if(K===J){if(W--,W===0)return Z.slice(Q,Y+1).trim()}}return null}function J7(Z){let Q="",G=!1,J=!1,W=!1,q=!1;for(let z=0;z<Z.length;z++){let Y=Z[z],K=Z[z+1];if(G){if(Q+=Y,J)J=!1;else if(Y==="\\")J=!0;else if(Y==='"')G=!1;continue}if(W){if(Y===`
`)W=!1,Q+=Y;continue}if(q){if(Y==="*"&&K==="/")q=!1,z++;continue}if(Y==='"'){G=!0,Q+=Y;continue}if(Y==="/"&&K==="/"){W=!0,z++;continue}if(Y==="/"&&K==="*"){q=!0,z++;continue}Q+=Y}return Q}function W7(Z){let Q="",G=!1,J=!1;for(let W=0;W<Z.length;W++){let q=Z[W];if(G){if(Q+=q,J)J=!1;else if(q==="\\")J=!0;else if(q==='"')G=!1;continue}if(q==='"'){G=!0,Q+=q;continue}if(q===","){let z=W+1;while(z<Z.length&&/\s/.test(Z[z]))z++;if(Z[z]==="}"||Z[z]==="]")continue}Q+=q}return Q}function a5(Z){let Q=[],G=new Set;for(let J of Z||[]){let W=String(J||"").trim();if(W=W.replace(/^["']|["']$/g,""),W=W.replace(/^\d+\.\s*/,""),W=W.replace(/^[\-\*\u2022]\s*/,""),W=W.trim(),!W)continue;let q=W.toLowerCase();if(G.has(q))continue;if(G.add(q),Q.push(W),Q.length>=30)break}return Q}function t5(Z){let Q=Q7(String(Z||"").trim()),G=[],J=G7(Q);if(J.length)G.push(...J);let W=$7(Q);if(W)G.push(W);G.push(Q);let q=Array.from(new Set(G));for(let K of q)try{let X=W7(J7(K)),V=JSON.parse(X),F=Array.isArray(V)?V:V&&Array.isArray(V.keywords)?V.keywords:null;if(F)return a5(F)}catch{}let z=Q.split(/\r?\n/).map((K)=>K.trim()).filter(Boolean),Y=[];if(z.length>1)Y=z.map((K)=>K.replace(/^[\-\*\u2022]?\s*\d*\.?\s*/,"").trim());else Y=Q.split(/[,;]+/).map((K)=>K.trim());return a5(Y)}async function dG(Z,Q){let G=String(Z||"").trim(),J=`${uG}

=== ARC SUMMARY ===
${G}
=== END SUMMARY ===`,{text:W}=await h1({model:Q.model,prompt:J,temperature:typeof Q.temperature==="number"?Q.temperature:0.2,api:Q.api,endpoint:Q.endpoint,apiKey:Q.apiKey,extra});try{console.debug("STMB ArcAnalysis: keyword gen response length=%d",(W||"").length)}catch{}let q=[];try{q=t5(W)}catch{}if(!Array.isArray(q)||q.length===0){let z=`${J}

Return ONLY a JSON array of 15-30 strings.`,Y=await h1({model:Q.model,prompt:z,temperature:typeof Q.temperature==="number"?Q.temperature:0.2,api:Q.api,endpoint:Q.endpoint,apiKey:Q.apiKey,extra});q=t5(Y.text)}if(q.length>30)q=q.slice(0,30);return q}function cG(Z){let Q=[];for(let G of Z){if(!G||typeof G!=="object")continue;let J=String(G.uid??""),W=pG(G.comment??"")??0,q=String(G.content??"").trim(),z=(G.comment||"Untitled").toString().trim();Q.push({id:J,order:W,content:q,title:z})}return Q.sort((G,J)=>G.order-J.order),Q}function pG(Z){if(!Z)return null;let Q=Z.match(/\[(\d+)\]/);if(Q)return parseInt(Q[1],10);let G=Z.match(/^(\d+)[\s-]/);if(G)return parseInt(G[1],10);return null}function e5({briefs:Z,previousArcSummary:Q=null,previousArcOrder:G=null,promptText:J=null}){let W=J||f8(),q=[];if(Q){if(q.push("=== PREVIOUS ARC (CANON — DO NOT REWRITE, DO NOT INCLUDE IN YOUR NEW SUMMARY) ==="),typeof G<"u"&&G!==null)q.push(`Arc ${G}`);q.push(Q.trim()),q.push("=== END PREVIOUS ARC ==="),q.push("")}return q.push("=== MEMORIES ==="),Z.forEach((z,Y)=>{let K=String(Y+1).padStart(3,"0"),X=(z.title||"").toString().trim(),V=(z.content||"").toString().trim();q.push(`=== Memory ${K} ===`),q.push(`Title: ${X}`),q.push(`Contents: ${V}`),q.push(`=== end Memory ${K} ===`),q.push("")}),q.push("=== END MEMORIES ==="),q.push(""),`${W}

${q.join(`
`)}`}function m8(Z){if(!Z||typeof Z!=="string")throw Error(I6("Empty AI response","STMemoryBooks_ArcAnalysis_EmptyResponse"));let Q=Q7(Z.trim().replace(/<think>[\s\S]*?<\/think>/gi,"")),G=[],J=mG(Q);if(J)G.push(J);let W=G7(Q);if(W.length)G.push(...W);G.push(Q);let q=$7(Q);if(q)G.push(q);let z=Array.from(new Set(G));for(let Y of z)try{let K=Y;K=J7(K),K=W7(K);let X=JSON.parse(K);if(!X||typeof X!=="object")continue;if(!("arcs"in X)||!("unassigned_memories"in X))continue;let V=Array.isArray(X.arcs)?X.arcs:[],F=Array.isArray(X.unassigned_memories)?X.unassigned_memories:[],j=V.filter((H)=>H&&typeof H.title==="string"&&H.title.trim()&&typeof H.summary==="string"&&H.summary.trim()),O=F.filter((H)=>H&&typeof H.id==="string"&&H.id.trim()&&typeof H.reason==="string");return{arcs:j,unassigned_memories:O}}catch{}throw Error(I6("Model did not return valid arc JSON","STMemoryBooks_ArcAnalysis_InvalidJSON"))}async function q7(Z,Q={},G=null){let{presetKey:J="arc_default",maxItemsPerPass:W=12,maxPasses:q=10,minAssigned:z=2,tokenTarget:Y}=Q,K=Q?.extra??{},X=J==="arc_alternate",V=Object.prototype.hasOwnProperty.call(Q,"maxPasses")?q:X?1:q,F=Z7?.STMemoryBooks?.moduleSettings?.tokenWarningThreshold,j=typeof Y==="number"?Y:typeof F==="number"?F:30000,O=j,H=Z.map((y)=>y&&y.entry?y.entry:y).filter(Boolean),A=cG(H),B=new Map(A.map((y)=>[y.id,y])),D=[],T="",L="",P=null;try{if(J&&await c5(J))P=await _6(J)}catch{}if(!P)P=f8();let x=Y7(G),w=null,_=null,h=0,u=[];while(B.size>0&&h<V){h++,O=j;let y=Array.from(B.values()).sort((g,l)=>g.order-l.order),C=[];for(let g of u)if(B.has(g.id)&&C.length<W)C.push(g);for(let g of y){if(C.length>=W)break;if(!C.find((l)=>l.id===g.id))C.push(g)}if(C.length===0)break;try{console.debug("STMB ArcAnalysis: pass %d batch=%o",h,C.map((g)=>g.id))}catch{}let d=e5({briefs:C,previousArcSummary:w,previousArcOrder:_,promptText:P}),F0=await $1(d,{estimatedOutput:500}),m0=C.length,h0=!1;while(F0.total>O&&C.length>1)C.pop(),h0=!0,d=e5({briefs:C,previousArcSummary:w,previousArcOrder:_,promptText:P}),F0=await $1(d,{estimatedOutput:500});if(h0)try{console.debug("STMB ArcAnalysis: trimmed batch from %d to %d (est=%d, budget=%d)",m0,C.length,F0.total,O)}catch{}if(F0.total>O&&C.length===1){let g=O;O=F0.total;try{console.debug("STMB ArcAnalysis: raised budget for single item from %d to %d (est=%d)",g,O,F0.total)}catch{}}let{text:D0}=await h1({model:x.model,prompt:d,temperature:x.temperature??0.2,api:x.api,endpoint:x.endpoint,apiKey:x.apiKey,extra:K});T=String(D0??""),L="";let X0;try{X0=m8(D0)}catch(g){let l=`${d}

Return ONLY the JSON object, nothing else. Ensure arrays and commas are valid.`,G0=await h1({model:x.model,prompt:l,temperature:x.temperature??0.2,api:x.api,endpoint:x.endpoint,apiKey:x.apiKey,extra:K});L=String(G0?.text??"");try{X0=m8(G0.text)}catch(R0){let _0=Error(String(R0?.message||g?.message||"Model did not return valid arc JSON"));throw _0.name="ArcAIResponseError",_0.code="ARC_INVALID_JSON",_0.rawText=String(D0??""),_0.retryRawText=String(G0?.text??""),_0.prompt=d,_0.repairPrompt=l,_0}}let T0=new Map;C.forEach((g,l)=>{let G0=String(g.id);T0.set(G0,G0);let R0=String(l+1).padStart(3,"0");T0.set(R0,G0),T0.set(String(l+1),G0)});let A1=(g)=>T0.get(String(g).trim()),U0=new Set;if(Array.isArray(X0.unassigned_memories))X0.unassigned_memories.forEach((g)=>{let l=A1(g.id);if(l)U0.add(l)});let o0=C.filter((g)=>!U0.has(g.id));try{console.debug("STMB ArcAnalysis: pass %d arcs=%d unassigned=%d assigned=%d",h,Array.isArray(X0.arcs)?X0.arcs.length:0,U0.size,o0.length)}catch{}if(o0.length<z&&h>1)break;let T8=Array.isArray(X0.arcs)?X0.arcs:[],n0=new Set,x6=0;for(let g=0;g<T8.length;g++){let l=T8[g];if(!l||typeof l.title!=="string"||typeof l.summary!=="string")continue;let G0=null;if(Array.isArray(l.member_ids))G0=l.member_ids.map(A1).filter((R0)=>R0!==void 0);if(G0&&G0.length>0);else G0=o0.map((R0)=>R0.id);if(G0.length===0)continue;D.push({order:h*10+g,title:l.title,summary:l.summary,keywords:Array.isArray(l.keywords)?l.keywords:[],memberIds:G0}),G0.forEach((R0)=>n0.add(String(R0))),x6++,w=l.summary}if(D.length>0)_=D[D.length-1].order;else _=null;if(n0.size>0){for(let g of n0)B.delete(String(g));if(B.size===0&&D.length===1)try{console.info("STMB ArcAnalysis: all memories were consumed into a single arc.")}catch{}}else{try{console.debug("STMB ArcAnalysis: no new IDs consumed on pass %d; stopping.",h)}catch{}break}u=C.filter((g)=>U0.has(g.id));try{console.debug("STMB ArcAnalysis: pass %d consumed=%d remaining=%d",h,n0.size,B.size)}catch{}}let e=Array.from(B.values()).map((y)=>y.id);return{arcCandidates:D,leftovers:e,rawText:String(T??""),retryRawText:String(L??"")}}function Y7(Z){if(Z&&Z.api&&Z.model)return Z;if(Z&&(Z.effectiveConnection||Z.connection)){let J=Z.effectiveConnection||Z.connection;return{api:q0(J.api||o().completionSource||"openai"),model:J.model||Q0().model||"",temperature:typeof J.temperature==="number"?J.temperature:Q0().temperature??0.2,endpoint:J.endpoint,apiKey:J.apiKey}}let Q=o(),G=Q0();return{api:q0(Q.completionSource||"openai"),model:G.model||"",temperature:G.temperature??0.2}}function iG(Z){if(!Z||typeof Z!=="string")return null;let Q=Z.match(/\[ARC\s+(\d+)\]/i);if(Q)return parseInt(Q[1],10);if(Q=Z.match(/\[ARC\s+\[(\d+)\]\]/i),Q)return parseInt(Q[1],10);return null}function lG(Z){let Q=Object.values(Z?.entries||{}),G=0;for(let J of Q)if(J&&J.stmbArc===!0&&typeof J.comment==="string"){let W=iG(J.comment);if(typeof W==="number"&&W>G)G=W}return G+1}function oG(Z,Q,G){let J=String(Q||"").trim(),W=String(Z||"").trim()||"[ARC 000] - {{title}}";W=W.replace(/\{\{\s*title\s*\}\}/g,J);let q=W.match(/\[([^\]]*?)(0{2,})([^\]]*?)\]/);if(q){let Y=q[2].length,K=String(G).padStart(Y,"0"),X=`[${q[1]}${K}${q[3]}]`;return W.replace(q[0],X)}return`[ARC ${String(G).padStart(3,"0")}] ${J}`}async function cZ({lorebookName:Z,lorebookData:Q,arcCandidates:G,disableOriginals:J=!1}){if(!Z||!Q)throw Error(I6("Missing lorebookName or lorebookData","STMemoryBooks_ArcAnalysis_MissingLorebookData"));let W=[],q=Z7?.STMemoryBooks?.arcTitleFormat||"[ARC 000] - {{title}}",z=lG(Q);try{console.info("STMB ArcAnalysis: committing %d arc(s): %o",G.length,G.map((Y)=>Y.title))}catch{}for(let Y of G){let K=oG(q,Y.title,z++),X=Y.summary,V=Array.isArray(Y.keywords)?Y.keywords:[];if(V.length===0)try{let B=Y7(null);V=await dG(X,B)}catch(B){try{console.warn('STMB ArcAnalysis: keyword generation failed for "%s": %s',K,String(B?.message||B))}catch{}}let F={vectorized:!0,selective:!0,order:100,position:0},j={stmemorybooks:!0,stmbArc:!0,type:"arc",key:Array.isArray(V)?V:[],disable:!1},O=await M8(Z,Q,[{title:K,content:X,defaults:F,entryOverrides:j}],{refreshEditor:!1}),H=O&&O[0],A=H?H.uid:null;if(!A)throw Error(I6("Arc upsert returned no entry (commitArcs failed)","STMemoryBooks_ArcAnalysis_UpsertFailed"));if(J&&A){let B=new Set(Y.memberIds.map(String)),D=Object.values(Q.entries||{});for(let T of D)if(B.has(String(T.uid)))T.disable=!0,T.disabledByArcId=A}W.push({arcEntryId:A,title:K})}await M8(Z,Q,[],{refreshEditor:!0});try{console.info("STMB ArcAnalysis: committed arc IDs: %o",W.map((Y)=>Y.arcEntryId))}catch{}return{results:W}}import{Handlebars as nG}from"../../../../lib.js";var pZ=nG.compile(`
<table style="width: 100%; border-collapse: collapse;">
  <thead>
    <tr>
...
Return ONLY the JSON, no other text.`,STMemoryBooks_DisplayName_summary:"Summary - Detailed beat-by-beat summaries in narrative prose",STMemoryBooks_DisplayName_summarize:"Summarize - Bullet-point format",STMemoryBooks_DisplayName_synopsis:"Synopsis - Long and comprehensive (beats, interactions, details) with headings",STMemoryBooks_DisplayName_sumup:"Sum Up - Concise story beats in narrative prose",STMemoryBooks_DisplayName_minimal:"Minimal - Brief 1-2 sentence summary",STMemoryBooks_DisplayName_northgate:"Northgate - Intended for creative writing. By Northgate on ST Discord",STMemoryBooks_DisplayName_aelemar:"Aelemar - Focuses on plot points and character memories. By Aelemar on ST Discord",STMemoryBooks_DisplayName_comprehensive:"Comprehensive - Synopsis plus improved keywords extraction",STMemoryBooks_PromptManager_RecreateBuiltins:"♻️ Recreate Built-in Prompts",STMemoryBooks_RecreateBuiltinsTitle:"Recreate Built-in Prompts",STMemoryBooks_RecreateBuiltinsWarning:"This will remove overrides for all built‑in presets (summary, summarize, synopsis, sumup, minimal, northgate, aelemar, comprehensive). Any customizations to these built-ins will be lost. After this, built-ins will follow the current app locale.",STMemoryBooks_RecreateArcBuiltinsWarning:"This will remove overrides for all built‑in presets (multi-arc, single, tiny). Any customizations to these built-ins will be lost. After this, built-ins will follow the current app locale.",STMemoryBooks_RecreateBuiltinsDoesNotAffectCustom:"This does not affect your other custom presets.",STMemoryBooks_RecreateBuiltinsOverwrite:"Overwrite",STMemoryBooks_RegexSelection_Title:"\uD83D\uDCD0 Regex selection",STMemoryBooks_RegexSelection_Desc:"Selecting a regex here will run it REGARDLESS of whether it is enabled or disabled.",STMemoryBooks_RegexSelection_Outgoing:"Run regex before sending to AI",STMemoryBooks_RegexSelection_Incoming:"Run regex before adding to lorebook (before previews)",STMemoryBooks_RegexSelect_PlaceholderOutgoing:"Select outgoing regex…",STMemoryBooks_RegexSelect_PlaceholderIncoming:"Select incoming regex…",STMemoryBooks_RegexSelectionsSaved:"Regex selections saved",STMemoryBooks_FailedToSaveRegexSelections:"Failed to save regex selections",STMemoryBooks_UseRegexAdvanced:"Use regex (advanced)",STMemoryBooks_ConfigureRegex:"\uD83D\uDCD0 Configure regex…"},f1={en:sG};import{getRegexScripts as O7}from"../../../extensions/regex/engine.js";import"../../../../lib/select2.min.js";async function A7(Z){try{if(Z?.prompt&&String(Z.prompt).trim())return Z.prompt;if(Z?.preset)return await G1(Z.preset)}catch(Q){console.warn(U("STMemoryBooks: getEffectivePromptAsync fallback due to error:","index.warn.getEffectivePromptAsync"),Q)}return d0()}async function J$(){return String(q4())}function W5(){return N0}var j0="STMemoryBooks",X7=!1;var N7={moduleSettings:{alwaysUseDefault:!0,showMemoryPreviews:!1,showNotifications:!0,unhideBeforeMemory:!1,refreshEditor:!0,tokenWarningThreshold:50000,defaultMemoryCount:0,autoClearSceneAfterMemory:!1,manualModeEnabled:!1,allowSceneOverlap:!1,autoHideMode:"all",unhiddenEntriesCount:2,autoSummaryEnabled:!1,autoSummaryInterval:50,autoSummaryBuffer:2,autoCreateLorebook:!1,lorebookNameTemplate:"LTM - {{char}} - {{chat}}",useRegex:!1,selectedRegexOutgoing:[],selectedRegexIncoming:[]},titleFormat:"[000] - {{title}}",profiles:[],defaultProfile:0,migrationVersion:4},m=null,N0=!1,oZ=!1,C6=null,V7=!1,d8=null,m1=null,p1=null,u1=null,B1=null,d1=null;var O1=null,c8=null;function W$(Z){let Q=[];if(Z.matches&&Z.matches("#chat .mes[mesid]")){if(!Z.querySelector(".mes_stmb_start"))s8(Z),Q.push(Z)}else if(Z.querySelectorAll)Z.querySelectorAll("#chat .mes[mesid]").forEach((J)=>{if(!J.querySelector(".mes_stmb_start"))s8(J),Q.push(J)});return Q}function q$(){if(O1)O1.disconnect(),O1=null;let Z=document.getElementById("chat");if(!Z)throw Error(U("STMemoryBooks: Chat container not found. SillyTavern DOM structure may have changed.","index.error.chatContainerNotFound"));let Q=X4();if(!Q||Q.start===null&&Q.end===null)r8();O1=new MutationObserver((G)=>{let J=[];for(let W of G)for(let q of W.addedNodes)if(q.nodeType===Node.ELEMENT_NODE)try{let z=W$(q);J.push(...z)}catch(z){console.error(U("STMemoryBooks: Error processing new chat elements:","index.error.processingChatElements"),z)}if(J.length>0)clearTimeout(c8),c8=setTimeout(()=>{try{Y4(J)}catch(W){console.error(U("STMemoryBooks: Error updating button states:","index.error.updatingButtonStates"),W)}},b6.CHAT_OBSERVER_DEBOUNCE_MS)}),O1.observe(Z,{childList:!0,subtree:!0}),console.log(U("STMemoryBooks: Chat observer initialized","index.log.chatObserverInitialized"))}function Y$(){if(O1)O1.disconnect(),O1=null,console.log(U("STMemoryBooks: Chat observer disconnected","index.log.chatObserverDisconnected"));if(c8)clearTimeout(c8),c8=null}function z$(){console.log(U("STMemoryBooks: Chat changed - updating scene state","index.log.chatChanged")),r8(),D7(),setTimeout(()=>{try{_7()}catch(Z){console.error(U("STMemoryBooks: Error processing messages after chat change:","index.error.processingMessagesAfterChange"),Z)}},b6.CHAT_OBSERVER_DEBOUNCE_MS)}function D7(){let Z=f()||{},{sceneStart:Q,sceneEnd:G}=Z;if(Q!==null||G!==null){if(console.log(S`Found orphaned scene markers: start=${Q}, end=${G}`),!N0&&p[j0].moduleSettings.autoSummaryEnabled)t1()}}async function X$(){try{setTimeout(r1,E0.VALIDATION_DELAY_MS),await $5(),await EZ()}catch(Z){console.error(U("STMemoryBooks: Error in handleMessageReceived:","index.error.handleMessageReceived"),Z)}}async function V$(){try{setTimeout(r1,E0.VALIDATION_DELAY_MS),await J5(),await EZ()}catch(Z){console.error(U("STMemoryBooks: Error in handleGroupWrapperFinished:","index.error.handleGroupWrapperFinished"),Z)}}async function K$(Z,Q){if(!await I8())return console.error(U("STMemoryBooks: No scene markers set for createMemory command","index.error.noSceneMarkersForCreate")),toastr.error(U("No scene markers set. Use chevron buttons to mark start and end points first.","STMemoryBooks_NoSceneMarkersToastr"),U("STMemoryBooks","index.toast.title")),"";return P6(),""}async function j$(Z,Q){let G=String(Q||"").trim();if(!G)return toastr.error(U("Missing range argument. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_MissingRangeArgument"),U("STMemoryBooks","index.toast.title")),"";let J=G.match(/^(\d+)\s*[-–—]\s*(\d+)$/);if(!J)return toastr.error(U("Invalid format. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_InvalidFormat"),U("STMemoryBooks","index.toast.title")),"";let W=Number(J[1]),q=Number(J[2]);if(!Number.isFinite(W)||!Number.isFinite(q))return toastr.error(U("Invalid message IDs parsed. Use: /scenememory X-Y (e.g., /scenememory 10-15)","STMemoryBooks_InvalidMessageIDs"),U("STMemoryBooks","index.toast.title")),"";if(W>q)return toastr.error(U("Start message cannot be greater than end message","STMemoryBooks_StartGreaterThanEnd"),U("STMemoryBooks","index.toast.title")),"";let z=B7;if(W<0||q>=z.length)return toastr.error(S`Message IDs out of range. Valid range: 0-${z.length-1}`,U("STMemoryBooks","index.toast.title")),"";if(!z[W]||!z[q])return toastr.error(U("One or more specified messages do not exist","STMemoryBooks_MessagesDoNotExist"),U("STMemoryBooks","index.toast.title")),"";y6(W,q);let Y=Y8(),K=Y.isGroupChat?` in group "${Y.groupName}"`:"";return toastr.info(S`Scene set: messages ${W}-${q}${K}`,U("STMemoryBooks","index.toast.title")),P6(),""}async function F$(Z,Q){try{if(N0)return toastr.info(U("Memory creation is already in progress","STMemoryBooks_MemoryAlreadyInProgress"),U("STMemoryBooks","index.toast.title")),"";let G=await eZ();if(!G.valid)return toastr.error(U("No lorebook available: "+G.error,"STMemoryBooks_NoLorebookAvailable"),U("STMemoryBooks","index.toast.title")),"";let J=f()||{},W=B7.length-1;if(W<0)return toastr.info(U("There are no messages to summarize yet.","STMemoryBooks_NoMessagesToSummarize"),U("STMemoryBooks","index.toast.title")),"";let q=typeof J.highestMemoryProcessed==="number"?J.highestMemoryProcessed:null,z=q===null?0:q+1,Y=W;if(z>Y)return toastr.info(U("No new messages since the last memory.","STMemoryBooks_NoNewMessagesSinceLastMemory"),U("STMemoryBooks","index.toast.title")),"";y6(z,Y),await P6()}catch(G){console.error(U("STMemoryBooks: /nextmemory failed:","index.error.nextMemoryFailed"),G),toastr.error(U("Failed to run /nextmemory: "+G.message,"STMemoryBooks_NextMemoryFailed"),U("STMemoryBooks","index.toast.title"))}return""}async function U$(Z,Q){let G=String(Q||"").trim();if(!G)return toastr.info(U('SidePrompt guide: Type a template name after the space to see suggestions. Usage: /sideprompt "Name" [X-Y]. Quote names with spaces.',"STMemoryBooks_SidePromptGuide"),U("STMemoryBooks","index.toast.title")),"";let J=G.match(/^["']([^"']+)["']\s*(.*)$/)||G.match(/^(.+?)(\s+\d+\s*[-–—]\s*\d+)?$/),W=J?(J[1]||G).trim():G;try{let z=(await X1()).filter((Y)=>Y.name.toLowerCase().includes(W.toLowerCase()));if(z.length>1){let Y=z.slice(0,5).map((X)=>X.name).join(", "),K=z.length>5?`, +${z.length-5} more`:"";return toastr.info(S`Multiple matches: ${Y}${K}. Refine the name or use quotes. Usage: /sideprompt "Name" [X-Y]`,U("STMemoryBooks","index.toast.title")),""}return yZ(G)}catch{return yZ(G)}}async function T7(Z,Q,G){let J=String(Q||"").trim();if(!J)return toastr.error(U(G?'Missing name. Use: /sideprompt-on "Name" OR /sideprompt-on all':'Missing name. Use: /sideprompt-off "Name" OR /sideprompt-off all',"STMemoryBooks_SidePromptToggle_MissingName"),U("STMemoryBooks","index.toast.title")),"";try{let{findTemplateByName:W,upsertTemplate:q,listTemplates:z}=await Promise.resolve().then(() => (S8(),h5));if(J.toLowerCase()==="all"){let K=await z(),X=0;for(let V of K)if(V.enabled!==G)await q({key:V.key,enabled:G}),X++;try{window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated"))}catch(V){}return toastr.success(S`${G?"Enabled":"Disabled"} ${X} side prompt${X===1?"":"s"}`,U("STMemoryBooks","index.toast.title")),""}let Y=await W(J);if(!Y)return toastr.error(S`Side Prompt not found: ${J}`,U("STMemoryBooks","index.toast.title")),"";if(Y.enabled===G)return toastr.info(S`"${Y.name}" is already ${G?"enabled":"disabled"}`,U("STMemoryBooks","index.toast.title")),"";await q({key:Y.key,enabled:G});try{window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated"))}catch(K){}toastr.success(S`${G?"Enabled":"Disabled"} "${Y.name}"`,U("STMemoryBooks","index.toast.title"))}catch(W){console.error("STMemoryBooks: sideprompt enable/disable failed:",W),toastr.error(S`Failed to toggle side prompt: ${W.message}`,U("STMemoryBooks","index.toast.title"))}return""}async function H$(Z,Q){return T7(Z,Q,!0)}async function B$(Z,Q){return T7(Z,Q,!1)}var R7=[];async function tZ(){try{R7=(await X1()||[]).filter((Q)=>{let G=Q?.triggers?.commands;if(!("commands"in(Q?.triggers||{})))return!0;return Array.isArray(G)&&G.some((J)=>String(J).toLowerCase()==="sideprompt")}).map((Q)=>Q.name)}catch(Z){console.warn(U("STMemoryBooks: side prompt cache refresh failed","index.warn.sidePromptCacheRefreshFailed"),Z)}}window.addEventListener("stmb-sideprompts-updated",tZ);try{tZ()}catch(Z){}var nZ=()=>R7.map((Z)=>new rZ(Z));function C0(){if(p.STMemoryBooks=p.STMemoryBooks||q8(N7),(p.STMemoryBooks.migrationVersion??1)<4){if(!p.STMemoryBooks.profiles?.some((W)=>W?.isBuiltinCurrentST||W?.useDynamicSTSettings||W?.connection?.api==="current_st"&&W?.name==="Current SillyTavern Settings")){if(!p.STMemoryBooks.profiles)p.STMemoryBooks.profiles=[];let W={name:"Current SillyTavern Settings",isBuiltinCurrentST:!0,connection:{api:"current_st"},preset:"summary",constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0};if(p.STMemoryBooks.profiles.unshift(W),p.STMemoryBooks.defaultProfile!==void 0)p.STMemoryBooks.defaultProfile+=1;console.log(S`${j0}: Added dynamic profile for existing installation (migration to v3)`)}p.STMemoryBooks.profiles.forEach((W)=>{if(W.useDynamicSTSettings&&W.titleFormat)delete W.titleFormat,console.log(S`${j0}: Removed static titleFormat from dynamic profile`)}),p.STMemoryBooks.migrationVersion=4,s()}if(!p.STMemoryBooks.profiles||p.STMemoryBooks.profiles.length===0){let J={name:"Current SillyTavern Settings",isBuiltinCurrentST:!0,connection:{api:"current_st"},preset:"summary",constVectMode:"link",position:0,orderMode:"auto",orderValue:100,preventRecursion:!1,delayUntilRecursion:!0};p.STMemoryBooks.profiles=[J],console.log(S`${j0}: Created dynamic profile for fresh installation`)}let Q=O$(p.STMemoryBooks),G=FZ(p.STMemoryBooks);if(G.fixes.length>0)console.log(S`${j0}: Applied profile fixes:`,G.fixes),s();return Q}function O$(Z){if(!Z.profiles||Z.profiles.length===0)Z.profiles=[],Z.defaultProfile=0;if(Z.defaultProfile>=Z.profiles.length)Z.defaultProfile=0;if(!Z.moduleSettings)Z.moduleSettings=q8(N7.moduleSettings);if(!Z.moduleSettings.tokenWarningThreshold||Z.moduleSettings.tokenWarningThreshold<1000)Z.moduleSettings.tokenWarningThreshold=30000;if(Z.moduleSettings.defaultMemoryCount=K0(Z.moduleSettings.defaultMemoryCount??0,0,7),Z.moduleSettings.unhiddenEntriesCount===void 0||Z.moduleSettings.unhiddenEntriesCount===null)Z.moduleSettings.unhiddenEntriesCount=2;if(Z.moduleSettings.autoSummaryEnabled===void 0)Z.moduleSettings.autoSummaryEnabled=!1;if(Z.moduleSettings.autoSummaryInterval===void 0||Z.moduleSettings.autoSummaryInterval<10)Z.moduleSettings.autoSummaryInterval=100;if(Z.moduleSettings.autoSummaryBuffer=K0(Z.moduleSettings.autoSummaryBuffer??0,0,50),Z.moduleSettings.autoCreateLorebook===void 0)Z.moduleSettings.autoCreateLorebook=!1;if(Z.moduleSettings.unhideBeforeMemory===void 0)Z.moduleSettings.unhideBeforeMemory=!1;if(!Z.moduleSettings.lorebookNameTemplate)Z.moduleSettings.lorebookNameTemplate="LTM - {{char}} - {{chat}}";if(Z.moduleSettings.manualModeEnabled&&Z.moduleSettings.autoCreateLorebook)Z.moduleSettings.autoCreateLorebook=!1,console.warn(U("STMemoryBooks: Both manualModeEnabled and autoCreateLorebook were true - setting autoCreateLorebook to false","index.warn.mutualExclusion"));if(!Z.migrationVersion||Z.migrationVersion<2)console.log(S`${j0}: Migrating to JSON-based architecture (v2)`),Z.migrationVersion=2,Z.profiles.forEach((Q)=>{if(Q.prompt&&Q.prompt.includes("createMemory"))console.log(S`${j0}: Updating profile "${Q.name}" to use JSON output`),Q.prompt=d0()});return Z}async function eZ(Z=!1){let Q=p.STMemoryBooks,G=await z8();if(!Z){if(!G&&Q?.moduleSettings?.autoCreateLorebook&&!Q?.moduleSettings?.manualModeEnabled){let J=Q.moduleSettings.lorebookNameTemplate||"LTM - {{char}} - {{chat}}",W=await j6(J,"chat");if(W.success)G=W.name;else return{valid:!1,error:W.error}}}if(!G)return{valid:!1,error:"No lorebook available or selected."};if(!h6||!h6.includes(G))return{valid:!1,error:`Selected lorebook "${G}" not found.`};try{let J=await tG(G);return{valid:!!J,data:J,name:G}}catch(J){return{valid:!1,error:"Failed to load the selected lorebook."}}}async function A$(Z,Q,G=null){let J=C0(),W=J.moduleSettings.tokenWarningThreshold??30000,q=!J.moduleSettings.alwaysUseDefault||Z.estimatedTokens>W,z=null;if(q){let X=G!==null?G:J.defaultProfile;if(z=await D5(Z,J,Q0(),o(),c1,X),!z.confirmed)return null}else{let X=J.profiles[J.defaultProfile];z={confirmed:!0,profileSettings:{...X,effectivePrompt:await A7(X)},advancedOptions:{memoryCount:K0(J.moduleSettings.defaultMemoryCount??0,0,7),overrideSettings:!1}}}let{profileSettings:Y,advancedOptions:K}=z;if(Y?.connection?.api==="current_st"||K.overrideSettings){let X=o(),V=Q0();if(Y.effectiveConnection={api:X.completionSource||"openai",model:V.model||"",temperature:V.temperature??0.7},Y.useDynamicSTSettings)console.log("STMemoryBooks: Using dynamic ST settings profile - current settings:",Y.effectiveConnection);else console.log("STMemoryBooks: Using current SillyTavern settings override for memory creation")}else Y.effectiveConnection={...Y.connection},console.log("STMemoryBooks: Using profile connection settings for memory creation");return{profileSettings:Y,summaryCount:K.memoryCount??0,tokenThreshold:W,settings:J}}function N$(Z){if(Z&&Z.name==="AIResponseError"){if(typeof Z.recoverable==="boolean")return Z.recoverable;if(Z.code&&String(Z.code).toUpperCase().includes("TRUNCATION"))return!0}if(["TokenWarningError","InvalidProfileError"].includes(Z?.name))return!1;if(Z?.message&&(Z.message.includes("Scene compilation failed")||Z.message.includes("Invalid memory result")||Z.message.includes("Invalid lorebook")))return!1;return!0}async function aZ(Z,Q,G,J=0){let{profileSettings:W,summaryCount:q,tokenThreshold:z,settings:Y}=G;C6=W;let K=null,X=null,V=null;try{if(Y?.moduleSettings?.convertExistingRecursion&&Q?.valid&&Q.data?.entries){let j=U8(Q.data)||[],O=j.length>0?j[0].entry:null,H=!!W.preventRecursion,A=!!W.delayUntilRecursion,B=!1;if(!O)B=!1;else{let D=!!O.preventRecursion,T=!!O.delayUntilRecursion;B=D!==H||T!==A}if(B){let D=0,T=0,L=Object.values(Q.data.entries||{});for(let P of L)if(P&&P.stmemorybooks===!0){D++;let x=P.preventRecursion!==H,w=P.delayUntilRecursion!==A;if(x||w)P.preventRecursion=H,P.delayUntilRecursion=A,T++}if(T>0){try{if(await eG(Q.name,Q.data,!0),Y.moduleSettings?.refreshEditor)try{Z$(Q.name)}catch(P){}}catch(P){console.warn("STMemoryBooks: Failed to save lorebook during recursion conversion:",P)}try{toastr.info(S`Updated recursion flags on ${T} of ${D} memory entr${T===1?"y":"ies"}`,"STMemoryBooks")}catch(P){}}}}}catch(j){console.warn("STMemoryBooks: convertExistingRecursion check failed:",j)}let F=i8.MAX_RETRIES;try{let j=Q8(Z.sceneStart,Z.sceneEnd);K=Z8(j);let O=C4(K);if(!O.valid)throw Error(`Scene compilation failed: ${O.errors.join(", ")}`);let H=[];if(X={summaries:[],actualCount:0,requestedCount:0},q>0)if(X=await x1(q,Y,c1),H=X.summaries,X.actualCount>0){if(X.actualCount<X.requestedCount)toastr.warning(S`Only ${X.actualCount} of ${X.requestedCount} requested memories available`,"STMemoryBooks");console.log(`STMemoryBooks: Including ${X.actualCount} previous memories as context`)}else toastr.warning(U("No previous memories found in lorebook","STMemoryBooks_NoPreviousMemoriesFound"),"STMemoryBooks");let A;if(J>0)A=`Retrying memory creation (attempt ${J+1}/${F+1})...`;else A=X.actualCount>0?`Creating memory with ${X.actualCount} context memories...`:"Creating memory...";toastr.info(S`${A}`,"STMemoryBooks",{timeOut:0}),K.previousSummariesContext=H,V=await w4(K);let B=V?.estimatedTokens,D=await n4(K,W,{tokenWarningThreshold:z}),T=D;if(Y.moduleSettings.showMemoryPreviews){toastr.clear();let w=await O8(D,Z,W);if(w.action==="cancel")return;else if(w.action==="retry"){let h=J>=F?J-F:0;if(h>=3)return toastr.warning(S`Maximum retry attempts (${3}) reached`,"STMemoryBooks"),{action:"cancel"};toastr.info(S`Retrying memory generation (${h+1}/${3})...`,"STMemoryBooks");let u=Math.max(J+1,F+h+1);return await aZ(Z,Q,G,u)}if(w.action==="accept")T=D;else if(w.action==="edit"){if(!w.memoryData){console.error("STMemoryBooks: Edit action missing memoryData"),toastr.error(U("Unable to retrieve edited memory data","STMemoryBooks_UnableToRetrieveEditedMemoryData"),"STMemoryBooks");return}if(!w.memoryData.extractedTitle||!w.memoryData.content){console.error("STMemoryBooks: Edited memory data missing required fields"),toastr.error(U("Edited memory data is incomplete","STMemoryBooks_EditedMemoryDataIncomplete"),"STMemoryBooks");return}T=w.memoryData}else console.warn(`STMemoryBooks: Unexpected preview action: ${w.action}`),T=D}let L=await zZ(T,Q);if(!L.success)throw Error(L.error||"Failed to add memory to lorebook");try{let w=W?.effectiveConnection||W?.connection||{};console.debug("STMemoryBooks: Passing profile to runAfterMemory",{api:w.api,model:w.model,temperature:w.temperature}),await bZ(K,W)}catch(w){console.warn("STMemoryBooks: runAfterMemory failed:",w)}try{let w=f()||{};w.highestMemoryProcessed=Z.sceneEnd,Z0()}catch(w){console.warn("STMemoryBooks: Failed to update highestMemoryProcessed baseline:",w)}KZ();let P=X.actualCount>0?` (with ${X.actualCount} context ${X.actualCount===1?"memory":"memories"})`:"";toastr.clear(),m1=null,d8=null,p1=null;let x=J>0?` (succeeded on attempt ${J+1})`:"";toastr.success(S`Memory "${L.entryTitle}" created successfully${P}${x}!`,"STMemoryBooks")}catch(j){if(console.error("STMemoryBooks: Error creating memory:",j),J<F&&N$(j))return toastr.warning(S`Memory creation failed (attempt ${J+1}). Retrying in ${Math.round(i8.RETRY_DELAY_MS/1000)} seconds...`,"STMemoryBooks",{timeOut:3000}),await new Promise((B)=>setTimeout(B,i8.RETRY_DELAY_MS)),await aZ(Z,Q,G,J+1);let H=J>0?` (failed after ${J+1} attempts)`:"",A=j&&j.code?` [${j.code}]`:"";if(j.name==="TokenWarningError")toastr.error(S`Scene is too large (${j.tokenCount} tokens). Try selecting a smaller range${H}.`,"STMemoryBooks",{timeOut:8000});else if(j.name==="AIResponseError"){try{toastr.clear(m1)}catch(B){}d8=j,p1={sceneData:Z,compiledScene:K,profileSettings:W,lorebookValidation:Q,memoryFetchResult:X,sceneStats:V,settings:Y,summaryCount:q,tokenThreshold:z,sceneRange:K?.metadata?.sceneStart!==void 0?`${K.metadata.sceneStart}-${K.metadata.sceneEnd}`:`${Z.sceneStart}-${Z.sceneEnd}`},m1=toastr.error(S`AI failed to generate valid memory${A}: ${j.message}${H}`,"STMemoryBooks",{timeOut:0,extendedTimeOut:0,closeButton:!0,tapToDismiss:!1,onclick:()=>{try{u$(d8)}catch(B){console.error(B)}}})}else if(j.name==="InvalidProfileError")toastr.error(S`Profile configuration error: ${j.message}${H}`,"STMemoryBooks",{timeOut:8000});else toastr.error(S`Failed to create memory: ${j.message}${H}`,"STMemoryBooks")}}async function P6(Z=null){let Q=Y8();if(!Q.isGroupChat){if(!iZ||iZ.length===0||!iZ[rG]){toastr.error(U("SillyTavern is still loading character data, please wait a few seconds and try again.","STMemoryBooks_LoadingCharacterData"),"STMemoryBooks");return}}else if(!Q.groupId||!Q.groupName){toastr.error(U("Group chat data not available, please wait a few seconds and try again.","STMemoryBooks_GroupChatDataUnavailable"),"STMemoryBooks");return}if(N0)return;N0=!0;try{let G=C0();if(G?.moduleSettings?.unhideBeforeMemory){let X=f()||{};if(X.sceneStart!==null&&X.sceneEnd!==null)try{await aG(`/unhide ${X.sceneStart}-${X.sceneEnd}`)}catch(V){console.warn("STMemoryBooks: /unhide command failed or unavailable:",V)}}let J=await I8();if(!J){console.error("STMemoryBooks: No scene selected for memory initiation"),toastr.error(U("No scene selected","STMemoryBooks_NoSceneSelected"),"STMemoryBooks"),N0=!1;return}let W=await eZ();if(!W.valid){console.error("STMemoryBooks: Lorebook validation failed:",W.error),toastr.error(U(W.error,"STMemoryBooks_LorebookValidationError"),"STMemoryBooks"),N0=!1;return}let q=U8(W.data),z=J.sceneStart,Y=J.sceneEnd;if(!G.moduleSettings.allowSceneOverlap)for(let X of q){let V=e4(X.entry);if(V&&V.start!==null&&V.end!==null){let F=Number(V.start),j=Number(V.end),O=Number(z),H=Number(Y);if(console.debug(`STMemoryBooks: OverlapCheck new=[${O}-${H}] existing="${X.title}" [${F}-${j}] cond1(ns<=e)=${O<=j} cond2(ne>=s)=${H>=F}`),O<=j&&H>=F){console.error(`STMemoryBooks: Scene overlap detected with memory: ${X.title} [${F}-${j}] vs new [${O}-${H}]`),toastr.error(S`Scene overlaps with existing memory: "${X.title}" (messages ${F}-${j})`,"STMemoryBooks"),N0=!1;return}}}let K=await A$(J,W,Z);if(!K){N0=!1;return}if(m)m.completeCancelled(),m=null;await aZ(J,W,K)}catch(G){console.error("STMemoryBooks: Critical error during memory initiation:",G),toastr.error(S`An unexpected error occurred: ${G.message}`,"STMemoryBooks")}finally{N0=!1}}function M6(Z){if(Z.autoHideMode)return Z.autoHideMode;if(Z.autoHideAllMessages)return"all";else if(Z.autoHideLastMemory)return"last";else return"none"}function K7(){let Z=p.STMemoryBooks;if(!Z)return;let Q=f()||{},G=Z.moduleSettings.manualModeEnabled,J=document.querySelector("#stmb-mode-badge");if(J)J.textContent=G?U("Manual","STMemoryBooks_Manual"):U("Automatic (Chat-bound)","STMemoryBooks_AutomaticChatBound");let W=document.querySelector("#stmb-active-lorebook");if(W){let V=G?Q.manualLorebook:c1?.[p8];W.textContent=V||U("None selected","STMemoryBooks_NoneSelected"),W.className=V?"":"opacity50p"}let q=document.querySelector("#stmb-manual-controls");if(q)q.style.display=G?"block":"none";let z=document.querySelector("#stmb-automatic-info");if(z){z.style.display=G?"none":"block";let V=z.querySelector("small");if(V){let F=c1?.[p8]??null;V.innerHTML=F?S`Using chat-bound lorebook "<strong>${F}</strong>"`:U("No chat-bound lorebook. Memories will require lorebook selection.","STMemoryBooks_NoChatBoundLorebook")}}let Y=document.querySelector("#stmb-auto-create-lorebook"),K=document.querySelector("#stmb-manual-mode-enabled"),X=document.querySelector("#stmb-lorebook-name-template");if(Y&&K){let V=Z.moduleSettings.autoCreateLorebook;if(Y.disabled=G,K.disabled=V,X)X.disabled=!V}}function v6(){if(!m?.dlg)return;let Z=C0(),Q=f()||{},G=m.content.querySelector("#stmb-manual-lorebook-buttons"),J=m.content.querySelector("#stmb-profile-buttons"),W=m.content.querySelector("#stmb-extra-function-buttons"),q=m.content.querySelector("#stmb-prompt-manager-buttons");if(G&&Z.moduleSettings.manualModeEnabled){let X=Q.manualLorebook??null,V=[{text:`\uD83D\uDCD5 ${X?U("Change","STMemoryBooks_ChangeManualLorebook"):U("Select","STMemoryBooks_SelectManualLorebook")} `+U("Manual Lorebook","STMemoryBooks_ManualLorebook"),id:"stmb-select-manual-lorebook",action:async()=>{try{if(await _1(X?Q.manualLorebook:null))Q1()}catch(F){console.error("STMemoryBooks: Error selecting manual lorebook:",F),toastr.error(U("Failed to select manual lorebook","STMemoryBooks_FailedToSelectManualLorebook"),"STMemoryBooks")}}}];if(X)V.push({text:"❌ "+U("Clear Manual Lorebook","STMemoryBooks_ClearManualLorebook"),id:"stmb-clear-manual-lorebook",action:()=>{try{let F=f()||{};delete F.manualLorebook,Z0(),Q1(),toastr.success(U("Manual lorebook cleared","STMemoryBooks_ManualLorebookCleared"),"STMemoryBooks")}catch(F){console.error("STMemoryBooks: Error clearing manual lorebook:",F),toastr.error(U("Failed to clear manual lorebook","STMemoryBooks_FailedToClearManualLorebook"),"STMemoryBooks")}}});G.innerHTML="",V.forEach((F)=>{let j=document.createElement("div");j.className="menu_button interactable whitespacenowrap",j.id=F.id,j.textContent=F.text,j.addEventListener("click",F.action),G.appendChild(j)})}if(!J||!W)return;let z=[{text:"⭐ "+U("Set as Default","STMemoryBooks_SetAsDefault"),id:"stmb-set-default-profile",action:()=>{let X=m?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let V=K0(J0(X,Z.defaultProfile??0),0,Z.profiles.length-1);if(V===Z.defaultProfile)return;Z.defaultProfile=V,s();let F=Z.profiles[V]?.isBuiltinCurrentST?U("Current SillyTavern Settings","STMemoryBooks_Profile_CurrentST"):Z.profiles[V].name;toastr.success(S`"${F}" is now the default profile.`,"STMemoryBooks"),Q1()}},{text:"✏️ "+U("Edit Profile","STMemoryBooks_EditProfile"),id:"stmb-edit-profile",action:async()=>{try{let X=m?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let V=K0(J0(X,Z.defaultProfile??0),0,Z.profiles.length-1),F=Z.profiles[V];if(F.useDynamicSTSettings)F.connection=F.connection||{},F.connection.api="current_st",delete F.useDynamicSTSettings,s();await X5(Z,V,Q1)}catch(X){console.error(`${j0}: Error in edit profile:`,X),toastr.error(U("Failed to edit profile","STMemoryBooks_FailedToEditProfile"),"STMemoryBooks")}}},{text:"➕ "+U("New Profile","STMemoryBooks_NewProfile"),id:"stmb-new-profile",action:async()=>{try{await V5(Z,Q1)}catch(X){console.error(`${j0}: Error in new profile:`,X),toastr.error(U("Failed to create profile","STMemoryBooks_FailedToCreateProfile"),"STMemoryBooks")}}},{text:"\uD83D\uDDD1️ "+U("Delete Profile","STMemoryBooks_DeleteProfile"),id:"stmb-delete-profile",action:async()=>{try{let X=m?.dlg?.querySelector("#stmb-profile-select");if(!X)return;let V=J0(X,Z.defaultProfile??0);await K5(Z,V,Q1)}catch(X){console.error(`${j0}: Error in delete profile:`,X),toastr.error(U("Failed to delete profile","STMemoryBooks_FailedToDeleteProfile"),"STMemoryBooks")}}}],Y=[{text:"\uD83D\uDCE4 "+U("Export Profiles","STMemoryBooks_ExportProfiles"),id:"stmb-export-profiles",action:()=>{try{j5(Z)}catch(X){console.error(`${j0}: Error in export profiles:`,X),toastr.error(U("Failed to export profiles","STMemoryBooks_FailedToExportProfiles"),"STMemoryBooks")}}},{text:"\uD83D\uDCE5 "+U("Import Profiles","STMemoryBooks_ImportProfiles"),id:"stmb-import-profiles",action:()=>{let X=m?.dlg?.querySelector("#stmb-import-file");if(X)X.click()}}],K=[{text:"\uD83E\uDDE9 "+U("Summary Prompt Manager","STMemoryBooks_SummaryPromptManager"),id:"stmb-prompt-manager",action:async()=>{try{await l1()}catch(X){console.error(`${j0}: Error opening prompt manager:`,X),toastr.error(U("Failed to open Summary Prompt Manager","STMemoryBooks_FailedToOpenSummaryPromptManager"),"STMemoryBooks")}}},{text:"\uD83E\uDDF1 "+U("Arc Prompt Manager","STMemoryBooks_ArcPromptManager"),id:"stmb-arc-prompt-manager",action:async()=>{try{await o1()}catch(X){console.error(`${j0}: Error opening Arc Prompt Manager:`,X),toastr.error(U("Failed to open Arc Prompt Manager","STMemoryBooks_FailedToOpenArcPromptManager"),"STMemoryBooks")}}},{text:"\uD83C\uDFA1 "+U("Trackers & Side Prompts","STMemoryBooks_SidePrompts"),id:"stmb-side-prompts",action:async()=>{try{await k5()}catch(X){console.error(`${j0}: Error opening Trackers & Side Prompts Manager:`,X),toastr.error(U("Failed to open Trackers & Side Prompts Manager","STMemoryBooks_FailedToOpenSidePrompts"),"STMemoryBooks")}}}];J.innerHTML="",W.innerHTML="",q.innerHTML="",z.forEach((X)=>{let V=document.createElement("div");V.className="menu_button interactable whitespacenowrap",V.id=X.id,V.textContent=X.text,V.addEventListener("click",X.action),J.appendChild(V)}),Y.forEach((X)=>{let V=document.createElement("div");V.className="menu_button interactable whitespacenowrap",V.id=X.id,V.textContent=X.text,V.addEventListener("click",X.action),W.appendChild(V)}),K.forEach((X)=>{let V=document.createElement("div");V.className="menu_button interactable whitespacenowrap",V.id=X.id,V.textContent=X.text,V.addEventListener("click",X.action),q.appendChild(V)})}async function l1(){try{let Z=p.STMemoryBooks;await J8(Z);let Q=await T1(),G='<h3 data-i18n="STMemoryBooks_PromptManager_Title">\uD83E\uDDE9 Summary Prompt Manager</h3>';G+='<div class="world_entry_form_control">',G+='<p data-i18n="STMemoryBooks_PromptManager_Desc">Manage your summary generation prompts. All presets are editable.</p>',G+="</div>",G+='<div class="world_entry_form_control">',G+='<input type="text" id="stmb-prompt-search" class="text_pole" placeholder="Search presets..." aria-label="Search presets" data-i18n="[placeholder]STMemoryBooks_PromptManager_Search;[aria-label]STMemoryBooks_PromptManager_Search" />',G+="</div>",G+='<div id="stmb-preset-list" class="padding10 marginBot10" style="max-height: 400px; overflow-y: auto;"></div>',G+='<div class="buttons_block justifyCenter gap10px whitespacenowrap">',G+='<button id="stmb-pm-new" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_New">➕ New Preset</button>',G+='<button id="stmb-pm-export" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_Export">\uD83D\uDCE4 Export JSON</button>',G+='<button id="stmb-pm-import" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_Import">\uD83D\uDCE5 Import JSON</button>',G+='<button id="stmb-pm-recreate-builtins" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_PromptManager_RecreateBuiltins">♻️ Recreate Built-in Prompts</button>',G+='<button id="stmb-pm-apply" class="menu_button whitespacenowrap" disabled data-i18n="STMemoryBooks_PromptManager_ApplyToProfile">✅ Apply to Selected Profile</button>',G+="</div>",G+=`<small>${U(`\uD83D\uDCA1 When creating a new prompt, copy one of the other built-in prompts and then amend it. Don't change the "respond with JSON" instructions, \uD83D\uDCD5Memory Books uses that to process the returned result from the AI.`,"STMemoryBooks_PromptManager_Hint")}</small>`,G+='<input type="file" id="stmb-pm-import-file" accept=".json" style="display: none;" />';let J=new $0(G,r.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:!1,cancelButton:U("Close","STMemoryBooks_Close")});D$(J);let W=J.dlg?.querySelector("#stmb-preset-list");if(W){let q=(Q||[]).map((z)=>({key:String(z.key||""),displayName:String(z.displayName||"")}));W.innerHTML=i1.sanitize(pZ({items:q}))}await J.show()}catch(Z){console.error("STMemoryBooks: Error showing prompt manager:",Z),toastr.error(U("Failed to open Summary Prompt Manager","STMemoryBooks_FailedToOpenSummaryPromptManager"),"STMemoryBooks")}}function D$(Z){let Q=Z.dlg,G=null;Q.addEventListener("click",async(W)=>{let q=W.target.closest(".stmb-action");if(q){W.preventDefault(),W.stopPropagation();let Y=q.closest("tr[data-preset-key]"),K=Y?.dataset.presetKey;if(!K)return;if(Q.querySelectorAll("tr[data-preset-key]").forEach((V)=>{V.classList.remove("ui-state-active"),V.style.backgroundColor="",V.style.border=""}),Y)Y.style.backgroundColor="var(--cobalt30a)",Y.style.border="",G=K;let X=Q.querySelector("#stmb-pm-apply");if(X)X.disabled=!1;if(q.classList.contains("stmb-action-edit"))await j7(Z,K);else if(q.classList.contains("stmb-action-duplicate"))await F7(Z,K);else if(q.classList.contains("stmb-action-delete"))await U7(Z,K);return}let z=W.target.closest("tr[data-preset-key]");if(z){Q.querySelectorAll("tr[data-preset-key]").forEach((K)=>{K.classList.remove("ui-state-active"),K.style.backgroundColor="",K.style.border=""}),z.style.backgroundColor="var(--cobalt30a)",z.style.border="",G=z.dataset.presetKey;let Y=Q.querySelector("#stmb-pm-apply");if(Y)Y.disabled=!1}});let J=Q.querySelector("#stmb-prompt-search");if(J)J.addEventListener("input",(W)=>{let q=W.target.value.toLowerCase();Q.querySelectorAll("tr[data-preset-key]").forEach((z)=>{let Y=z.querySelector("td:first-child").textContent.toLowerCase();z.style.display=Y.includes(q)?"":"none"})});Q.querySelector("#stmb-pm-new")?.addEventListener("click",async()=>{await T$(Z)}),Q.querySelector("#stmb-pm-edit")?.addEventListener("click",async()=>{if(G)await j7(Z,G)}),Q.querySelector("#stmb-pm-duplicate")?.addEventListener("click",async()=>{if(G)await F7(Z,G)}),Q.querySelector("#stmb-pm-delete")?.addEventListener("click",async()=>{if(G)await U7(Z,G)}),Q.querySelector("#stmb-pm-export")?.addEventListener("click",async()=>{await R$()}),Q.querySelector("#stmb-pm-import")?.addEventListener("click",()=>{Q.querySelector("#stmb-pm-import-file")?.click()}),Q.querySelector("#stmb-pm-import-file")?.addEventListener("change",async(W)=>{await _$(W,Z)}),Q.querySelector("#stmb-pm-recreate-builtins")?.addEventListener("click",async()=>{try{let W=`
            ...
            `;if(await new $0(W,r.CONFIRM,"",{okButton:U("Overwrite","STMemoryBooks_RecreateBuiltinsOverwrite"),cancelButton:U("Cancel","STMemoryBooks_Cancel")}).show()===i.AFFIRMATIVE){let Y=await A4("overwrite");try{window.dispatchEvent(new CustomEvent("stmb-presets-updated"))}catch(K){}toastr.success(S`Removed ${Y?.removed||0} built-in overrides`,U("STMemoryBooks","index.toast.title")),Z.completeAffirmative(),await l1()}}catch(W){console.error("STMemoryBooks: Error recreating built-in prompts:",W),toastr.error(U("Failed to recreate built-in prompts","STMemoryBooks_FailedToRecreateBuiltins"),U("STMemoryBooks","index.toast.title"))}}),Q.querySelector("#stmb-pm-apply")?.addEventListener("click",async()=>{if(!G){toastr.error(U("Select a preset first","STMemoryBooks_SelectPresetFirst"),"STMemoryBooks");return}let W=p?.STMemoryBooks;if(!W||!Array.isArray(W.profiles)||W.profiles.length===0){toastr.error(U("No profiles available","STMemoryBooks_NoProfilesAvailable"),"STMemoryBooks");return}let q=W.defaultProfile??0;if(m?.dlg){let Y=m.dlg.querySelector("#stmb-profile-select");if(Y)q=J0(Y,W.defaultProfile??0)}let z=W.profiles[q];if(!z){toastr.error(U("Selected profile not found","STMemoryBooks_SelectedProfileNotFound"),"STMemoryBooks");return}if(z.prompt&&z.prompt.trim())if(await new $0('<h3 data-i18n="STMemoryBooks_ClearCustomPromptTitle">Clear Custom Prompt?</h3><p data-i18n="STMemoryBooks_ClearCustomPromptDesc">This profile has a custom prompt. Clear it so the selected preset is used?</p>',r.CONFIRM,"",{okButton:U("Clear and Apply","STMemoryBooks_ClearAndApply"),cancelButton:U("Cancel","STMemoryBooks_Cancel")}).show()===i.AFFIRMATIVE)z.prompt="";else return;if(z.preset=G,s(),toastr.success(U("Preset applied to profile","STMemoryBooks_PresetAppliedToProfile"),"STMemoryBooks"),m?.dlg)try{Q1()}catch(Y){}})}async function T$(Z){let G=new $0(`
    ...
    `,r.TEXT,"",{okButton:U("Create","STMemoryBooks_Create"),cancelButton:U("Cancel","STMemoryBooks_Cancel")});if(await G.show()===i.AFFIRMATIVE){let W=G.dlg.querySelector("#stmb-pm-new-display-name").value.trim(),q=G.dlg.querySelector("#stmb-pm-new-prompt").value.trim();if(!q){toastr.error(U("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),"STMemoryBooks");return}try{await w8(null,q,W||null),toastr.success(U("Preset created successfully","STMemoryBooks_PresetCreatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-presets-updated")),Z.completeAffirmative(),await l1()}catch(z){console.error("STMemoryBooks: Error creating preset:",z),toastr.error(U("Failed to create preset","STMemoryBooks_FailedToCreatePreset"),"STMemoryBooks")}}}async function j7(Z,Q){try{let G=await m6(Q),J=await G1(Q),W=`
        ...
        `,q=new $0(W,r.TEXT,"",{okButton:U("Save","STMemoryBooks_Save"),cancelButton:U("Cancel","STMemoryBooks_Cancel")});if(await q.show()===i.AFFIRMATIVE){let Y=q.dlg.querySelector("#stmb-pm-edit-display-name").value.trim(),K=q.dlg.querySelector("#stmb-pm-edit-prompt").value.trim();if(!K){toastr.error(U("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),"STMemoryBooks");return}await w8(Q,K,Y||null),toastr.success(U("Preset updated successfully","STMemoryBooks_PresetUpdatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-presets-updated")),Z.completeAffirmative(),await l1()}}catch(G){console.error("STMemoryBooks: Error editing preset:",G),toastr.error(U("Failed to edit preset","STMemoryBooks_FailedToEditPreset"),"STMemoryBooks")}}async function F7(Z,Q){try{let G=await U4(Q);toastr.success(U("Preset duplicated successfully","STMemoryBooks_PresetDuplicatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-presets-updated")),Z.completeAffirmative(),await l1()}catch(G){console.error("STMemoryBooks: Error duplicating preset:",G),toastr.error(U("Failed to duplicate preset","STMemoryBooks_FailedToDuplicatePreset"),"STMemoryBooks")}}async function U7(Z,Q){let G=await m6(Q),J=new $0(`<h3 data-i18n="STMemoryBooks_DeletePresetTitle">Delete Preset</h3><p>${b(U('Are you sure you want to delete "{{name}}"?',"STMemoryBooks_DeletePresetConfirm",{name:G}))}</p>`,r.CONFIRM,"",{okButton:U("Delete","STMemoryBooks_Delete"),cancelButton:U("Cancel","STMemoryBooks_Cancel")});try{D8(J.dlg)}catch(q){}if(await J.show()===i.AFFIRMATIVE)try{await H4(Q),toastr.success(U("Preset deleted successfully","STMemoryBooks_PresetDeletedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-presets-updated")),Z.completeAffirmative(),await l1()}catch(q){console.error("STMemoryBooks: Error deleting preset:",q),toastr.error(U("Failed to delete preset","STMemoryBooks_FailedToDeletePreset"),"STMemoryBooks")}}async function R$(){try{let Z=await B4(),Q=new Blob([Z],{type:"application/json"}),G=URL.createObjectURL(Q),J=document.createElement("a");J.href=G,J.download="stmb-summary-prompts.json",J.click(),URL.revokeObjectURL(G),toastr.success(U("Prompts exported successfully","STMemoryBooks_PromptsExportedSuccessfully"),"STMemoryBooks")}catch(Z){console.error("STMemoryBooks: Error exporting prompts:",Z),toastr.error(U("Failed to export prompts","STMemoryBooks_FailedToExportPrompts"),"STMemoryBooks")}}async function _$(Z,Q){let G=Z.target.files[0];if(!G)return;try{let J=await G.text();await O4(J),toastr.success(U("Prompts imported successfully","STMemoryBooks_PromptsImportedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-presets-updated")),Q.completeAffirmative(),await l1()}catch(J){console.error("STMemoryBooks: Error importing prompts:",J),toastr.error(S`Failed to import prompts: ${J.message}`,"STMemoryBooks")}}async function o1(){try{let Z=p.STMemoryBooks;await uZ(Z);let Q=await R6(),G='<h3 data-i18n="STMemoryBooks_ArcPromptManager_Title">\uD83E\uDDF1 Arc Prompt Manager</h3>';G+='<div class="world_entry_form_control">',G+='<p data-i18n="STMemoryBooks_ArcPromptManager_Desc">Manage your Arc Analysis prompts. All presets are editable.</p>',G+="</div>",G+='<div class="world_entry_form_control">',G+='<input type="text" id="stmb-apm-search" class="text_pole" placeholder="Search arc presets..." aria-label="Search arc presets" data-i18n="[placeholder]STMemoryBooks_ArcPromptManager_Search;[aria-label]STMemoryBooks_ArcPromptManager_Search" />',G+="</div>",G+='<div id="stmb-apm-list" class="padding10 marginBot10" style="max-height: 400px; overflow-y: auto;"></div>',G+='<div class="buttons_block justifyCenter gap10px whitespacenowrap">',G+='<button id="stmb-apm-new" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_ArcPromptManager_New">➕ New Arc Preset</button>',G+='<button id="stmb-apm-export" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_ArcPromptManager_Export">\uD83D\uDCE4 Export JSON</button>',G+='<button id="stmb-apm-import" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_ArcPromptManager_Import">\uD83D\uDCE5 Import JSON</button>',G+='<button id="stmb-apm-recreate-builtins" class="menu_button whitespacenowrap" data-i18n="STMemoryBooks_ArcPromptManager_RecreateBuiltins">♻️ Recreate Built-in Arc Prompts</button>',G+="</div>",G+='<input type="file" id="stmb-apm-import-file" accept=".json" style="display: none;" />';let J=new $0(G,r.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:!1,cancelButton:U("Close","STMemoryBooks_Close")});I$(J);let W=J.dlg?.querySelector("#stmb-apm-list");if(W){let q=(Q||[]).map((z)=>({key:String(z.key||""),displayName:String(z.displayName||"")}));W.innerHTML=i1.sanitize(pZ({items:q}))}await J.show()}catch(Z){console.error("STMemoryBooks: Error showing Arc Prompt Manager:",Z),toastr.error(U("Failed to open Arc Prompt Manager","STMemoryBooks_FailedToOpenArcPromptManager"),"STMemoryBooks")}}function I$(Z){let Q=Z.dlg,G=null;Q.addEventListener("click",async(J)=>{let W=J.target.closest(".stmb-action");if(W){J.preventDefault(),J.stopPropagation();let z=W.closest("tr[data-preset-key]"),Y=z?.dataset.presetKey;if(!Y)return;if(Q.querySelectorAll("tr[data-preset-key]").forEach((K)=>{K.classList.remove("ui-state-active"),K.style.backgroundColor="",K.style.border=""}),z)z.style.backgroundColor="var(--cobalt30a)",z.style.border="",G=Y;if(W.classList.contains("stmb-action-edit"))await w$(Z,Y);else if(W.classList.contains("stmb-action-duplicate"))await C$(Z,Y);else if(W.classList.contains("stmb-action-delete"))await h$(Z,Y);return}let q=J.target.closest("tr[data-preset-key]");if(q)Q.querySelectorAll("tr[data-preset-key]").forEach((z)=>{z.classList.remove("ui-state-active"),z.style.backgroundColor="",z.style.border=""}),q.style.backgroundColor="var(--cobalt30a)",q.style.border="",G=q.dataset.presetKey}),Q.querySelector("#stmb-apm-search")?.addEventListener("input",(J)=>{let W=J.target.value.toLowerCase();Q.querySelectorAll("tr[data-preset-key]").forEach((q)=>{let z=q.querySelector("td:first-child").textContent.toLowerCase();q.style.display=z.includes(W)?"":"none"})}),Q.querySelector("#stmb-apm-new")?.addEventListener("click",async()=>{await L$(Z)}),Q.querySelector("#stmb-apm-export")?.addEventListener("click",async()=>{await M$()}),Q.querySelector("#stmb-apm-import")?.addEventListener("click",()=>{Q.querySelector("#stmb-apm-import-file")?.click()}),Q.querySelector("#stmb-apm-import-file")?.addEventListener("change",async(J)=>{await v$(J,Z)}),Q.querySelector("#stmb-apm-recreate-builtins")?.addEventListener("click",async()=>{try{let J=`
                ...
                <p class="opacity70p">${b(U("This does not affect your other custom presets.","STMemoryBooks_RecreateBuiltinsDoesNotAffectCustom"))}</p>
            `;if(await new $0(J,r.CONFIRM,"",{okButton:U("Overwrite","STMemoryBooks_RecreateBuiltinsOverwrite"),cancelButton:U("Cancel","STMemoryBooks_Cancel")}).show()===i.AFFIRMATIVE){let z=await n5("overwrite");try{window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated"))}catch(Y){}toastr.success(S`Removed ${z?.removed||0} built-in overrides`,U("STMemoryBooks","index.toast.title")),Z.completeAffirmative(),await o1()}}catch(J){console.error("STMemoryBooks: Error recreating built-in arc prompts:",J),toastr.error(U("Failed to recreate built-in prompts","STMemoryBooks_FailedToRecreateBuiltins"),U("STMemoryBooks","index.toast.title"))}})}async function L$(Z){let G=new $0(`
        <h3 data-i18n="STMemoryBooks_CreateNewPresetTitle">Create New Preset</h3>
        <div class="world_entry_form_control">
    ...
    `,r.TEXT,"",{okButton:U("Create","STMemoryBooks_Create"),cancelButton:U("Cancel","STMemoryBooks_Cancel")});if(await G.show()===i.AFFIRMATIVE){let W=G.dlg.querySelector("#stmb-apm-new-display-name").value.trim(),q=G.dlg.querySelector("#stmb-apm-new-prompt").value.trim();if(!q){toastr.error(U("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),"STMemoryBooks");return}try{await dZ(null,q,W||null),toastr.success(U("Preset created successfully","STMemoryBooks_PresetCreatedSuccessfully"),"STMemoryBooks"),window.dispatchEvent(new CustomEvent("stmb-arc-presets-updated")),Z.completeAffirmative(),await o1()}catch(z){console.error("STMemoryBooks: Error creating arc preset:",z),toastr.error(U("Failed to create preset","STMemoryBooks_FailedToCreatePreset"),"STMemoryBooks")}}}async function w$(Z,Q){try{let G=await mZ(Q),J=await _6(Q),W=`
            <h3 data-i18n="STMemoryBooks_EditPresetTitle">Edit Preset</h3>
            <div class="world_entry_form_control">
