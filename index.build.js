...
`).filter((G)=>G.trim());if(Q.length>0){let J=Q[0].trim().replace(/^(You are|Analyze|Create|Generate|Write)\s+/i,"").replace(/[:.]/g,"").trim();return I8(J.substring(0,50))}return"Custom Prompt"}function k6(Z,Q){let G=E7(Z),J=G,W=2,q=R1();while(J in Q||J in q)J=`${G}-${W}`,W++;return J}async function r0(Z=null){if(G8)return G8;let Q=!1,G=null;try{let J=await fetch(`/user/files/${K4}`,{method:"GET",credentials:"include",headers:V4()});if(!J.ok)Q=!0;else{let W=await J.text();if(G=JSON.parse(W),!U4(G))Q=!0}}catch(J){Q=!0}if(Q){let J={},W=new Date().toISOString(),q=R1();for(let[Y,z]of Object.entries(q))J[Y]={displayName:f6[Y]||I8(Y),prompt:z,createdAt:W};if(Z&&Z.profiles&&Array.isArray(Z.profiles)){for(let Y of Z.profiles)if(Y.prompt&&Y.prompt.trim()){let z=`Custom: ${Y.name||"Unnamed Profile"}`,K=k6(z,J);J[K]={displayName:z,prompt:Y.prompt,createdAt:W},console.log(`${_0}: Migrated custom prompt from profile "${Y.name}" as "${K}"`)}}G={version:s0.CURRENT_VERSION,overrides:J},await $8(G)}return G8=G,G8}async function $8(Z){try{let Q=JSON.stringify(Z,null,2),G=btoa(unescape(encodeURIComponent(Q))),J=await fetch("/api/files/upload",{method:"POST",credentials:"include",headers:V4(),body:JSON.stringify({name:K4,data:G})});if(!J.ok)throw Error(`Failed to save prompts: ${J.statusText}`);G8=Z,console.log(`${_0}: Prompts saved successfully`)}catch(Q){throw console.error(`${_0}: Error saving overrides:`,Q),Q}}function U4(Z){if(!Z||typeof Z!=="object")return console.error(`${_0}: Invalid data type`),!1;if(typeof Z.version!=="number")return console.error(`${_0}: Invalid schema version type: ${Z.version}`),!1;if(Z.version!==s0.CURRENT_VERSION)console.warn(`${_0}: Unexpected schema version: ${Z.version} (expected ${s0.CURRENT_VERSION})`);if(!Z.overrides||typeof Z.overrides!=="object")return console.error(`${_0}: Missing or invalid overrides object`),!1;for(let[Q,G]of Object.entries(Z.overrides)){if(!G||typeof G!=="object")return console.error(`${_0}: Invalid override entry for key: ${Q}`),!1;if(typeof G.prompt!=="string"||!G.prompt.trim())return console.error(`${_0}: Invalid or empty prompt for key: ${Q}`),!1;if(G.displayName!==void 0&&typeof G.displayName!=="string")return console.error(`${_0}: Invalid displayName for key: ${Q}`),!1}return!0}async function J8(Z){return await r0(Z),x7=!0,S7=null,!0}async function T1(Z=null){let Q=await r0(Z),G=[];for(let[W,q]of Object.entries(Q.overrides))G.push({key:W,displayName:q.displayName||I8(W),createdAt:q.createdAt||null});let J=R1()||{};for(let W of Object.keys(J))if(!(W in Q.overrides))G.push({key:W,displayName:f6[W]||I8(W),createdAt:null});return G.sort((W,q)=>{if(!W.createdAt)return 1;if(!q.createdAt)return-1;return new Date(q.createdAt)-new Date(W.createdAt)}),G}async function G1(Z,Q=null){let G=await r0(Q);if(G.overrides[Z]){let W=G.overrides[Z].prompt;if(typeof W==="string"&&W.trim())return W}return R1()[Z]||d0()}async function g6(Z,Q=null){let G=await r0(Q);if(G.overrides[Z]&&G.overrides[Z].displayName)return G.overrides[Z].displayName;return f6[Z]||I8(Z)}async function L8(Z,Q,G){let J=await r0(),W=new Date().toISOString();if(!Z)Z=k6(G||X4(Q),J.overrides);if(J.overrides[Z])J.overrides[Z].prompt=Q,J.overrides[Z].displayName=G||J.overrides[Z].displayName,J.overrides[Z].updatedAt=W;else J.overrides[Z]={displayName:G||X4(Q),prompt:Q,createdAt:W};return await $8(J),Z}async function j4(Z){let Q=await r0(),G=Q.overrides[Z];if(!G)throw Error(`Preset "${Z}" not found`);let J=`${G.displayName} (Copy)`,W=k6(J,Q.overrides),q=new Date().toISOString();return Q.overrides[W]={displayName:J,prompt:G.prompt,createdAt:q},await $8(Q),W}async function B4(Z){let Q=await r0();if(!Q.overrides[Z])throw Error(`Preset "${Z}" not found`);delete Q.overrides[Z],await $8(Q)}async function F4(){let Z=await r0();return JSON.stringify(Z,null,2)}async function H4(Z){try{let Q=JSON.parse(Z);if(!U4(Q))throw Error("Invalid prompts file structure - see console for details");await $8(Q)}catch(Q){throw console.error(`${_0}: Error importing prompts:`,Q),Q}}async function O4(Z="overwrite"){if(Z!=="overwrite")console.warn(`${_0}: Unsupported mode for recreateBuiltInPrompts: ${Z}; defaulting to 'overwrite'`);let Q=await r0(),G=R1(),J=Object.keys(G||{}),W=0;if(Q&&Q.overrides&&typeof Q.overrides==="object"){for(let q of J)if(q in Q.overrides)delete Q.overrides[q],W++}return await $8(Q),G8=Q,console.log(`${_0}: Recreated built-in prompts (removed ${W} overrides)`),{removed:W}}var _0="STMemoryBooks-SummaryPromptManager",K4,G8=null,x7=!1,S7=null,f6;var a8=N1(()=>{b0();A1();K4=s1.PROMPTS_FILE,f6=Object.fromEntries(Object.keys(D8).map((Z)=>[Z,P7(D8[Z],i8[Z])]))});var _4={};G4(_4,{validateProfile:()=>X8,showLorebookSelectionPopup:()=>D1,resolveEffectiveConnectionFromProfile:()=>i6,readIntInput:()=>J0,parseTemperature:()=>l6,normalizeCompletionSource:()=>q0,isValidPreset:()=>c7,getUIModelSettings:()=>Q0,getPresetPrompt:()=>m7,getPresetNames:()=>d7,getEffectivePrompt:()=>_1,getEffectiveLorebookName:()=>z8,getDefaultPrompt:()=>d0,getCurrentModelSettings:()=>u7,getCurrentMemoryBooksContext:()=>Y8,getCurrentApiInfo:()=>o,getBuiltInPresetPrompts:()=>R1,getApiSelectors:()=>p6,generateSafeProfileName:()=>I1,formatPresetDisplayName:()=>p7,estimateTokens:()=>$1,deepClone:()=>q8,createProfileObject:()=>L1,clampInt:()=>K0,SELECTORS:()=>a0});import{chat_metadata as W8,characters as u6,name2 as m6,this_chid as d6}from"../../../../script.js";import{getContext as b7,extension_settings as A4}from"../../../extensions.js";import{selected_group as T4,groups as y7}from"../../../group-chats.js";import{METADATA_KEY as c6,world_names as t8}from"../../../world-info.js";import{Popup as R4,POPUP_TYPE as D4,POPUP_RESULT as e8}from"../../../popup.js";import{translate as c0}from"../../../i18n.js";function f7(...Z){for(let Q of Z){let G=v0(Q);if(G.length)return G}return v0()}function k7(){return document.querySelector("#group_chat_completion_source")?"#group_":"#"}function J0(Z,Q){if(!Z)return Q;let G=parseInt(Z.value,10);return Number.isFinite(G)?G:Q}function K0(Z,Q,G){return Math.min(Math.max(Z,Q),G)}function q0(Z){let Q=String(Z||"").trim().toLowerCase();if(Q==="google")return"makersuite";return Q===""?"openai":Q}function o(){try{let Z="unknown",Q="unknown",G="unknown";if(typeof window.getGeneratingApi==="function")Z=window.getGeneratingApi();else Z=v0(a0.mainApi).val()||"unknown";if(typeof window.getGeneratingModel==="function")Q=window.getGeneratingModel();if(G=v0(a0.completionSource).val()||Z,!g7.includes(G))console.warn(`${p0}: Unsupported completion source: ${G}, falling back to openai`),G="openai";return{api:Z,model:Q,completionSource:G}}catch(Z){return console.warn(`${p0}: Error getting API info:`,Z),{api:v0(a0.mainApi).val()||"unknown",model:"unknown",completionSource:v0(a0.completionSource).val()||"openai"}}}function p6(){let Z=k7(),G=f7(`${Z}chat_completion_source`,"#chat_completion_source").val?.()||"openai",J={openai:`${Z}model_openai_select`,claude:`${Z}model_claude_select`,openrouter:`${Z}model_openrouter_select`,ai21:`${Z}model_ai21_select`,makersuite:`${Z}model_google_select`,mistralai:`${Z}model_mistralai_select`,custom:`${Z}model_custom_select`,cohere:`${Z}model_cohere_select`,perplexity:`${Z}model_perplexity_select`,groq:`${Z}model_groq_select`,nanogpt:`${Z}model_nanogpt_select`,deepseek:`${Z}model_deepseek_select`,electronhub:`${Z}model_electronhub_select`,vertexai:`${Z}model_vertexai_select`,aimlapi:`${Z}model_aimlapi_select`,xai:`${Z}model_xai_select`,pollinations:`${Z}model_pollinations_select`,moonshot:`${Z}model_moonshot_select`,fireworks:`${Z}model_fireworks_select`,cometapi:`${Z}model_cometapi_select`,azure_openai:`${Z}model_azure_openai_select`},W=J[G]||J.openai,q=`${Z}temp_openai`.replace("##","#"),Y=`${Z}temp_counter_openai`.replace("##","#");return{model:W,temp:q,tempCounter:Y}}function Y8(){try{let Z=null,Q=null,G=null,J=!!T4,W=T4||null,q=null;if(J){let X=y7?.find((V)=>V.id===W);if(X)q=X.name,Q=X.chat_id,G=Q,Z=q}else{if(m6&&m6.trim())Z=String(m6).trim();else if(d6!==void 0&&u6&&u6[d6])Z=u6[d6].name;else if(W8?.character_name)Z=String(W8.character_name).trim();if(Z&&Z.normalize)Z=Z.normalize("NFC");try{let X=b7();if(X?.chatId)Q=X.chatId,G=Q;else if(typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}catch(X){if(console.warn(`${p0}: Could not get context, trying fallback methods`),typeof window.getCurrentChatId==="function")Q=window.getCurrentChatId(),G=Q}}let Y=null;if(W8&&c6 in W8)Y=W8[c6];let z=null;try{let X=o(),V=p6(),j=v0(V.temp).val()??v0(V.tempCounter).val(),U=Number.isFinite(parseFloat(j))?parseFloat(j):0.7,O=v0(V.model).val()||"";z={api:X.api,model:O,temperature:U,completionSource:X.completionSource,source:"current_ui"}}catch(X){console.warn(`${p0}: Could not get current model/temperature settings:`,X),z=null}let K={characterName:Z,chatId:Q,chatName:G,groupId:W,isGroupChat:J,lorebookName:Y,modelSettings:z};if(J)K.groupName=q;return K}catch(Z){return console.warn(`${p0}: Error getting context:`,Z),{characterName:null,chatId:null,chatName:null,groupId:null,groupName:null,isGroupChat:!1}}}async function z8(){if(!A4.STMemoryBooks.moduleSettings.manualModeEnabled)return W8?.[c6]||null;let Q=k();if(Q.manualLorebook??null)if(t8.includes(Q.manualLorebook))return Q.manualLorebook;else toastr.error(`The designated manual lorebook "${Q.manualLorebook}" no longer exists. Please select a new one.`),delete Q.manualLorebook;let G=t8.map((Y)=>`<option value="${Y}">${Y}</option>`).join("");if(G.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let J=`
    ...
    `,W=new R4(J,D4.TEXT,"",{okButton:"Select",cancelButton:"Cancel"});if(await W.show()===e8.AFFIRMATIVE){let Y=W.dlg.querySelector("#stmb-manual-lorebook-select").value;return Q.manualLorebook=Y,Z0(),toastr.success(`"${Y}" is now the Memory Book for this chat.`,"STMemoryBooks"),Y}return null}async function D1(Z=null){if(t8.length===0)return toastr.error("No lorebooks found to select from.","STMemoryBooks"),null;let Q=t8.map((q)=>{return`<option value="${q}"${q===Z?" selected":""}>${q}</option>`}).join(""),G=`
        <h4>Select a Memory Book</h4>
        <div class="world_entry_form_control">
    ...
    `,J=new R4(G,D4.TEXT,"",{okButton:"Select",cancelButton:"Cancel"});if(await J.show()===e8.AFFIRMATIVE){let q=J.dlg.querySelector("#stmb-manual-lorebook-select").value;if(q!==Z){let Y=k();return Y.manualLorebook=q,Z0(),toastr.success(`Manual lorebook changed to: ${q}`,"STMemoryBooks"),q}else return q}return null}function u7(Z){try{if(!Z)throw Error("getCurrentModelSettings requires a profile");let Q=Z.effectiveConnection||Z.connection;if(!Q)throw Error("Profile is missing connection");let G=(Q.model||"").trim();if(!G)throw Error("Profile is missing required connection.model");let J=l6(Q.temperature);if(J===null)J=0.7;return{model:G,temperature:J}}catch(Q){throw console.warn(`${p0}: Error getting current model settings:`,Q),Q}}function Q0(){try{let Z=p6(),Q=(v0(Z.model).val()||"").trim(),G=0.7,J=v0(Z.temp).val()||v0(Z.tempCounter).val();if(J!==null&&J!==void 0&&J!==""){let W=parseFloat(J);if(!isNaN(W)&&W>=0&&W<=2)G=W}return{model:Q,temperature:G}}catch(Z){return console.warn(`${p0}: Error getting UI model settings:`,Z),{model:"",temperature:0.7}}}async function $1(Z,Q={}){let{estimatedOutput:G=300}=Q,J=String(Z||""),W=Math.ceil(J.length/4);return{input:W,output:G,total:W+G}}function i6(Z){let Q=Z?.effectiveConnection||Z?.connection||{},G=q0(Q.api||"openai"),J=(Q.model||"").trim(),W=0.7;if(typeof Q.temperature==="number"&&!Number.isNaN(Q.temperature))W=Math.max(0,Math.min(2,Q.temperature));let q=Q.endpoint?String(Q.endpoint):void 0,Y=Q.apiKey?String(Q.apiKey):void 0;return{api:G,model:J,temperature:W,endpoint:q,apiKey:Y}}function R1(){return{summary:c0(`You are a talented summarist skilled at capturing scenes from stories comprehensively. Analyze the following roleplay scene and return a detailed memory as JSON.
...
`);import{translate as N,applyLocale as E5}from"../../../i18n.js";function e0(Z,Q,G){let J=N(Q,Z);if(!G)return J;return J.replace(/{{\s*(\w+)\s*}}/g,(W,q)=>{let Y=G[q];return Y!==void 0&&Y!==null?String(Y):""})}function b5(Z){let Q=[],G=Z?.triggers||{};if(G.onInterval&&Number(G.onInterval.visibleMessages)>=1)Q.push(`${N("Interval","STMemoryBooks_Interval")}:${Number(G.onInterval.visibleMessages)}`);if(G.onAfterMemory&&!!G.onAfterMemory.enabled)Q.push(N("AfterMemory","STMemoryBooks_AfterMemory"));if(Array.isArray(G.commands)&&G.commands.some((J)=>String(J).toLowerCase()==="sideprompt"))Q.push(N("Manual","STMemoryBooks_Manual"));return Q}function xG(Z){let Q=(Z||[]).map((G)=>({key:String(G.key||""),name:String(G.name||""),badges:b5(G)}));return S5({items:Q})}async function V1(Z,Q=null){let G=Z?.dlg?.querySelector("#stmb-sp-list");if(!G)return;let J=(Z?.dlg?.querySelector("#stmb-sp-search")?.value||"").toLowerCase(),W=await z1(),q=J?W.filter((Y)=>{let z=Y.name.toLowerCase().includes(J),K=b5(Y).join(" ").toLowerCase();return z||K.includes(J)}):W;G.innerHTML=A6.sanitize(xG(q));try{E5(G)}catch(Y){}if(Q){let Y=G.querySelector(`tr[data-tpl-key="${CSS.escape(Q)}"]`);if(Y)Y.style.backgroundColor="var(--cobalt30a)",Y.style.border=""}}async function SG(Z,Q){try{let G=await AZ(Q);if(!G){toastr.error(e0("STMemoryBooks_TemplateNotFound",'Template "{{key}}" not found',{key:Q}),N("STMemoryBooks","index.toast.title"));return}let J=!!G.enabled,W=G.settings||{},q=G.triggers||{},Y=!!(q.onInterval&&Number(q.onInterval.visibleMessages)>=1),z=Y?Math.max(1,Number(q.onInterval.visibleMessages)):50,K=!!(q.onAfterMemory&&q.onAfterMemory.enabled),X=Array.isArray(q.commands)?q.commands.some((C)=>String(C).toLowerCase()==="sideprompt"):!1,V=l0?.STMemoryBooks?.profiles||[],j=Number.isFinite(W.overrideProfileIndex)?Number(W.overrideProfileIndex):l0?.STMemoryBooks?.defaultProfile??0;if(!(j>=0&&j<V.length))j=0;let U=!!W.overrideProfileEnabled,O=V.map((C,d)=>`<option value="${d}" ${d===j?"selected":""}>${D(C?.name||"Profile "+(d+1))}</option>`).join(""),F=`
            ...
            <div class="world_entry_form_control" id="stmb-sp-edit-override-container" style="display: ${U?"block":"none"};">
                <label for="stmb-sp-edit-override-index">
                    <h4>${D(N("Connection Profile:","STMemoryBooks_ConnectionProfile"))}</h4>
                    <select id="stmb-sp-edit-override-index" class="text_pole">
                        ${O}
                    </select>
                </label>
            </div>
        `,A=Number.isFinite(W.previousMemoriesCount)?Number(W.previousMemoriesCount):0,H=W&&W.lorebook||{},T=H.constVectMode||"link",R=Number.isFinite(H.position)?Number(H.position):0,L=H.orderMode==="manual",P=Number.isFinite(H.orderValue)?Number(H.orderValue):100,x=H.preventRecursion!==!1,w=!!H.delayUntilRecursion,_=`
            <h3>${D(N("Edit Side Prompt","STMemoryBooks_EditSidePrompt"))}</h3>
            <div class="world_entry_form_control">
                <small>${D(N("Key:","STMemoryBooks_Key"))} <code>${D(G.key)}</code></small>
            </div>
            <div class="world_entry_form_control">
                <label for="stmb-sp-edit-name">
                    <h4>${D(N("Name:","STMemoryBooks_Name"))}</h4>
            ...
            <div class="world_entry_form_control">
                <label class="checkbox_label">
                    ...
                    <span>${D(N("Enabled","STMemoryBooks_Enabled"))}</span>
                </label>
            </div>
            <div class="world_entry_form_control">
                <h4>${D(N("Triggers:","STMemoryBooks_Triggers"))}</h4>
                <label class="checkbox_label">
                    <input type="checkbox" id="stmb-sp-edit-trg-interval" ${Y?"checked":""}>
                    <span>${D(N("Run on visible message interval","STMemoryBooks_RunOnVisibleMessageInterval"))}</span>
                </label>
                <div id="stmb-sp-edit-interval-container" style="display:${Y?"block":"none"}; margin-left:28px;">
                    <label for="stmb-sp-edit-interval">
                        <h4 style="margin: 0 0 4px 0;">${D(N("Interval (visible messages):","STMemoryBooks_IntervalVisibleMessages"))}</h4>
                ...
                <label class="checkbox_label">
                    ...
                    <span>${D(N("Run automatically after memory","STMemoryBooks_RunAutomaticallyAfterMemory"))}</span>
                </label>
                <label class="checkbox_label">
                    <input type="checkbox" id="stmb-sp-edit-trg-manual" ${X?"checked":""}>
                    <span>${D(N("Allow manual run via /sideprompt","STMemoryBooks_AllowManualRunViaSideprompt"))}</span>
                </label>
            </div>
            <div class="world_entry_form_control">
                <label for="stmb-sp-edit-prompt">
                    <h4>${D(N("Prompt:","STMemoryBooks_PromptTitle"))}</h4>
            ...
            <div class="world_entry_form_control">
                <label for="stmb-sp-edit-response-format">
                    <h4>${D(N("Response Format (optional):","STMemoryBooks_ResponseFormatOptional"))}</h4>
            ...
            <div class="world_entry_form_control">
                <h4>${D(N("Lorebook Entry Settings","STMemoryBooks_LorebookEntrySettings"))}:</h4>
                <div class="flex-container" style="gap:12px; flex-wrap: wrap;">
                    <label>
                        <h4 style="margin: 0 0 4px 0;">${D(N("Activation Mode","STMemoryBooks_ActivationMode"))}:</h4>
                        <select id="stmb-sp-edit-lb-mode" class="text_pole">
                            <option value="link" ${T==="link"?"selected":""}>${D(N("\uD83D\uDD17 Vectorized (Default)","STMemoryBooks_Vectorized"))}</option>
                            <option value="green" ${T==="green"?"selected":""}>${D(N("\uD83D\uDFE2 Normal","STMemoryBooks_Normal"))}</option>
                            <option value="blue" ${T==="blue"?"selected":""}>${D(N("\uD83D\uDD35 Constant","STMemoryBooks_Constant"))}</option>
                        </select>
                    </label>
                    <label>
                        <h4 style="margin: 0 0 4px 0;">${D(N("Insertion Position:","STMemoryBooks_InsertionPosition"))}</h4>
                        <select id="stmb-sp-edit-lb-position" class="text_pole">
                            <option value="0" ${R===0?"selected":""}>${D(N("↑Char","STMemoryBooks_CharUp"))}</option>
                            <option value="1" ${R===1?"selected":""}>${D(N("↓Char","STMemoryBooks_CharDown"))}</option>
                            <option value="5" ${R===5?"selected":""}>${D(N("↑EM","STMemoryBooks_EMUp"))}</option>
                            <option value="6" ${R===6?"selected":""}>${D(N("↓EM","STMemoryBooks_EMDown"))}</option>
                            <option value="2" ${R===2?"selected":""}>${D(N("↑AN","STMemoryBooks_ANUp"))}</option>
                            <option value="3" ${R===3?"selected":""}>${D(N("↓AN","STMemoryBooks_ANDown"))}</option>
                            <option value="7" ${R===7?"selected":""}>${D(N("Outlet","STMemoryBooks_Outlet"))}</option>
                        </select>
                        <div id="stmb-sp-edit-lb-outlet-name-container" style="display:${R===7?"block":"none"}; margin-top: 8px;">
                            <label>
                                <h4 style="margin: 0 0 4px 0;">${D(N("Outlet Name:","STMemoryBooks_OutletName"))}</h4>
                                <input type="text" id="stmb-sp-edit-lb-outlet-name" class="text_pole" placeholder="${D(N("Outlet name","STMemoryBooks_OutletNamePlaceholder"))}" value="${D(H.outletName||"")}">
                            </label>
                        </div>
                    </label>
                </div>
                <div class="world_entry_form_control" style="margin-top: 8px;">
                    <h4>${D(N("Insertion Order:","STMemoryBooks_InsertionOrder"))}</h4>
                    <label class="radio_label">
                        <input type="radio" name="stmb-sp-edit-lb-order-mode" id="stmb-sp-edit-lb-order-auto" value="auto" ${L?"":"checked"}>
                        <span>${D(N("Auto (uses memory #)","STMemoryBooks_AutoOrder"))}</span>
                    </label>
                    <label class="radio_label" style="margin-left: 12px;">
                        ...
                        <span>${D(N("Manual","STMemoryBooks_ManualOrder"))}</span>
                    </label>
                    <div id="stmb-sp-edit-lb-order-value-container" style="display:${L?"block":"none"}; margin-left:28px;">
                        <label>
                            <h4 style="margin: 0 0 4px 0;">${D(N("Order Value:","STMemoryBooks_OrderValue"))}</h4>
                ...
                <div class="world_entry_form_control" style="margin-top: 8px;">
                    <label class="checkbox_label">
                        ...
                        <span>${D(N("Prevent Recursion","STMemoryBooks_PreventRecursion"))}</span>
                    </label>
                    <label class="checkbox_label" style="margin-left: 12px;">
                        <input type="checkbox" id="stmb-sp-edit-lb-delay" ${w?"checked":""}>
                        <span>${D(N("Delay Until Recursion","STMemoryBooks_DelayUntilRecursion"))}</span>
                    </label>
                </div>
            </div>
            ...
            <div class="world_entry_form_control">
                <label for="stmb-sp-edit-prev-mem-count">
                    <h4>${D(N("Previous memories for context:","STMemoryBooks_PreviousMemoriesForContext"))}</h4>
<input type="number" id="stmb-sp-edit-prev-mem-count" class="text_pole" min="0" max="7" step="1" value="${A}">
                </label>
                <small class="opacity70p">${D(N("Number of previous memory entries to include before scene text (0 = none).","STMemoryBooks_PreviousMemoriesHelp"))}</small>
            </div>

            <div class="world_entry_form_control">
                <h4>${D(N("Overrides:","STMemoryBooks_Overrides"))}</h4>
                ${F}
            </div>
        `,M=new b8(A6.sanitize(_),E1.TEXT,"",{wide:!0,large:!0,allowVerticalScrolling:!0,okButton:N("Save","STMemoryBooks_Save"),cancelButton:N("Cancel","STMemoryBooks_Cancel")}),u=()=>{let C=M.dlg;if(!C)return;let d=C.querySelector("#stmb-sp-edit-trg-interval"),j0=C.querySelector("#stmb-sp-edit-interval-container");d?.addEventListener("change",()=>{if(j0)j0.style.display=d.checked?"block":"none";if(d.checked)C.querySelector("#stmb-sp-edit-interval")?.focus()});let m0=C.querySelector("#stmb-sp-edit-override-enabled"),M0=C.querySelector("#stmb-sp-edit-override-container");m0?.addEventListener("change",()=>{if(M0)M0.style.display=m0.checked?"block":"none"});let A0=C.querySelector("#stmb-sp-edit-lb-order-auto"),X0=C.querySelector("#stmb-sp-edit-lb-order-manual"),T0=C.querySelector("#stmb-sp-edit-lb-order-value-container"),O1=()=>{if(T0)T0.style.display=X0?.checked?"block":"none"};A0?.addEventListener("change",O1),X0?.addEventListener("change",O1);let B0=C.querySelector("#stmb-sp-edit-lb-position"),o0=C.querySelector("#stmb-sp-edit-lb-outlet-name-container");B0?.addEventListener("change",()=>{if(o0)o0.style.display=B0.value==="7"?"block":"none"})},e=M.show();if(u(),await e===K1.AFFIRMATIVE){let C=M.dlg,d=C.querySelector("#stmb-sp-edit-name")?.value.trim()||"",j0=C.querySelector("#stmb-sp-edit-prompt")?.value.trim()||"",m0=C.querySelector("#stmb-sp-edit-response-format")?.value.trim()||"",M0=!!C.querySelector("#stmb-sp-edit-enabled")?.checked;if(!j0){toastr.error(N("Prompt cannot be empty","STMemoryBooks_PromptCannotBeEmpty"),N("STMemoryBooks","index.toast.title"));return}if(!d)toastr.info(N("Name was empty. Keeping previous name.","STMemoryBooks_NameEmptyKeepPrevious"),N("STMemoryBooks","index.toast.title"));let A0={},X0=!!C.querySelector("#stmb-sp-edit-trg-interval")?.checked,T0=!!C.querySelector("#stmb-sp-edit-trg-aftermem")?.checked,O1=!!C.querySelector("#stmb-sp-edit-trg-manual")?.checked;if(X0){let D0=parseInt(C.querySelector("#stmb-sp-edit-interval")?.value??"50",10),D7=Math.max(1,isNaN(D0)?50:D0);A0.onInterval={visibleMessages:D7}}if(T0)A0.onAfterMemory={enabled:!0};if(O1)A0.commands=["sideprompt"];let B0={...G.settings||{}},o0=!!C.querySelector("#stmb-sp-edit-override-enabled")?.checked;if(B0.overrideProfileEnabled=o0,o0){let D0=parseInt(C.querySelector("#stmb-sp-edit-override-index")?.value??"",10);if(!isNaN(D0))B0.overrideProfileIndex=D0}else delete B0.overrideProfileIndex;let T8=C.querySelector("#stmb-sp-edit-lb-mode")?.value||"link",n0=parseInt(C.querySelector("#stmb-sp-edit-lb-position")?.value??"0",10),v6=!!C.querySelector("#stmb-sp-edit-lb-order-manual")?.checked,P6=parseInt(C.querySelector("#stmb-sp-edit-lb-order-value")?.value??"100",10),f=!!C.querySelector("#stmb-sp-edit-lb-prevent")?.checked,l=!!C.querySelector("#stmb-sp-edit-lb-delay")?.checked,G0=n0===7?C.querySelector("#stmb-sp-edit-lb-outlet-name")?.value?.trim()||"":"",R0=parseInt(C.querySelector("#stmb-sp-edit-prev-mem-count")?.value??"0",10);B0.previousMemoriesCount=Number.isFinite(R0)&&R0>0?Math.min(R0,7):0,B0.lorebook={constVectMode:["link","green","blue"].includes(T8)?T8:"link",position:Number.isFinite(n0)?n0:0,orderMode:v6?"manual":"auto",orderValue:Number.isFinite(P6)?P6:100,preventRecursion:f,delayUntilRecursion:l,...n0===7&&G0?{outletName:G0}:{}},await F6({key:G.key,name:d,enabled:M0,prompt:j0,responseFormat:m0,settings:B0,triggers:A0}),toastr.success(e0("STMemoryBooks_Toast_SidePromptUpdated",'SidePrompt "{{name}}" updated.',{name:d||G.name}),N("STMemoryBooks","index.toast.title")),window.dispatchEvent(new CustomEvent("stmb-sideprompts-updated")),await V1(Z,G.key)}}catch(G){console.error("STMemoryBooks: Error editing side prompt:",G),toastr.error(N("Failed to edit SidePrompt","STMemoryBooks_FailedToEditSidePrompt"),N("STMemoryBooks","index.toast.title"))}}async function EG(Z){let Q=l0?.STMemoryBooks?.profiles||[],G=Number(l0?.STMemoryBooks?.defaultProfile??0);if(!(G>=0&&G<Q.length))G=0;let J=Q.map((X,V)=>`<option value="${V}" ${V===G?"selected":""}>${D(X?.name||"Profile "+(V+1))}</option>`).join(""),W=`
        <h3>${D(N("New Side Prompt","STMemoryBooks_NewSidePrompt"))}</h3>
        <div class="world_entry_form_control">
            <label for="stmb-sp-new-name">
                <h4>${D(N("Name:","STMemoryBooks_Name"))}</h4>
                <input type="text" id="stmb-sp-new-name" class="text_pole" placeholder="${D(N("My Side Prompt","STMemoryBooks_MySidePromptPlaceholder"))}" />
            </label>
        </div>
        <div class="world_entry_form_control">
            <label class="checkbox_label">
        ...
        <div class="world_entry_form_control">
            <label for="stmb-sp-new-prompt">
                ...
                <textarea id="stmb-sp-new-prompt" class="text_pole textarea_compact" rows="8" placeholder="${D(N("Enter your prompt here...","STMemoryBooks_EnterPromptPlaceholder"))}"></textarea>
            </label>
        </div>
        <div class="world_entry_form_control">
            <label for="stmb-sp-new-response-format">
                ...
                <textarea id="stmb-sp-new-response-format" class="text_pole textarea_compact" rows="6" placeholder="${D(N("Optional response format","STMemoryBooks_ResponseFormatPlaceholder"))}"></textarea>
            </label>
        </div>
        <div class="world_entry_form_control">
            <h4>${D(N("Lorebook Entry Settings","STMemoryBooks_LorebookEntrySettings"))}:</h4>
            <div class="flex-container" style="gap:12px; flex-wrap: wrap;">
                <label>
                    ...
                    <select id="stmb-sp-new-lb-mode" class="text_pole">
                        <option value="link" selected>${D(N("\uD83D\uDD17 Vectorized (Default)","STMemoryBooks_Vectorized"))}</option>
                        <option value="green">${D(N("\uD83D\uDFE2 Normal","STMemoryBooks_Normal"))}</option>
                        <option value="blue">${D(N("\uD83D\uDD35 Constant","STMemoryBooks_Constant"))}</option>
                    </select>
                </label>
                <label>
                    <h4 style="margin: 0 0 4px 0;">${D(N("Insertion Position:","STMemoryBooks_InsertionPosition"))}</h4>
                    <select id="stmb-sp-new-lb-position" class="text_pole">
                        <option value="0" selected>${D(N("↑Char","STMemoryBooks_CharUp"))}</option>
                        <option value="1">${D(N("↓Char","STMemoryBooks_CharDown"))}</option>
                        <option value="2">${D(N("↑AN","STMemoryBooks_ANUp"))}</option>
                        <option value="3">${D(N("↓AN","STMemoryBooks_ANDown"))}</option>
                        <option value="4">${D(N("↑EM","STMemoryBooks_EMUp"))}</option>
                        <option value="5">${D(N("↓EM","STMemoryBooks_EMDown"))}</option>
                        <option value="7">${D(N("Outlet","STMemoryBooks_Outlet"))}</option>
                    </select>
                    <div id="stmb-sp-new-lb-outlet-name-container" class="displayNone" style="margin-top: 8px;">
                        <label>
                            <h4 style="margin: 0 0 4px 0;">${D(N("Outlet Name:","STMemoryBooks_OutletName"))}</h4>
                            <input type="text" id="stmb-sp-new-lb-outlet-name" class="text_pole" placeholder="${D(N("Outlet name (e.g., ENDING)","STMemoryBooks_OutletNamePlaceholder"))}">
                        </label>
                    </div>
                </label>
            </div>
...
${q.join(`
`)}`}function u8(Z){if(!Z||typeof Z!=="string")throw Error(D6("Empty AI response","STMemoryBooks_ArcAnalysis_EmptyResponse"));let Q=e5(Z.trim().replace(/<think>[\s\S]*?<\/think>/gi,"")),G=[],J=gG(Q);if(J)G.push(J);let W=Z7(Q);if(W.length)G.push(...W);G.push(Q);let q=Q7(Q);if(q)G.push(q);let Y=Array.from(new Set(G));for(let z of Y)try{let K=z;K=G7(K),K=$7(K);let X=JSON.parse(K);if(!X||typeof X!=="object")continue;if(!("arcs"in X)||!("unassigned_memories"in X))continue;let V=Array.isArray(X.arcs)?X.arcs:[],j=Array.isArray(X.unassigned_memories)?X.unassigned_memories:[],U=V.filter((F)=>F&&typeof F.title==="string"&&F.title.trim()&&typeof F.summary==="string"&&F.summary.trim()),O=j.filter((F)=>F&&typeof F.id==="string"&&F.id.trim()&&typeof F.reason==="string");return{arcs:U,unassigned_memories:O}}catch{}throw Error(D6("Model did not return valid arc JSON","STMemoryBooks_ArcAnalysis_InvalidJSON"))}async function J7(Z,Q={},G=null){let{presetKey:J="arc_default",maxItemsPerPass:W=12,maxPasses:q=10,minAssigned:Y=2,tokenTarget:z}=Q,K=Q?.extra??{},X=J==="arc_alternate",V=Object.prototype.hasOwnProperty.call(Q,"maxPasses")?q:X?1:q,j=t5?.STMemoryBooks?.moduleSettings?.tokenWarningThreshold,U=typeof z==="number"?z:typeof j==="number"?j:30000,O=U,F=Z.map((y)=>y&&y.entry?y.entry:y).filter(Boolean),A=mG(F),H=new Map(A.map((y)=>[y.id,y])),T=[],R="",L="",P=null;try{if(J&&await m5(J))P=await R6(J)}catch{}if(!P)P=y8();let x=W7(G),w=null,_=null,M=0,u=[];while(H.size>0&&M<V){M++,O=U;let y=Array.from(H.values()).sort((f,l)=>f.order-l.order),C=[];for(let f of u)if(H.has(f.id)&&C.length<W)C.push(f);for(let f of y){if(C.length>=W)break;if(!C.find((l)=>l.id===f.id))C.push(f)}if(C.length===0)break;try{console.debug("STMB ArcAnalysis: pass %d batch=%o",M,C.map((f)=>f.id))}catch{}let d=a5({briefs:C,previousArcSummary:w,previousArcOrder:null,promptText:P}),j0=await $1(d,{estimatedOutput:500}),m0=C.length,M0=!1;while(j0.total>O&&C.length>1)C.pop(),M0=!0,d=a5({briefs:C,previousArcSummary:w,previousArcOrder:_,promptText:P}),j0=await $1(d,{estimatedOutput:500});if(M0)try{console.debug("STMB ArcAnalysis: trimmed batch from %d to %d (est=%d, budget=%d)",m0,C.length,j0.total,O)}catch{}if(j0.total>O&&C.length===1){let f=O;O=j0.total;try{console.debug("STMB ArcAnalysis: raised budget for single item from %d to %d (est=%d)",f,O,j0.total)}catch{}}let{text:A0}=await M1({model:x.model,prompt:d,temperature:x.temperature??0.2,api:x.api,endpoint:x.endpoint,apiKey:x.apiKey,extra:K});R=A0,L="";let X0;try{X0=u8(A0)}catch(f){let l=`${d}

Return ONLY the JSON object, nothing else. Ensure arrays and commas are valid.`,G0=await M1({model:x.model,prompt:l,temperature:x.temperature??0.2,api:x.api,endpoint:x.endpoint,apiKey:x.apiKey,extra:K});L=G0?.text||"";try{X0=u8(G0.text)}catch(R0){let D0=Error(String(R0?.message||f?.message||"Model did not return valid arc JSON"));throw D0.name="ArcAIResponseError",D0.code="ARC_INVALID_JSON",D0.rawText=A0,D0.retryRawText=G0?.text,D0.prompt=d,D0.repairPrompt=l,D0}}let T0=new Map;C.forEach((f,l)=>{let G0=String(f.id);T0.set(G0,G0);let R0=String(l+1).padStart(3,"0");T0.set(R0,G0),T0.set(String(l+1),G0)});let O1=(f)=>T0.get(String(f).trim()),B0=new Set;if(Array.isArray(X0.unassigned_memories))X0.unassigned_memories.forEach((f)=>{let l=O1(f.id);if(l)B0.add(l)});let o0=C.filter((f)=>!B0.has(f.id));try{console.debug("STMB ArcAnalysis: pass %d arcs=%d unassigned=%d assigned=%d",M,Array.isArray(X0.arcs)?X0.arcs.length:0,B0.size,o0.length)}catch{}if(o0.length<Y&&M>1)break;let T8=Array.isArray(X0.arcs)?X0.arcs:[],n0=new Set,v6=0;for(let f=0;f<T8.length;f++){let l=T8[f];if(!l||typeof l.title!=="string"||typeof l.summary!=="string")continue;let G0=null;if(Array.isArray(l.member_ids))G0=l.member_ids.map(O1).filter((R0)=>R0!==void 0);if(G0&&G0.length>0);else G0=o0.map((R0)=>R0.id);if(G0.length===0)continue;T.push({order:M*10+f,title:l.title,summary:l.summary,keywords:Array.isArray(l.keywords)?l.keywords:[],memberIds:G0}),G0.forEach((R0)=>n0.add(String(R0))),v6++,w=l.summary}if(T.length>0)_=T[T.length-1].order;else _=null;if(n0.size>0){for(let f of n0)H.delete(String(f));if(H.size===0&&T.length===1)try{console.info("STMB ArcAnalysis: all memories were consumed into a single arc.")}catch{}}else{try{console.debug("STMB ArcAnalysis: no new IDs consumed on pass %d; stopping.",M)}catch{}break}u=C.filter((f)=>B0.has(f.id));try{console.debug("STMB ArcAnalysis: pass %d consumed=%d remaining=%d",M,n0.size,H.size)}catch{}}let e=Array.from(H.values()).map((y)=>y.id);return{arcCandidates:T,leftovers:e,rawText:R,retryRawText:L}}function W7(Z){if(Z&&Z.api&&Z.model)return Z;if(Z&&(Z.effectiveConnection||Z.connection)){let J=Z.effectiveConnection||Z.connection;return{api:q0(J.api||o().completionSource||"openai"),model:J.model||Q0().model||"",temperature:typeof J.temperature==="number"?J.temperature:Q0().temperature??0.2,endpoint:J.endpoint,apiKey:J.apiKey}}let Q=o(),G=Q0();return{api:q0(Q.completionSource||"openai"),model:G.model||"",temperature:G.temperature??0.2}}function cG(Z){if(!Z||typeof Z!=="string")return null;let Q=Z.match(/\[ARC\s+(\d+)\]/i);if(Q)return parseInt(Q[1],10);if(Q=Z.match(/\[ARC\s+\[(\d+)\]\]/i),Q)return parseInt(Q[1],10);return null}function pG(Z){let Q=Object.values(Z?.entries||{}),G=0;for(let J of Q)if(J&&J.stmbArc===!0&&typeof J.comment==="string"){let W=cG(J.comment);if(typeof W==="number"&&W>G)G=W}return G+1}function iG(Z,Q,G){let J=String(Q||"").trim(),W=String(Z||"").trim()||"[ARC 000] - {{title}}";W=W.replace(/\{\{\s*title\s*\}\}/g,J);let q=W.match(/\[([^\]]*?)(0{2,})([^\]]*?)\]/);if(q){let z=q[2].length,K=String(G).padStart(z,"0"),X=`[${q[1]}${K}${q[3]}]`;return W.replace(q[0],X)}return`[ARC ${String(G).padStart(3,"0")}] ${J}`}async function dZ({lorebookName:Z,lorebookData:Q,arcCandidates:G,disableOriginals:J=!1}){if(!Z||!Q)throw Error(D6("Missing lorebookName or lorebookData","STMemoryBooks_ArcAnalysis_MissingLorebookData"));let W=[],q=t5?.STMemoryBooks?.arcTitleFormat||"[ARC 000] - {{title}}",Y=pG(Q);try{console.info("STMB ArcAnalysis: committing %d arc(s): %o",G.length,G.map((z)=>z.title))}catch{}for(let z of G){let K=iG(q,z.title,Y++),X=z.summary,V=Array.isArray(z.keywords)?z.keywords:[];if(V.length===0)try{let H=W7(null);V=await uG(X,H)}catch(H){try{console.warn('STMB ArcAnalysis: keyword generation failed for "%s": %s',K,String(H?.message||H))}catch{}}let j={vectorized:!0,selective:!0,order:100,position:0},U={stmemorybooks:!0,stmbArc:!0,type:"arc",key:Array.isArray(V)?V:[],disable:!1},O=await M8(Z,Q,[{title:K,content:X,defaults:j,entryOverrides:U}],{refreshEditor:!1}),F=O&&O[0],A=F?F.uid:null;if(!A)throw Error(D6("Arc upsert returned no entry (commitArcs failed)","STMemoryBooks_ArcAnalysis_UpsertFailed"));if(J&&A){let H=new Set(z.memberIds.map(String)),T=Object.values(Q.entries||{});for(let R of T)if(H.has(String(R.uid)))R.disable=!0,R.disabledByArcId=A}W.push({arcEntryId:A,title:K})}await M8(Z,Q,[],{refreshEditor:!0});try{console.info("STMB ArcAnalysis: committed arc IDs: %o",W.map((z)=>z.arcEntryId))}catch{}return{results:W}}import{Handlebars as lG}from"../../../../lib.js";var cZ=lG.compile(`
<table style="width: 100%; border-collapse: collapse;">
  <thead>
    <tr>
