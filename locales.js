...
export const localeData_en = {
    ...
    'STMemoryBooks_Regeneration_GroupChoiceTitle': 'Regenerate linked group memory',
    'STMemoryBooks_Regeneration_GroupChoiceBody': 'This group-chat memory has {{count}} linked character entries. What should be regenerated?',
    'STMemoryBooks_Regeneration_GroupChoiceEntryOnly': 'Regenerate this entry only',
    'STMemoryBooks_Regeneration_GroupChoiceAll': "Regenerate this entry and the characters' entries",
    'STMemoryBooks_Regeneration_JobsQueuedMany': '{{count}} linked memory regeneration jobs queued.',
    'STMemoryBooks_Regeneration_SuccessMany': '{{count}} linked memory entries regenerated successfully.',
    ...
    'STMemoryBooks_GroupChatSettings': 'Group Chat',
    'STMemoryBooks_CharacterAwareMemories': 'character-aware memories',
    'STMemoryBooks_CharacterAwareMemoriesTooltip': 'Filter group-chat memories to participating characters. When unchecked, use ordinary single-book processing without character filters, participant selection, character copies, or separate group/character prompts. Existing entries keep their filters until rewritten.',
    'STMemoryBooks_SeparateGroupSidePrompts': 'Use separate group side prompts',
    'STMemoryBooks_SeparateGroupSidePromptsTooltip': 'Use the group side-prompt default for automatic runs. When unchecked, inherit the solo default. Explicit per-chat selections still apply. Independent of character-aware memories.',
    'STMemoryBooks_CharacterAwareDisabled': 'Disabled and not applied because ‘character-aware memories’ is unchecked in General Settings.',
    'STMemoryBooks_SeparateGroupSidePromptsDisabled': 'Disabled and not applied because ‘Use separate group side prompts’ is unchecked in General Settings.',
    ...
    'STMemoryBooks_TitleFormatDesc': 'Use [0], [00], [000] for auto-numbering. Available: {{title}}, {{scene}}, {{char}}, {{groupname}}, {{present}}, {{user}}, {{messages}}, {{profile}}, {{date}}, {{time}}',
    ...
    'STMemoryBooks_EnableSidePrompt': 'Enable Side Prompt',
    'STMemoryBooks_DisableSidePrompt': 'Disable Side Prompt',
    'STMemoryBooks_FailedToToggleSidePrompt': 'Failed to change Side Prompt enabled state.',
    ...
    'STMemoryBooks_Consolidation_SourceMemoryBook': 'Memory Book to consolidate',
    'STMemoryBooks_Consolidation_SelectMemoryBook': 'Select a Memory Book...',
    'STMemoryBooks_Consolidation_SourceMemoryBookDesc': 'Choose the Memory Book whose eligible entries should be consolidated. This choice applies only to this run.',
    'STMemoryBooks_Consolidation_LoadingMemoryBook': 'Loading Memory Book...',
    'STMemoryBooks_Consolidation_LoadFailed': 'Could not load Memory Book "{{name}}".',
