...
export const localeData_en = {
    ...
    'STMemoryBooks_LorebookEntryKeywordsHelp': 'Optional. If filled in, these keywords are applied to the upserted lorebook entry. You may only use macros already present in Prompt or Response Format.',
    ...
    'STMemoryBooks_SidePromptKeywordsInvalidMacros': 'Lorebook Entry Keywords may only use macros already present in Prompt or Response Format: {{macros}}.',
