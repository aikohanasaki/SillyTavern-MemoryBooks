...
export const localeData_en = {
    ...
    'STMemoryBooks_SidePrompts_MaxConcurrentLabel': 'How many concurrent prompts to run at once',
    'STMemoryBooks_SidePrompts_MaxConcurrentHelp': 'Range 1–5. Defaults to 2.',
    'STMemoryBooks_SidePromptCreated': 'SidePrompt created',
    'STMemoryBooks_FailedToCreateSidePrompt': 'Failed to create SidePrompt',
    'STMemoryBooks_SidePromptDuplicated': 'SidePrompt duplicated',
    'STMemoryBooks_FailedToDuplicateSidePrompt': 'Failed to duplicate SidePrompt',
    'STMemoryBooks_SidePromptDeleted': 'SidePrompt deleted',
    'STMemoryBooks_FailedToDeleteSidePrompt': 'Failed to delete SidePrompt',
    'STMemoryBooks_SidePromptsExported': 'Side prompts exported successfully',
    'STMemoryBooks_FailedToExportSidePrompts': 'Failed to export side prompts',
    'STMemoryBooks_ImportedSidePrompts': 'Imported side prompts',
    ...
    'STMemoryBooks_FailedToImportSidePrompts': 'Failed to import: {{message}}',
    'STMemoryBooks_DeleteSidePromptTitle': 'Delete Side Prompt',
    'STMemoryBooks_DeleteSidePromptConfirm': 'Are you sure you want to delete this template?',
    'STMemoryBooks_NameEmptyKeepPrevious': 'Name was empty. Keeping previous name.',
    'STMemoryBooks_SidePrompts_NoNameProvidedUsingUntitled': 'No name provided. Using "{{name}}".',
    ...
    'STMemoryBooks_ModelHint': 'For model, copy-paste the exact model ID, eg. <code>gemini-2.5-pro</code>, <code>deepseek/deepseek-r1-0528:free</code>, <code>gpt-4o-mini-2024-07-18</code>, etc.',
    ...
    'STMemoryBooks_ConverterDescription': 'This tool flags entries by adding <code>stmemorybooks: true</code>. An entry is converted only if it matches the title format, is <strong>not</strong> set to <code>"vectorized": false</code>, and has its <code>"position"</code> set to <code>0</code>.',
    ...
    'STMemoryBooks_ConverterIncludeVectorizedDescription': 'If enabled, entries with <code>vectorized: false</code> will also be included as memories.',
