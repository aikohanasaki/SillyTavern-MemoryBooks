# 📕 ST Memory Books - Tu Asistente de Memoria de Chat con IA
...
**Perfecto si quieres:** Automatización sin intervención que simplemente funciona

**Cómo funciona:**
1. Activa "Auto-Summary" en los ajustes
2. Elige con qué frecuencia crear memorias (cada 20-50 mensajes funciona bien)
3. Sigue chateando normalmente - ¡las memorias se crean automáticamente!

**Lo que obtienes:**
- No se requiere trabajo manual
- Creación de memorias consistente
- Nunca te pierdes los momentos importantes de la historia
- Funciona tanto en chats individuales como en grupales

**Consejo profesional:** Comienza con 30 mensajes y luego ajústalo según tu estilo de chat. Los chats rápidos pueden querer más de 50, los chats detallados más lentos pueden preferir 20.

</details>

<details>
<summary><strong>✋ "Control Manual" (Para la Creación Selectiva de Memorias)</strong></summary>

**Perfecto si quieres:** Decidir exactamente qué se convierte en una memoria

**Cómo funciona:**
1. Busca los pequeños botones de flecha (► ◄) en tus mensajes de chat
2. Haz clic en ► en el primer mensaje de una escena importante
3. Haz clic en ◄ en el último mensaje de esa escena
4. Abre Memory Books (🪄) y haz clic en "Crear Memoria"
...
**Consejo profesional:** Los botones de flecha aparecen unos segundos después de cargar un chat. Si no los ves, espera un momento o actualiza la página.
...
**Lo que obtienes:**
- Creación de memorias ultrarrápida
...
### ⚙️ **Cómo Funcionan los Prompts Laterales**
...
### 📚 **Colecciones de Memorias** (Lorebooks)
