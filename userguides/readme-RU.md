...
Расширение нового поколения для SillyTavern для автоматического, структурированного и надежного создания воспоминаний. Отмечайте сцены в чате, генерируйте JSON-резюме с помощью ИИ и сохраняйте их как «[векторизованные](#vectorized)» записи в ваших лорбуках. Поддерживает групповые чаты, расширенное управление профилями и надежную обработку API/моделей. Поддерживает 简体中文 (zh-cn), 繁體中文 (zh-tw).
...
### 🧩 Менеджер промптов для резюме

SillyTavern-MemoryBooks теперь предоставляет мощный «Менеджер промптов для резюме» для настройки генерации резюме.
- **Доступ:** В настройках «Книг Памяти» нажмите «🧩 Менеджер промптов для резюме».
- **Функции:**
    - Просмотр всех предустановок промптов для резюме.
    - Создание новых или дублирование существующих предустановок для экспериментов с различными стилями промптов.
    ...
    - Применение предустановки к любому настроенному профилю «Книг Памяти».
- **Советы по использованию:**
    - При создании нового промпта вы можете скопировать его из встроенных для лучшей совместимости.
    - Не удаляйте инструкцию «отвечать в формате JSON», если вы не уверены, так как «Книги Памяти» полагаются на структуру вывода ИИ.

### ⚡ Улучшения и исправления

- Улучшена обработка создания воспоминаний о сценах, что уменьшило количество ошибок и проблем с пересечением.
- Улучшена логика миграции настроек и профилей — динамические профили теперь более надежно обновляются до новых форматов.

---

## 🚦 Что нового (v4.2.2)

- **Исправления ошибок:** Критические исправления для автоматического скрытия и режима ручного лорбука.
- **Производительность:** Удалено избыточное логирование DEBUG для более чистого вывода в консоль.
...
(Если эти настройки не используются, маловероятно, что воспоминания будут подгружаться!)
