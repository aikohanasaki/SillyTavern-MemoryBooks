...
* **Auto-create lorebook if none exists (Buat lorebook otomatis jika tidak ada):** ⭐ *Baru di v4.2.0* - Secara otomatis membuat dan mengikat lorebook menggunakan templat penamaan Anda.
* **Lorebook Name Template (Templat Nama Lorebook):** ⭐ *Baru di v4.2.0* - Kustomisasi nama lorebook yang dibuat otomatis dengan placeholder {{char}}, {{user}}, {{chat}}.
