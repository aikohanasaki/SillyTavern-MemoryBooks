...
**📘 [使用者指南](USER_GUIDE.md)** |  **📋 [版本歷史與更新日誌](changelog.md)** | **🔧 [傳說書轉換器](lorebookconverter.html)**
...
> **現有記憶必須轉換！**
> 使用 [傳說書轉換器](https://github.com/aikohanasaki/SillyTavern-MemoryBooks/blob/main/lorebookconverter.html) 新增 `stmemorybooks` 標誌和必填欄位。
