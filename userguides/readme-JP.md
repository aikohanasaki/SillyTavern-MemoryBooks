...
- [推奨されるグローバルワールド情報/ロアブック有効化設定](#推奨されるグローバルワールド情報-ロアブック有効化設定)
- [はじめに](#はじめに)
...
- [FAQ (よくある質問)](#faq-よくある質問)
  ...
  - [メモリ用に別のロアブックを作成すべきですか？それとも他の用途ですでに使用しているものと同じロアブックを使用できますか？](#メモリ用に別のロアブックを作成すべきですか-それとも他の用途ですでに使用しているものと同じロアブックを使用できますか)
