...
/**
 * Keyword selection template - Updated to use ST's built-in classes
 */
export const keywordSelectionTemplate = Handlebars.compile(`
<div class="world_entry_form_control">
    <h5>Generated Memory:</h5>
    <pre class="stmb-scene-preview"><code>{{formattedContent}}</code></pre>
</div>
...
<div class="world_entry_form_control">
    ...
    <div class="flex flexFlowColumn gap5px">
        <div class="menu_button flex alignItemsCenter gap5px" id="stmb-keyword-st-generate">
            <i class="fa-solid fa-cog"></i>
            <div>
                <div>ST Generate</div>
                <small class="opacity50p">Use SillyTavern's built-in keyword detection</small>
            </div>
        </div>
        
        <div class="menu_button flex alignItemsCenter gap5px" id="stmb-keyword-ai-generate">
            <i class="fa-solid fa-robot"></i>
            <div>
                <div>AI Keywords</div>
                <small class="opacity50p">Send separate request to AI for keywords only</small>
            </div>
        </div>
        
        <div class="menu_button flex alignItemsCenter gap5px" id="stmb-keyword-user-input">
            <i class="fa-solid fa-keyboard"></i>
            <div>
                <div>Manual Entry</div>
                <small class="opacity50p">Enter your own keywords</small>
            </div>
        </div>
    </div>
</div>

<div class="world_entry_form_control displayNone" id="stmb-manual-keywords-section">
    <label for="stmb-manual-keywords">
        <h4>Enter Keywords (comma-separated):</h4>
        ...
        <h5>Enter 1-8 keywords separated by commas. Each keyword should be 1-25 characters.</h5>
    </label>
</div>
