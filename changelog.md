...
- Review Safety and Scaling: Added token-based batching, structured-response validation, stale-Clip detection, editable topic suggestions, and a dedicated Memory Assistance Suggestions screen.
- Customization: Memory Assistance update and topic-suggestion prompts can be edited and assigned a connection-profile override from the Side Prompt manager.
